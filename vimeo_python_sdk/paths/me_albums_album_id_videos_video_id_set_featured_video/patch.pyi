...
class BaseApi(api_client.Api):
    ...
    def _set_featured_video_mapped_args(
        self,
    ...
    async def _aset_featured_video_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/albums/{album_id}/videos/{video_id}/set_featured_video',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SetFeaturedVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_featured_video(
        self,
        album_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._set_featured_video_mapped_args(
            album_id=album_id,
            video_id=video_id,
        )
        return await self._aset_featured_video_oapg(
    ...
    def set_featured_video(
        ...
        return self._set_featured_video_oapg(
            path_params=args.path,
        )

class SetFeaturedVideo(BaseApi):
    ...
    async def aset_featured_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_featured_video(
            album_id=album_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def set_featured_video(
        ...
        raw_response = self.raw.set_featured_video(
            album_id=album_id,
            video_id=video_id,
        )
        if validate:
