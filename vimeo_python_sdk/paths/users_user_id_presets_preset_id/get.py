...
class BaseApi(api_client.Api):
    ...
    def _get_specific_embed_preset_mapped_args(
        self,
    ...
    async def _aget_specific_embed_preset_oapg(
        self,
    ...
    def _get_specific_embed_preset_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificEmbedPresetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_embed_preset(
        self,
        preset_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_embed_preset_mapped_args(
            preset_id=preset_id,
            user_id=user_id,
        )
        return await self._aget_specific_embed_preset_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_embed_preset(
        self,
        preset_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_specific_embed_preset_oapg(
            path_params=args.path,
        )

class GetSpecificEmbedPreset(BaseApi):
    ...
    async def aget_specific_embed_preset(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_embed_preset(
            preset_id=preset_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def get_specific_embed_preset(
        ...
        raw_response = self.raw.get_specific_embed_preset(
            preset_id=preset_id,
            user_id=user_id,
        )
        if validate:
