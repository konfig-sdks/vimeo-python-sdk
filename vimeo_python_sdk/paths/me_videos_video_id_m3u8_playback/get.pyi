...
class BaseApi(api_client.Api):
    ...
    def _get_playback_url_mapped_args(
        self,
    ...
    async def _aget_playback_url_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/videos/{video_id}/m3u8_playback',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPlaybackUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_playback_url(
        self,
        video_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_playback_url_mapped_args(
            video_id=video_id,
        )
        return await self._aget_playback_url_oapg(
    ...
    def get_playback_url(
        ...
        return self._get_playback_url_oapg(
            path_params=args.path,
        )

class GetPlaybackUrl(BaseApi):
    ...
    async def aget_playback_url(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_playback_url(
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_playback_url(
        ...
        raw_response = self.raw.get_playback_url(
            video_id=video_id,
        )
