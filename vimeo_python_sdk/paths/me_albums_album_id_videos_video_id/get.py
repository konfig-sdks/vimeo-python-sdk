...
class BaseApi(api_client.Api):
    ...
    def _get_specific_video_in_showcase_mapped_args(
        self,
    ...
    async def _aget_specific_video_in_showcase_oapg(
        self,
    ...
    def _get_specific_video_in_showcase_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSpecificVideoInShowcaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_video_in_showcase(
        self,
        album_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        password: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_specific_video_in_showcase_mapped_args(
            album_id=album_id,
            video_id=video_id,
            password=password,
        )
        return await self._aget_specific_video_in_showcase_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_video_in_showcase(
        self,
        album_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        password: typing.Optional[str] = None,
        ...
        return self._get_specific_video_in_showcase_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSpecificVideoInShowcase(BaseApi):
    ...
    async def aget_specific_video_in_showcase(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_video_in_showcase(
            album_id=album_id,
            video_id=video_id,
            password=password,
            **kwargs,
    ...
    def get_specific_video_in_showcase(
        ...
        raw_response = self.raw.get_specific_video_in_showcase(
            album_id=album_id,
            video_id=video_id,
            password=password,
        )
