...
class BaseApi(api_client.Api):
    ...
    def _remove_from_showcase_mapped_args(
        self,
    ...
    async def _aremove_from_showcase_oapg(
        self,
    ...
    def _remove_from_showcase_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveFromShowcaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_showcase(
        self,
        album_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_from_showcase_mapped_args(
            album_id=album_id,
            video_id=video_id,
        )
        return await self._aremove_from_showcase_oapg(
    ...
    def remove_from_showcase(
        ...
        return self._remove_from_showcase_oapg(
            path_params=args.path,
        )

class RemoveFromShowcase(BaseApi):
    ...
    async def aremove_from_showcase(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_showcase(
            album_id=album_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def remove_from_showcase(
        ...
        raw_response = self.raw.remove_from_showcase(
            album_id=album_id,
            video_id=video_id,
        )
