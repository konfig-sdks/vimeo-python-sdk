...
class BaseApi(api_client.Api):
    ...
    def _add_to_showcase_mapped_args(
        self,
    ...
    async def _aadd_to_showcase_oapg(
        self,
...
class AddToShowcaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_showcase(
        self,
        album_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_to_showcase_mapped_args(
            album_id=album_id,
            video_id=video_id,
        )
        return await self._aadd_to_showcase_oapg(
    ...
    def add_to_showcase(
        ...
        return self._add_to_showcase_oapg(
            path_params=args.path,
        )

class AddToShowcase(BaseApi):
    ...
    async def aadd_to_showcase(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_to_showcase(
            album_id=album_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def add_to_showcase(
        ...
        raw_response = self.raw.add_to_showcase(
            album_id=album_id,
            video_id=video_id,
        )
