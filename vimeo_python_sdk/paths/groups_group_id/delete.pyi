...
class Group1Raw(BaseApi):
    ...
    async def agroup_1(
        ...
        **kwargs,
        ...
        args = self._group_1_mapped_args(
            group_id=group_id,
        )
        return await self._agroup_1_oapg(
    ...
    def group_1(
        ...
        return self._group_1_oapg(
            path_params=args.path,
        )

class Group1(BaseApi):
    ...
    async def agroup_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agroup_1(
            group_id=group_id,
            **kwargs,
        )
