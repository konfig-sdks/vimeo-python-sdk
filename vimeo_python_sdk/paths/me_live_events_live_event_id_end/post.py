...
class BaseApi(api_client.Api):
    ...
    def _event_termination_alt1_mapped_args(
        self,
    ...
    async def _aevent_termination_alt1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/live_events/{live_event_id}/end',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _event_termination_alt1_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EventTerminationAlt1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevent_termination_alt1(
        self,
        live_event_id: typing.Union[int, float],
        clip_id: typing.Optional[typing.Union[int, float]] = None,
        **kwargs,
        ...
        args = self._event_termination_alt1_mapped_args(
            live_event_id=live_event_id,
            clip_id=clip_id,
        )
        return await self._aevent_termination_alt1_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def event_termination_alt1(
        self,
        live_event_id: typing.Union[int, float],
        clip_id: typing.Optional[typing.Union[int, float]] = None,
    ) -> typing.Union[
        ...
        return self._event_termination_alt1_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class EventTerminationAlt1(BaseApi):
    ...
    async def aevent_termination_alt1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aevent_termination_alt1(
            live_event_id=live_event_id,
            clip_id=clip_id,
            **kwargs,
        )
    ...
    def event_termination_alt1(
        ...
        raw_response = self.raw.event_termination_alt1(
            live_event_id=live_event_id,
            clip_id=clip_id,
        )
        if validate:
