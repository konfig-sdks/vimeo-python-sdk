...
from vimeo_python_sdk.model.users_analytics_get_metrics_response import UsersAnalyticsGetMetricsResponse as UsersAnalyticsGetMetricsResponseSchema

from vimeo_python_sdk.type.users_analytics_get_metrics_response import UsersAnalyticsGetMetricsResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.users_analytics_get_metrics_response import UsersAnalyticsGetMetricsResponse as UsersAnalyticsGetMetricsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoAnalyticsjson = UsersAnalyticsGetMetricsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersAnalyticsGetMetricsResponse
    ...
    async def _aget_metrics_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/analytics',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMetrics(BaseApi):
    ...
    async def aget_metrics(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersAnalyticsGetMetricsResponsePydantic:
        ...
        if validate:
            return RootModel[UsersAnalyticsGetMetricsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UsersAnalyticsGetMetricsResponsePydantic, raw_response.body)
