...
class BaseApi(api_client.Api):
    ...
    def _permit_user_access_0_mapped_args(
        self,
    ...
    async def _apermit_user_access_0_oapg(
        self,
    ...
    def _permit_user_access_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PermitUserAccess0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apermit_user_access_0(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._permit_user_access_0_mapped_args(
            channel_id=channel_id,
            user_id=user_id,
        )
        return await self._apermit_user_access_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def permit_user_access_0(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._permit_user_access_0_oapg(
            path_params=args.path,
        )

class PermitUserAccess0(BaseApi):
    ...
    async def apermit_user_access_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apermit_user_access_0(
            channel_id=channel_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def permit_user_access_0(
        ...
        raw_response = self.raw.permit_user_access_0(
            channel_id=channel_id,
            user_id=user_id,
        )
