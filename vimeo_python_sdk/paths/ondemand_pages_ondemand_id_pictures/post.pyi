...
class BaseApi(api_client.Api):
    ...
    def _add_poster_to_page_mapped_args(
        self,
    ...
    async def _aadd_poster_to_page_oapg(
        self,
...
class AddPosterToPageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_poster_to_page(
        self,
        ondemand_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._add_poster_to_page_mapped_args(
            ondemand_id=ondemand_id,
        )
        return await self._aadd_poster_to_page_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def add_poster_to_page(
        self,
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor201,
        ...
        return self._add_poster_to_page_oapg(
            path_params=args.path,
        )

class AddPosterToPage(BaseApi):
    ...
    async def aadd_poster_to_page(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_poster_to_page(
            ondemand_id=ondemand_id,
            **kwargs,
        )
        if validate:
    ...
    def add_poster_to_page(
        ...
        raw_response = self.raw.add_poster_to_page(
            ondemand_id=ondemand_id,
        )
        if validate:
            return PicturePydantic(**raw_response.body)
