...
from vimeo_python_sdk.model.get_followers_response import GetFollowersResponse as GetFollowersResponseSchema

from vimeo_python_sdk.type.get_followers_response import GetFollowersResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.get_followers_response import GetFollowersResponse as GetFollowersResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoUserjson = GetFollowersResponseSchema
...
class FollowersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afollowers(
        self,
        user_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        page: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._followers_mapped_args(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        return await self._afollowers_oapg(
    ...
    def followers(
        ...
        return self._followers_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class Followers(BaseApi):
    ...
    async def afollowers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetFollowersResponsePydantic:
        raw_response = await self.raw.afollowers(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[GetFollowersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetFollowersResponsePydantic, raw_response.body)
    ...
    def followers(
        ...
        raw_response = self.raw.followers(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
