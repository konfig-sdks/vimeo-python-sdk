...
class BaseApi(api_client.Api):
    ...
    def _check_user_owns_video_mapped_args(
        self,
    ...
    async def _acheck_user_owns_video_oapg(
        self,
    ...
    def _check_user_owns_video_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckUserOwnsVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_user_owns_video(
        self,
        video_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_user_owns_video_mapped_args(
            video_id=video_id,
        )
        return await self._acheck_user_owns_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_user_owns_video(
        self,
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._check_user_owns_video_oapg(
            path_params=args.path,
        )

class CheckUserOwnsVideo(BaseApi):
    ...
    async def acheck_user_owns_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_user_owns_video(
            video_id=video_id,
            **kwargs,
        )
        if validate:
    ...
    def check_user_owns_video(
        ...
        raw_response = self.raw.check_user_owns_video(
            video_id=video_id,
        )
        if validate:
            return VideoPydantic(**raw_response.body)
