...
class BaseApi(api_client.Api):
    ...
    def _delete_showcase_mapped_args(
        self,
    ...
    async def _adelete_showcase_oapg(
        self,
...
class DeleteShowcaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_showcase(
        self,
        album_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_showcase_mapped_args(
            album_id=album_id,
        )
        return await self._adelete_showcase_oapg(
    ...
    def delete_showcase(
        ...
        return self._delete_showcase_oapg(
            path_params=args.path,
        )

class DeleteShowcase(BaseApi):
    ...
    async def adelete_showcase(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_showcase(
            album_id=album_id,
            **kwargs,
        )
    ...
    def delete_showcase(
        ...
        raw_response = self.raw.delete_showcase(
            album_id=album_id,
        )
