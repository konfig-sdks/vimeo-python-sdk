...
class BaseApi(api_client.Api):
    ...
    def _get_specific_showcase_mapped_args(
        self,
    ...
    async def _aget_specific_showcase_oapg(
        self,
    ...
    def _get_specific_showcase_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificShowcaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_showcase(
        self,
        album_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_showcase_mapped_args(
            album_id=album_id,
        )
        return await self._aget_specific_showcase_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_showcase(
        self,
        album_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_showcase_oapg(
            path_params=args.path,
        )

class GetSpecificShowcase(BaseApi):
    ...
    async def aget_specific_showcase(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_showcase(
            album_id=album_id,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_showcase(
        ...
        raw_response = self.raw.get_specific_showcase(
            album_id=album_id,
        )
        if validate:
            return AlbumPydantic(**raw_response.body)
