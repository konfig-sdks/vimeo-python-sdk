...
from vimeo_python_sdk.model.get_channels_response import GetChannelsResponse as GetChannelsResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.get_channels_response import GetChannelsResponse
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.get_channels_response import GetChannelsResponse as GetChannelsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoChanneljson = GetChannelsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetChannelsResponse
...
class ChannelsRaw(BaseApi):
    ...
    async def achannels(
        ...
        **kwargs,
        ...
        args = self._channels_mapped_args(
            direction=direction,
            filter=filter,
            page=page,
            per_page=per_page,
        ...
        return await self._achannels_oapg(
...
class Channels(BaseApi):
    ...
    async def achannels(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetChannelsResponsePydantic:
        raw_response = await self.raw.achannels(
            direction=direction,
            filter=filter,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[GetChannelsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetChannelsResponsePydantic, raw_response.body)
    ...
    def channels(
        ...
        raw_response = self.raw.channels(
            direction=direction,
            filter=filter,
            page=page,
            per_page=per_page,
