...
class Channel0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achannel_0(
        self,
        channel_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._channel_0_mapped_args(
            channel_id=channel_id,
        )
        return await self._achannel_0_oapg(
    ...
    def channel_0(
        ...
        return self._channel_0_oapg(
            path_params=args.path,
        )

class Channel0(BaseApi):
    ...
    async def achannel_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.achannel_0(
            channel_id=channel_id,
            **kwargs,
        )
        if validate:
    ...
    def channel_0(
        ...
        raw_response = self.raw.channel_0(
            channel_id=channel_id,
        )
        if validate:
            return ChannelPydantic(**raw_response.body)
