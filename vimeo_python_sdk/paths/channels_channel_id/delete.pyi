...
class Channel1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achannel_1(
        self,
        channel_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._channel_1_mapped_args(
            channel_id=channel_id,
        )
        return await self._achannel_1_oapg(
    ...
    def channel_1(
        ...
        return self._channel_1_oapg(
            path_params=args.path,
        )

class Channel1(BaseApi):
    ...
    async def achannel_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.achannel_1(
            channel_id=channel_id,
            **kwargs,
        )
    ...
    def channel_1(
        ...
        raw_response = self.raw.channel_1(
            channel_id=channel_id,
        )
