...
class BaseApi(api_client.Api):
    ...
    def _add_multiple_to_folder_mapped_args(
        self,
    ...
    async def _aadd_multiple_to_folder_oapg(
        self,
    ...
    def _add_multiple_to_folder_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddMultipleToFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_multiple_to_folder(
        self,
        project_id: typing.Union[int, float],
        uris: str,
        **kwargs,
        ...
        args = self._add_multiple_to_folder_mapped_args(
            project_id=project_id,
            uris=uris,
        )
        return await self._aadd_multiple_to_folder_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def add_multiple_to_folder(
        self,
        project_id: typing.Union[int, float],
        uris: str,
    ) -> typing.Union[
        ...
        return self._add_multiple_to_folder_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class AddMultipleToFolder(BaseApi):
    ...
    async def aadd_multiple_to_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_multiple_to_folder(
            project_id=project_id,
            uris=uris,
            **kwargs,
        )
    ...
    def add_multiple_to_folder(
        ...
        raw_response = self.raw.add_multiple_to_folder(
            project_id=project_id,
            uris=uris,
        )
