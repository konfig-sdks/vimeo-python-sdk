...
from vimeo_python_sdk.model.folders_videos_get_videos_in_folder_response import FoldersVideosGetVideosInFolderResponse as FoldersVideosGetVideosInFolderResponseSchema
from vimeo_python_sdk.model.error import Error as ErrorSchema

from vimeo_python_sdk.type.folders_videos_get_videos_in_folder_response import FoldersVideosGetVideosInFolderResponse
from vimeo_python_sdk.type.error import Error

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.folders_videos_get_videos_in_folder_response import FoldersVideosGetVideosInFolderResponse as FoldersVideosGetVideosInFolderResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FoldersVideosGetVideosInFolderResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FoldersVideosGetVideosInFolderResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_videos_in_folder_mapped_args(
        self,
    ...
    async def _aget_videos_in_folder_oapg(
        self,
    ...
    def _get_videos_in_folder_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetVideosInFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_videos_in_folder(
        self,
        project_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        filter_tag: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_videos_in_folder_mapped_args(
        ...
        return await self._aget_videos_in_folder_oapg(
    ...
    def get_videos_in_folder(
        ...
        return self._get_videos_in_folder_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetVideosInFolder(BaseApi):
    ...
    async def aget_videos_in_folder(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FoldersVideosGetVideosInFolderResponsePydantic:
        raw_response = await self.raw.aget_videos_in_folder(
            project_id=project_id,
            direction=direction,
            filter_tag=filter_tag,
            filter_tag_all_of=filter_tag_all_of,
        ...
        if validate:
            return RootModel[FoldersVideosGetVideosInFolderResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FoldersVideosGetVideosInFolderResponsePydantic, raw_response.body)
    ...
    def get_videos_in_folder(
        ...
        raw_response = self.raw.get_videos_in_folder(
            project_id=project_id,
            direction=direction,
            filter_tag=filter_tag,
            filter_tag_all_of=filter_tag_all_of,
