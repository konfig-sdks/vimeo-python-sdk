...
class BaseApi(api_client.Api):
    ...
    def _remove_multiple_from_folder_mapped_args(
        self,
    ...
    async def _aremove_multiple_from_folder_oapg(
        self,
    ...
    def _remove_multiple_from_folder_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RemoveMultipleFromFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_multiple_from_folder(
        self,
        project_id: typing.Union[int, float],
        uris: str,
        should_delete_clips: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._remove_multiple_from_folder_mapped_args(
            project_id=project_id,
            uris=uris,
            should_delete_clips=should_delete_clips,
        )
        return await self._aremove_multiple_from_folder_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def remove_multiple_from_folder(
        self,
        project_id: typing.Union[int, float],
        uris: str,
        should_delete_clips: typing.Optional[bool] = None,
        ...
        return self._remove_multiple_from_folder_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RemoveMultipleFromFolder(BaseApi):
    ...
    async def aremove_multiple_from_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_multiple_from_folder(
            project_id=project_id,
            uris=uris,
            should_delete_clips=should_delete_clips,
            **kwargs,
    ...
    def remove_multiple_from_folder(
        ...
        raw_response = self.raw.remove_multiple_from_folder(
            project_id=project_id,
            uris=uris,
            should_delete_clips=should_delete_clips,
        )
