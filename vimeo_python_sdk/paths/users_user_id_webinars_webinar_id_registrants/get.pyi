...
class BaseApi(api_client.Api):
    ...
    def _get_user_registrations_by_webinar_id_0_mapped_args(
        self,
    ...
    async def _aget_user_registrations_by_webinar_id_0_oapg(
        self,
    ...
    def _get_user_registrations_by_webinar_id_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserRegistrationsByWebinarId0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="webinar\registrations")
    async def aget_user_registrations_by_webinar_id_0(
        self,
        user_id: typing.Union[int, float],
        webinar_id: str,
        direction: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_registrations_by_webinar_id_0_mapped_args(
            user_id=user_id,
        ...
        return await self._aget_user_registrations_by_webinar_id_0_oapg(
    ...
    @api_client.DeprecationWarningOnce(prefix="webinar\registrations")
    def get_user_registrations_by_webinar_id_0(
        self,
        user_id: typing.Union[int, float],
        webinar_id: str,
        direction: typing.Optional[str] = None,
        ...
        return self._get_user_registrations_by_webinar_id_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserRegistrationsByWebinarId0(BaseApi):
    ...
    async def aget_user_registrations_by_webinar_id_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_registrations_by_webinar_id_0(
            user_id=user_id,
            webinar_id=webinar_id,
            direction=direction,
            page=page,
    ...
    def get_user_registrations_by_webinar_id_0(
        ...
        raw_response = self.raw.get_user_registrations_by_webinar_id_0(
            user_id=user_id,
            webinar_id=webinar_id,
            direction=direction,
            page=page,
