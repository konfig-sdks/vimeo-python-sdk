...
class BaseApi(api_client.Api):
    ...
    def _remove_specific_video_mapped_args(
        self,
    ...
    async def _aremove_specific_video_oapg(
        self,
    ...
    def _remove_specific_video_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveSpecificVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_specific_video(
        self,
        channel_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_specific_video_mapped_args(
            channel_id=channel_id,
            video_id=video_id,
        )
        return await self._aremove_specific_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_specific_video(
        self,
        channel_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._remove_specific_video_oapg(
            path_params=args.path,
        )

class RemoveSpecificVideo(BaseApi):
    ...
    async def aremove_specific_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_specific_video(
            channel_id=channel_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def remove_specific_video(
        ...
        raw_response = self.raw.remove_specific_video(
            channel_id=channel_id,
            video_id=video_id,
        )
