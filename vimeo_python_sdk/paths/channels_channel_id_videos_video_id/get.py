...
class BaseApi(api_client.Api):
    ...
    def _get_specific_video_in_channel_mapped_args(
        self,
    ...
    async def _aget_specific_video_in_channel_oapg(
        self,
    ...
    def _get_specific_video_in_channel_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificVideoInChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_video_in_channel(
        self,
        channel_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_video_in_channel_mapped_args(
            channel_id=channel_id,
            video_id=video_id,
        )
        return await self._aget_specific_video_in_channel_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_video_in_channel(
        self,
        channel_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_specific_video_in_channel_oapg(
            path_params=args.path,
        )

class GetSpecificVideoInChannel(BaseApi):
    ...
    async def aget_specific_video_in_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_video_in_channel(
            channel_id=channel_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_specific_video_in_channel(
        ...
        raw_response = self.raw.get_specific_video_in_channel(
            channel_id=channel_id,
            video_id=video_id,
        )
        if validate:
