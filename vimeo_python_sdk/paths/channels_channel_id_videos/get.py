...
from vimeo_python_sdk.model.channels_videos_list_in_channel_response import ChannelsVideosListInChannelResponse as ChannelsVideosListInChannelResponseSchema
...
from vimeo_python_sdk.type.channels_videos_list_in_channel_response import ChannelsVideosListInChannelResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.channels_videos_list_in_channel_response import ChannelsVideosListInChannelResponse as ChannelsVideosListInChannelResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = ChannelsVideosListInChannelResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ChannelsVideosListInChannelResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_in_channel_mapped_args(
        self,
    ...
    async def _alist_in_channel_oapg(
        self,
...
class ListInChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_in_channel(
        self,
        channel_id: typing.Union[int, float],
        containing_uri: typing.Optional[str] = None,
        direction: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_in_channel_mapped_args(
        ...
        return await self._alist_in_channel_oapg(
    ...
    def list_in_channel(
        ...
        return self._list_in_channel_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListInChannel(BaseApi):
    ...
    async def alist_in_channel(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChannelsVideosListInChannelResponsePydantic:
        raw_response = await self.raw.alist_in_channel(
            channel_id=channel_id,
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
        ...
        if validate:
            return RootModel[ChannelsVideosListInChannelResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ChannelsVideosListInChannelResponsePydantic, raw_response.body)
    ...
    def list_in_channel(
        ...
        raw_response = self.raw.list_in_channel(
            channel_id=channel_id,
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
