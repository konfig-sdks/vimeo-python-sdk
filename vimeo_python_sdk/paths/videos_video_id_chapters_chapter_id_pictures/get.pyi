...
class BaseApi(api_client.Api):
    ...
    def _get_chapter_thumbnails_mapped_args(
        self,
    ...
    async def _aget_chapter_thumbnails_oapg(
        self,
    ...
    def _get_chapter_thumbnails_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetChapterThumbnailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_chapter_thumbnails(
        self,
        chapter_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_chapter_thumbnails_mapped_args(
            chapter_id=chapter_id,
            video_id=video_id,
        )
        return await self._aget_chapter_thumbnails_oapg(
    ...
    def get_chapter_thumbnails(
        ...
        return self._get_chapter_thumbnails_oapg(
            path_params=args.path,
        )

class GetChapterThumbnails(BaseApi):
    ...
    async def aget_chapter_thumbnails(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_chapter_thumbnails(
            chapter_id=chapter_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_chapter_thumbnails(
        ...
        raw_response = self.raw.get_chapter_thumbnails(
            chapter_id=chapter_id,
            video_id=video_id,
        )
        if validate:
