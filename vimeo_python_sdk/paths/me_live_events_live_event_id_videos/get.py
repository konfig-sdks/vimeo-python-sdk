...
from vimeo_python_sdk.model.live_event_videos_get_all_response import LiveEventVideosGetAllResponse as LiveEventVideosGetAllResponseSchema
from vimeo_python_sdk.model.error import Error as ErrorSchema

from vimeo_python_sdk.type.live_event_videos_get_all_response import LiveEventVideosGetAllResponse
from vimeo_python_sdk.type.error import Error

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.live_event_videos_get_all_response import LiveEventVideosGetAllResponse as LiveEventVideosGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = LiveEventVideosGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LiveEventVideosGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LiveEventVideosGetAllResponsePydantic:
        ...
        if validate:
            return RootModel[LiveEventVideosGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(LiveEventVideosGetAllResponsePydantic, raw_response.body)
