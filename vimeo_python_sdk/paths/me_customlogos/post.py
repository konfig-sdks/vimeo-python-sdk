...
class BaseApi(api_client.Api):
    ...
    def _add_user_logo_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aadd_user_logo_oapg(
        self,
...
class AddUserLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_user_logo(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor201Async,
        ...
        args = self._add_user_logo_mapped_args(
        )
        return await self._aadd_user_logo_oapg(
            **kwargs,
        )
    ...
    def add_user_logo(
        ...
        return self._add_user_logo_oapg(
        )

class AddUserLogo(BaseApi):
    ...
    async def aadd_user_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_user_logo(
            **kwargs,
        )
        if validate:
    ...
    def add_user_logo(
        ...
        raw_response = self.raw.add_user_logo(
        )
        if validate:
            return PicturePydantic(**raw_response.body)
        return api_client.construct_model_instance(PicturePydantic, raw_response.body)
