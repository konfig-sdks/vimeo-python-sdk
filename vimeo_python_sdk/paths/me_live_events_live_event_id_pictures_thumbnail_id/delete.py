...
class BaseApi(api_client.Api):
    ...
    def _delete_for_event_mapped_args(
        self,
    ...
    async def _adelete_for_event_oapg(
        self,
...
class DeleteForEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_for_event(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_for_event_mapped_args(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
        )
        return await self._adelete_for_event_oapg(
    ...
    def delete_for_event(
        ...
        return self._delete_for_event_oapg(
            path_params=args.path,
        )

class DeleteForEvent(BaseApi):
    ...
    async def adelete_for_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_for_event(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            **kwargs,
        )
    ...
    def delete_for_event(
        ...
        raw_response = self.raw.delete_for_event(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
        )
