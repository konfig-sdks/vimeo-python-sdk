...
from vimeo_python_sdk.model.live_event_activation_create_rtmp_links_request2 import LiveEventActivationCreateRtmpLinksRequest2 as LiveEventActivationCreateRtmpLinksRequest2Schema
...
from vimeo_python_sdk.type.live_event_activation_create_rtmp_links_request2 import LiveEventActivationCreateRtmpLinksRequest2
from vimeo_python_sdk.type.error import Error

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.live_event_activation_create_rtmp_links_request2 import LiveEventActivationCreateRtmpLinksRequest2 as LiveEventActivationCreateRtmpLinksRequest2Pydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoVideojson = LiveEventActivationCreateRtmpLinksRequest2Schema


request_body_live_event_activation_create_rtmp_links_request2 = api_client.RequestBody(
    content={
...
SchemaFor503ResponseBodyApplicationVndVimeoVideojson = ErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_rtmp_links_1_mapped_args(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        cloud_composing_streaming: typing.Optional[bool] = None,
        streaming_start_requested: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if cloud_composing_streaming is not None:
            _body["cloud_composing_streaming"] = cloud_composing_streaming
        if streaming_start_requested is not None:
            _body["streaming_start_requested"] = streaming_start_requested
        args.body = _body
    ...
    async def _acreate_rtmp_links_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/live_events/{live_event_id}/activate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_activation_create_rtmp_links_request2.serialize(body, content_type)
...
class CreateRtmpLinks1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_rtmp_links_1(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        cloud_composing_streaming: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_rtmp_links_1_mapped_args(
        ...
        return await self._acreate_rtmp_links_1_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_rtmp_links_1(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        cloud_composing_streaming: typing.Optional[bool] = None,
        ...
        return self._create_rtmp_links_1_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateRtmpLinks1(BaseApi):
    ...
    async def acreate_rtmp_links_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_rtmp_links_1(
            live_event_id=live_event_id,
            user_id=user_id,
            cloud_composing_streaming=cloud_composing_streaming,
            streaming_start_requested=streaming_start_requested,
    ...
    def create_rtmp_links_1(
        ...
        raw_response = self.raw.create_rtmp_links_1(
            live_event_id=live_event_id,
            user_id=user_id,
            cloud_composing_streaming=cloud_composing_streaming,
            streaming_start_requested=streaming_start_requested,
