...
class BaseApi(api_client.Api):
    ...
    def _specific_event_video_mapped_args(
        self,
    ...
    async def _aspecific_event_video_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/live_events/{live_event_id}/videos/{video_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _specific_event_video_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SpecificEventVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aspecific_event_video(
        self,
        live_event_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._specific_event_video_mapped_args(
            live_event_id=live_event_id,
            video_id=video_id,
        )
        return await self._aspecific_event_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def specific_event_video(
        self,
        live_event_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._specific_event_video_oapg(
            path_params=args.path,
        )

class SpecificEventVideo(BaseApi):
    ...
    async def aspecific_event_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aspecific_event_video(
            live_event_id=live_event_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def specific_event_video(
        ...
        raw_response = self.raw.specific_event_video(
            live_event_id=live_event_id,
            video_id=video_id,
        )
        if validate:
