...
SchemaFor200ResponseBodyApplicationVndVimeoCategoryjson = CategorySchema
...
class CategoryRaw(BaseApi):
    ...
    async def acategory(
        ...
        **kwargs,
        ...
        args = self._category_mapped_args(
            category=category,
        )
        return await self._acategory_oapg(
...
class Category(BaseApi):
    ...
    async def acategory(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acategory(
            category=category,
            **kwargs,
        )
        if validate:
    ...
    def category(
        ...
        raw_response = self.raw.category(
            category=category,
        )
        if validate:
            return CategoryPydantic(**raw_response.body)
