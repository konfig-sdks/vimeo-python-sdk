...
class BaseApi(api_client.Api):
    ...
    def _delete_video_version_mapped_args(
        self,
    ...
    async def _adelete_video_version_oapg(
        self,
    ...
    def _delete_video_version_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteVideoVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_video_version(
        self,
        version_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_video_version_mapped_args(
            version_id=version_id,
            video_id=video_id,
        )
        return await self._adelete_video_version_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_video_version(
        self,
        version_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._delete_video_version_oapg(
            path_params=args.path,
        )

class DeleteVideoVersion(BaseApi):
    ...
    async def adelete_video_version(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_video_version(
            version_id=version_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def delete_video_version(
        ...
        raw_response = self.raw.delete_video_version(
            version_id=version_id,
            video_id=video_id,
        )
