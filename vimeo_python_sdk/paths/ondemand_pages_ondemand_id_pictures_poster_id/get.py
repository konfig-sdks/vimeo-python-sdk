...
class BaseApi(api_client.Api):
    ...
    def _get_specific_poster_mapped_args(
        self,
    ...
    async def _aget_specific_poster_oapg(
        self,
...
class GetSpecificPosterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_poster(
        self,
        ondemand_id: typing.Union[int, float],
        poster_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_poster_mapped_args(
            ondemand_id=ondemand_id,
            poster_id=poster_id,
        )
        return await self._aget_specific_poster_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_poster(
        self,
        ondemand_id: typing.Union[int, float],
        poster_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_specific_poster_oapg(
            path_params=args.path,
        )

class GetSpecificPoster(BaseApi):
    ...
    async def aget_specific_poster(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_poster(
            ondemand_id=ondemand_id,
            poster_id=poster_id,
            **kwargs,
        )
    ...
    def get_specific_poster(
        ...
        raw_response = self.raw.get_specific_poster(
            ondemand_id=ondemand_id,
            poster_id=poster_id,
        )
        if validate:
