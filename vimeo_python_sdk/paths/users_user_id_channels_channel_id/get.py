...
class BaseApi(api_client.Api):
    ...
    def _check_user_follows_channel_mapped_args(
        self,
    ...
    async def _acheck_user_follows_channel_oapg(
        self,
    ...
    def _check_user_follows_channel_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckUserFollowsChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_user_follows_channel(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._check_user_follows_channel_mapped_args(
            channel_id=channel_id,
            user_id=user_id,
        )
        return await self._acheck_user_follows_channel_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_user_follows_channel(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._check_user_follows_channel_oapg(
            path_params=args.path,
        )

class CheckUserFollowsChannel(BaseApi):
    ...
    async def acheck_user_follows_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_user_follows_channel(
            channel_id=channel_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def check_user_follows_channel(
        ...
        raw_response = self.raw.check_user_follows_channel(
            channel_id=channel_id,
            user_id=user_id,
        )
