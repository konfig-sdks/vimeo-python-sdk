...
class BaseApi(api_client.Api):
    ...
    def _unsubscribe_user_from_channel_0_mapped_args(
        self,
    ...
    async def _aunsubscribe_user_from_channel_0_oapg(
        self,
    ...
    def _unsubscribe_user_from_channel_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UnsubscribeUserFromChannel0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunsubscribe_user_from_channel_0(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._unsubscribe_user_from_channel_0_mapped_args(
            channel_id=channel_id,
            user_id=user_id,
        )
        return await self._aunsubscribe_user_from_channel_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def unsubscribe_user_from_channel_0(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._unsubscribe_user_from_channel_0_oapg(
            path_params=args.path,
        )

class UnsubscribeUserFromChannel0(BaseApi):
    ...
    async def aunsubscribe_user_from_channel_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunsubscribe_user_from_channel_0(
            channel_id=channel_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def unsubscribe_user_from_channel_0(
        ...
        raw_response = self.raw.unsubscribe_user_from_channel_0(
            channel_id=channel_id,
            user_id=user_id,
        )
