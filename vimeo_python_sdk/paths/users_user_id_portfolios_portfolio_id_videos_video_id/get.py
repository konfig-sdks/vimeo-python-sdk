...
class BaseApi(api_client.Api):
    ...
    def _get_specific_video_0_mapped_args(
        self,
    ...
    async def _aget_specific_video_0_oapg(
        self,
    ...
    def _get_specific_video_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificVideo0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_video_0(
        self,
        portfolio_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_video_0_mapped_args(
            portfolio_id=portfolio_id,
            user_id=user_id,
            video_id=video_id,
        )
        return await self._aget_specific_video_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_video_0(
        self,
        portfolio_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        ...
        return self._get_specific_video_0_oapg(
            path_params=args.path,
        )

class GetSpecificVideo0(BaseApi):
    ...
    async def aget_specific_video_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_video_0(
            portfolio_id=portfolio_id,
            user_id=user_id,
            video_id=video_id,
            **kwargs,
    ...
    def get_specific_video_0(
        ...
        raw_response = self.raw.get_specific_video_0(
            portfolio_id=portfolio_id,
            user_id=user_id,
            video_id=video_id,
        )
