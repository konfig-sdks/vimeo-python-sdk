...
class BaseApi(api_client.Api):
    ...
    def _add_video_to_portfolio_mapped_args(
        self,
    ...
    async def _aadd_video_to_portfolio_oapg(
        self,
    ...
    def _add_video_to_portfolio_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddVideoToPortfolioRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_video_to_portfolio(
        self,
        portfolio_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_video_to_portfolio_mapped_args(
            portfolio_id=portfolio_id,
            user_id=user_id,
            video_id=video_id,
        )
        return await self._aadd_video_to_portfolio_oapg(
    ...
    def add_video_to_portfolio(
        ...
        return self._add_video_to_portfolio_oapg(
            path_params=args.path,
        )

class AddVideoToPortfolio(BaseApi):
    ...
    async def aadd_video_to_portfolio(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_video_to_portfolio(
            portfolio_id=portfolio_id,
            user_id=user_id,
            video_id=video_id,
            **kwargs,
    ...
    def add_video_to_portfolio(
        ...
        raw_response = self.raw.add_video_to_portfolio(
            portfolio_id=portfolio_id,
            user_id=user_id,
            video_id=video_id,
        )
