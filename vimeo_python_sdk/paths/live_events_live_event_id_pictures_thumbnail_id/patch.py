...
from vimeo_python_sdk.model.live_event_thumbnails_edit_live_event_thumbnail_request import LiveEventThumbnailsEditLiveEventThumbnailRequest as LiveEventThumbnailsEditLiveEventThumbnailRequestSchema
...
from vimeo_python_sdk.type.live_event_thumbnails_edit_live_event_thumbnail_request import LiveEventThumbnailsEditLiveEventThumbnailRequest

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.live_event_thumbnails_edit_live_event_thumbnail_request import LiveEventThumbnailsEditLiveEventThumbnailRequest as LiveEventThumbnailsEditLiveEventThumbnailRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoPicturejson = LiveEventThumbnailsEditLiveEventThumbnailRequestSchema


request_body_live_event_thumbnails_edit_live_event_thumbnail_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _edit_live_event_thumbnail_mapped_args(
        self,
    ...
    async def _aedit_live_event_thumbnail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/live_events/{live_event_id}/pictures/{thumbnail_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_thumbnails_edit_live_event_thumbnail_request.serialize(body, content_type)
    ...
    def _edit_live_event_thumbnail_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EditLiveEventThumbnailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_live_event_thumbnail(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._edit_live_event_thumbnail_mapped_args(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            active=active,
        )
        return await self._aedit_live_event_thumbnail_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def edit_live_event_thumbnail(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
        ...
        return self._edit_live_event_thumbnail_oapg(
            body=args.body,
            path_params=args.path,
        )

class EditLiveEventThumbnail(BaseApi):
    ...
    async def aedit_live_event_thumbnail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aedit_live_event_thumbnail(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            active=active,
            **kwargs,
    ...
    def edit_live_event_thumbnail(
        ...
        raw_response = self.raw.edit_live_event_thumbnail(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            active=active,
        )
