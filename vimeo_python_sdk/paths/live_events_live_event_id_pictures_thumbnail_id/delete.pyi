...
class BaseApi(api_client.Api):
    ...
    def _delete_thumbnail_for_event_mapped_args(
        self,
    ...
    async def _adelete_thumbnail_for_event_oapg(
        self,
    ...
    def _delete_thumbnail_for_event_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteThumbnailForEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_thumbnail_for_event(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_thumbnail_for_event_mapped_args(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
        )
        return await self._adelete_thumbnail_for_event_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_thumbnail_for_event(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._delete_thumbnail_for_event_oapg(
            path_params=args.path,
        )

class DeleteThumbnailForEvent(BaseApi):
    ...
    async def adelete_thumbnail_for_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_thumbnail_for_event(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            **kwargs,
        )
    ...
    def delete_thumbnail_for_event(
        ...
        raw_response = self.raw.delete_thumbnail_for_event(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
        )
