...
class BaseApi(api_client.Api):
    ...
    def _get_single_chapter_thumbnail_0_mapped_args(
        self,
    ...
    async def _aget_single_chapter_thumbnail_0_oapg(
        self,
    ...
    def _get_single_chapter_thumbnail_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSingleChapterThumbnail0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_chapter_thumbnail_0(
        self,
        chapter_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_single_chapter_thumbnail_0_mapped_args(
            chapter_id=chapter_id,
            video_id=video_id,
        )
        return await self._aget_single_chapter_thumbnail_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_single_chapter_thumbnail_0(
        self,
        chapter_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_single_chapter_thumbnail_0_oapg(
            path_params=args.path,
        )

class GetSingleChapterThumbnail0(BaseApi):
    ...
    async def aget_single_chapter_thumbnail_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_chapter_thumbnail_0(
            chapter_id=chapter_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_single_chapter_thumbnail_0(
        ...
        raw_response = self.raw.get_single_chapter_thumbnail_0(
            chapter_id=chapter_id,
            video_id=video_id,
        )
        if validate:
