...
class BaseApi(api_client.Api):
    ...
    def _remove_tag_from_channel_mapped_args(
        self,
    ...
    async def _aremove_tag_from_channel_oapg(
        self,
    ...
    def _remove_tag_from_channel_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveTagFromChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_tag_from_channel(
        self,
        channel_id: typing.Union[int, float],
        word: str,
        **kwargs,
        ...
        args = self._remove_tag_from_channel_mapped_args(
            channel_id=channel_id,
            word=word,
        )
        return await self._aremove_tag_from_channel_oapg(
    ...
    def remove_tag_from_channel(
        ...
        return self._remove_tag_from_channel_oapg(
            path_params=args.path,
        )

class RemoveTagFromChannel(BaseApi):
    ...
    async def aremove_tag_from_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_tag_from_channel(
            channel_id=channel_id,
            word=word,
            **kwargs,
        )
    ...
    def remove_tag_from_channel(
        ...
        raw_response = self.raw.remove_tag_from_channel(
            channel_id=channel_id,
            word=word,
        )
