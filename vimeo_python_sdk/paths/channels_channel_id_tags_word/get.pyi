...
SchemaFor404ResponseBodyApplicationVndVimeoTagjson = ErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _check_if_tag_added_to_channel_mapped_args(
        self,
    ...
    async def _acheck_if_tag_added_to_channel_oapg(
        self,
    ...
    def _check_if_tag_added_to_channel_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckIfTagAddedToChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_if_tag_added_to_channel(
        self,
        channel_id: typing.Union[int, float],
        word: str,
        **kwargs,
        ...
        args = self._check_if_tag_added_to_channel_mapped_args(
            channel_id=channel_id,
            word=word,
        )
        return await self._acheck_if_tag_added_to_channel_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_if_tag_added_to_channel(
        self,
        channel_id: typing.Union[int, float],
        word: str,
    ) -> typing.Union[
        ...
        return self._check_if_tag_added_to_channel_oapg(
            path_params=args.path,
        )

class CheckIfTagAddedToChannel(BaseApi):
    ...
    async def acheck_if_tag_added_to_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_if_tag_added_to_channel(
            channel_id=channel_id,
            word=word,
            **kwargs,
        )
    ...
    def check_if_tag_added_to_channel(
        ...
        raw_response = self.raw.check_if_tag_added_to_channel(
            channel_id=channel_id,
            word=word,
        )
