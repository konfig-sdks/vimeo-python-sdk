...
class BaseApi(api_client.Api):
    ...
    def _add_tag_to_channel_mapped_args(
        self,
    ...
    async def _aadd_tag_to_channel_oapg(
        self,
...
class AddTagToChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_tag_to_channel(
        self,
        channel_id: typing.Union[int, float],
        word: str,
        **kwargs,
        ...
        args = self._add_tag_to_channel_mapped_args(
            channel_id=channel_id,
            word=word,
        )
        return await self._aadd_tag_to_channel_oapg(
    ...
    def add_tag_to_channel(
        ...
        return self._add_tag_to_channel_oapg(
            path_params=args.path,
        )

class AddTagToChannel(BaseApi):
    ...
    async def aadd_tag_to_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_tag_to_channel(
            channel_id=channel_id,
            word=word,
            **kwargs,
        )
    ...
    def add_tag_to_channel(
        ...
        raw_response = self.raw.add_tag_to_channel(
            channel_id=channel_id,
            word=word,
        )
