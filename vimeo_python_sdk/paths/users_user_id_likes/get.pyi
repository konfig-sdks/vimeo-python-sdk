...
from vimeo_python_sdk.model.get_likes_response import GetLikesResponse as GetLikesResponseSchema

from vimeo_python_sdk.type.get_likes_response import GetLikesResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.get_likes_response import GetLikesResponse as GetLikesResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = GetLikesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetLikesResponse
...
class LikesRaw(BaseApi):
    ...
    async def alikes(
        ...
        **kwargs,
        ...
        return await self._alikes_oapg(
...
class Likes(BaseApi):
    ...
    async def alikes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetLikesResponsePydantic:
        raw_response = await self.raw.alikes(
            user_id=user_id,
            filter=filter,
            filter_embeddable=filter_embeddable,
            page=page,
        ...
        if validate:
            return RootModel[GetLikesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetLikesResponsePydantic, raw_response.body)
