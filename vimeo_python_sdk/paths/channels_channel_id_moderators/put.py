...
class BaseApi(api_client.Api):
    ...
    def _bulk_add_moderators_mapped_args(
        self,
    ...
    async def _abulk_add_moderators_oapg(
        self,
...
class BulkAddModeratorsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abulk_add_moderators(
        self,
        channel_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._bulk_add_moderators_mapped_args(
            channel_id=channel_id,
        )
        return await self._abulk_add_moderators_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def bulk_add_moderators(
        self,
        channel_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._bulk_add_moderators_oapg(
            path_params=args.path,
        )

class BulkAddModerators(BaseApi):
    ...
    async def abulk_add_moderators(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abulk_add_moderators(
            channel_id=channel_id,
            **kwargs,
        )
    ...
    def bulk_add_moderators(
        ...
        raw_response = self.raw.bulk_add_moderators(
            channel_id=channel_id,
        )
