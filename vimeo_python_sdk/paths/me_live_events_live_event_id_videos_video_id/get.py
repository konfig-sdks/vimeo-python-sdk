...
class BaseApi(api_client.Api):
    ...
    def _specific_video_mapped_args(
        self,
    ...
    async def _aspecific_video_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/live_events/{live_event_id}/videos/{video_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SpecificVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aspecific_video(
        self,
        live_event_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._specific_video_mapped_args(
            live_event_id=live_event_id,
            video_id=video_id,
        )
        return await self._aspecific_video_oapg(
    ...
    def specific_video(
        ...
        return self._specific_video_oapg(
            path_params=args.path,
        )

class SpecificVideo(BaseApi):
    ...
    async def aspecific_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aspecific_video(
            live_event_id=live_event_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def specific_video(
        ...
        raw_response = self.raw.specific_video(
            live_event_id=live_event_id,
            video_id=video_id,
        )
        if validate:
