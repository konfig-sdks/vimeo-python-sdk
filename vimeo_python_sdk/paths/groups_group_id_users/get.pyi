...
from vimeo_python_sdk.model.groups_users_get_group_users_response import GroupsUsersGetGroupUsersResponse as GroupsUsersGetGroupUsersResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.groups_users_get_group_users_response import GroupsUsersGetGroupUsersResponse
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.groups_users_get_group_users_response import GroupsUsersGetGroupUsersResponse as GroupsUsersGetGroupUsersResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoUserjson = GroupsUsersGetGroupUsersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GroupsUsersGetGroupUsersResponse
...
class GetGroupUsers(BaseApi):
    ...
    async def aget_group_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GroupsUsersGetGroupUsersResponsePydantic:
        ...
        if validate:
            return RootModel[GroupsUsersGetGroupUsersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GroupsUsersGetGroupUsersResponsePydantic, raw_response.body)
