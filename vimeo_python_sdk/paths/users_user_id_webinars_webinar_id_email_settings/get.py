...
class BaseApi(api_client.Api):
    ...
    def _get_customization_data_0_mapped_args(
        self,
    ...
    async def _aget_customization_data_0_oapg(
        self,
    ...
    def _get_customization_data_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCustomizationData0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="webinar\emails")
    async def aget_customization_data_0(
        self,
        user_id: typing.Union[int, float],
        webinar_id: str,
        **kwargs,
        ...
        args = self._get_customization_data_0_mapped_args(
            user_id=user_id,
            webinar_id=webinar_id,
        )
        return await self._aget_customization_data_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="webinar\emails")
    def get_customization_data_0(
        self,
        user_id: typing.Union[int, float],
        webinar_id: str,
    ) -> typing.Union[
        ...
        return self._get_customization_data_0_oapg(
            path_params=args.path,
        )

class GetCustomizationData0(BaseApi):
    ...
    async def aget_customization_data_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_customization_data_0(
            user_id=user_id,
            webinar_id=webinar_id,
            **kwargs,
        )
    ...
    def get_customization_data_0(
        ...
        raw_response = self.raw.get_customization_data_0(
            user_id=user_id,
            webinar_id=webinar_id,
        )
        if validate:
