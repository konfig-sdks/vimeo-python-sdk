...
class Videos0Raw(BaseApi):
    ...
    async def avideos_0(
        ...
        **kwargs,
        ...
        args = self._videos_0_mapped_args(
            user_id=user_id,
            uris=uris,
        )
        return await self._avideos_0_oapg(
    ...
    def videos_0(
        ...
        return self._videos_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class Videos0(BaseApi):
    ...
    async def avideos_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avideos_0(
            user_id=user_id,
            uris=uris,
            **kwargs,
        )
    ...
    def videos_0(
        ...
        raw_response = self.raw.videos_0(
            user_id=user_id,
            uris=uris,
        )
