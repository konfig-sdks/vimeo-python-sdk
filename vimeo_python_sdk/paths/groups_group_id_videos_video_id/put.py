...
class AddToGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_group(
        self,
        group_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_to_group_mapped_args(
            group_id=group_id,
            video_id=video_id,
        )
        return await self._aadd_to_group_oapg(
    ...
    def add_to_group(
        ...
        return self._add_to_group_oapg(
            path_params=args.path,
        )

class AddToGroup(BaseApi):
    ...
    async def aadd_to_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_to_group(
            group_id=group_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def add_to_group(
        ...
        raw_response = self.raw.add_to_group(
            group_id=group_id,
            video_id=video_id,
        )
        if validate:
