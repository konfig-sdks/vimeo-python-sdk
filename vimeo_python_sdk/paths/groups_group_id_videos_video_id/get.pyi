...
class BaseApi(api_client.Api):
    ...
    def _get_single_video_mapped_args(
        self,
    ...
    async def _aget_single_video_oapg(
        self,
...
class GetSingleVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_video(
        self,
        group_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_single_video_mapped_args(
            group_id=group_id,
            video_id=video_id,
        )
        return await self._aget_single_video_oapg(
    ...
    def get_single_video(
        ...
        return self._get_single_video_oapg(
            path_params=args.path,
        )

class GetSingleVideo(BaseApi):
    ...
    async def aget_single_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_video(
            group_id=group_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_single_video(
        ...
        raw_response = self.raw.get_single_video(
            group_id=group_id,
            video_id=video_id,
        )
        if validate:
