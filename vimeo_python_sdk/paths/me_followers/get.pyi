...
from vimeo_python_sdk.model.users_followers_list_all_response import UsersFollowersListAllResponse as UsersFollowersListAllResponseSchema

from vimeo_python_sdk.type.users_followers_list_all_response import UsersFollowersListAllResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.users_followers_list_all_response import UsersFollowersListAllResponse as UsersFollowersListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoUserjson = UsersFollowersListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersFollowersListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersFollowersListAllResponsePydantic:
        ...
        if validate:
            return RootModel[UsersFollowersListAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UsersFollowersListAllResponsePydantic, raw_response.body)
