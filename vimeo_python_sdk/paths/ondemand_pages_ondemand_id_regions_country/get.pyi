...
class BaseApi(api_client.Api):
    ...
    def _get_specific_region_mapped_args(
        self,
        country: str,
    ...
    async def _aget_specific_region_oapg(
        self,
...
class GetSpecificRegionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_region(
        self,
        country: str,
        ondemand_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_region_mapped_args(
            country=country,
            ondemand_id=ondemand_id,
        )
        return await self._aget_specific_region_oapg(
    ...
    def get_specific_region(
        ...
        return self._get_specific_region_oapg(
            path_params=args.path,
        )

class GetSpecificRegion(BaseApi):
    ...
    async def aget_specific_region(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_region(
            country=country,
            ondemand_id=ondemand_id,
            **kwargs,
        )
    ...
    def get_specific_region(
        ...
        raw_response = self.raw.get_specific_region(
            country=country,
            ondemand_id=ondemand_id,
        )
        if validate:
