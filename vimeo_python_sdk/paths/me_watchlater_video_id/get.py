...
class BaseApi(api_client.Api):
    ...
    def _check_video_in_queue_mapped_args(
        self,
    ...
    async def _acheck_video_in_queue_oapg(
        self,
    ...
    def _check_video_in_queue_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckVideoInQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_video_in_queue(
        self,
        video_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_video_in_queue_mapped_args(
            video_id=video_id,
        )
        return await self._acheck_video_in_queue_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_video_in_queue(
        self,
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._check_video_in_queue_oapg(
            path_params=args.path,
        )

class CheckVideoInQueue(BaseApi):
    ...
    async def acheck_video_in_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_video_in_queue(
            video_id=video_id,
            **kwargs,
        )
        if validate:
    ...
    def check_video_in_queue(
        ...
        raw_response = self.raw.check_video_in_queue(
            video_id=video_id,
        )
        if validate:
            return VideoPydantic(**raw_response.body)
