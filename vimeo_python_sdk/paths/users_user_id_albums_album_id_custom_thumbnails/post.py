...
class BaseApi(api_client.Api):
    ...
    def _add_custom_thumbnail_mapped_args(
        self,
    ...
    async def _aadd_custom_thumbnail_oapg(
        self,
    ...
    def _add_custom_thumbnail_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddCustomThumbnailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_custom_thumbnail(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_custom_thumbnail_mapped_args(
            album_id=album_id,
            user_id=user_id,
        )
        return await self._aadd_custom_thumbnail_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def add_custom_thumbnail(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._add_custom_thumbnail_oapg(
            path_params=args.path,
        )

class AddCustomThumbnail(BaseApi):
    ...
    async def aadd_custom_thumbnail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_custom_thumbnail(
            album_id=album_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def add_custom_thumbnail(
        ...
        raw_response = self.raw.add_custom_thumbnail(
            album_id=album_id,
            user_id=user_id,
        )
        if validate:
