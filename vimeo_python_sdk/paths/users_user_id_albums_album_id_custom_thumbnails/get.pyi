...
from vimeo_python_sdk.model.showcases_custom_showcase_thumbnails_list_response import ShowcasesCustomShowcaseThumbnailsListResponse as ShowcasesCustomShowcaseThumbnailsListResponseSchema
...
from vimeo_python_sdk.type.showcases_custom_showcase_thumbnails_list_response import ShowcasesCustomShowcaseThumbnailsListResponse
...
from vimeo_python_sdk.pydantic.showcases_custom_showcase_thumbnails_list_response import ShowcasesCustomShowcaseThumbnailsListResponse as ShowcasesCustomShowcaseThumbnailsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoPicturejson = ShowcasesCustomShowcaseThumbnailsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShowcasesCustomShowcaseThumbnailsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShowcasesCustomShowcaseThumbnailsListResponsePydantic:
        ...
        if validate:
            return RootModel[ShowcasesCustomShowcaseThumbnailsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ShowcasesCustomShowcaseThumbnailsListResponsePydantic, raw_response.body)
