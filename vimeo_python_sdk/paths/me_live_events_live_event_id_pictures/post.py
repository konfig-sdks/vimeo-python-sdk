...
from vimeo_python_sdk.model.live_event_thumbnails_add_thumbnail_request import LiveEventThumbnailsAddThumbnailRequest as LiveEventThumbnailsAddThumbnailRequestSchema
...
from vimeo_python_sdk.type.live_event_thumbnails_add_thumbnail_request import LiveEventThumbnailsAddThumbnailRequest
...
from vimeo_python_sdk.pydantic.live_event_thumbnails_add_thumbnail_request import LiveEventThumbnailsAddThumbnailRequest as LiveEventThumbnailsAddThumbnailRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoPicturejson = LiveEventThumbnailsAddThumbnailRequestSchema


request_body_live_event_thumbnails_add_thumbnail_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_thumbnail_mapped_args(
        self,
    ...
    async def _aadd_thumbnail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/live_events/{live_event_id}/pictures',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_thumbnails_add_thumbnail_request.serialize(body, content_type)
...
class AddThumbnailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_thumbnail(
        self,
        live_event_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._add_thumbnail_mapped_args(
            live_event_id=live_event_id,
            active=active,
        )
        return await self._aadd_thumbnail_oapg(
            body=args.body,
    ...
    def add_thumbnail(
        ...
        return self._add_thumbnail_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddThumbnail(BaseApi):
    ...
    async def aadd_thumbnail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_thumbnail(
            live_event_id=live_event_id,
            active=active,
            **kwargs,
        )
    ...
    def add_thumbnail(
        ...
        raw_response = self.raw.add_thumbnail(
            live_event_id=live_event_id,
            active=active,
        )
        if validate:
