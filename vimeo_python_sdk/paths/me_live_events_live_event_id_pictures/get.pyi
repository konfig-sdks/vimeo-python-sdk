...
from vimeo_python_sdk.model.live_event_thumbnails_get_all_response import LiveEventThumbnailsGetAllResponse as LiveEventThumbnailsGetAllResponseSchema

from vimeo_python_sdk.type.live_event_thumbnails_get_all_response import LiveEventThumbnailsGetAllResponse
from vimeo_python_sdk.type.error import Error

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.live_event_thumbnails_get_all_response import LiveEventThumbnailsGetAllResponse as LiveEventThumbnailsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoPicturejson = LiveEventThumbnailsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LiveEventThumbnailsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LiveEventThumbnailsGetAllResponsePydantic:
        raw_response = await self.raw.aget_all(
            live_event_id=live_event_id,
            **kwargs,
        )
        if validate:
            return RootModel[LiveEventThumbnailsGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(LiveEventThumbnailsGetAllResponsePydantic, raw_response.body)
