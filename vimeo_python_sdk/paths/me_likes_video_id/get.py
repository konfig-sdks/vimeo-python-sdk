...
class BaseApi(api_client.Api):
    ...
    def _check_user_liked_video_mapped_args(
        self,
    ...
    async def _acheck_user_liked_video_oapg(
        self,
    ...
    def _check_user_liked_video_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckUserLikedVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_user_liked_video(
        self,
        video_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_user_liked_video_mapped_args(
            video_id=video_id,
        )
        return await self._acheck_user_liked_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_user_liked_video(
        self,
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._check_user_liked_video_oapg(
            path_params=args.path,
        )

class CheckUserLikedVideo(BaseApi):
    ...
    async def acheck_user_liked_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_user_liked_video(
            video_id=video_id,
            **kwargs,
        )
    ...
    def check_user_liked_video(
        ...
        raw_response = self.raw.check_user_liked_video(
            video_id=video_id,
        )
