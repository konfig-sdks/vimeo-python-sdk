...
class UnlikeVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunlike_video(
        self,
        video_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unlike_video_mapped_args(
            video_id=video_id,
        )
        return await self._aunlike_video_oapg(
    ...
    def unlike_video(
        ...
        return self._unlike_video_oapg(
            path_params=args.path,
        )

class UnlikeVideo(BaseApi):
    ...
    async def aunlike_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunlike_video(
            video_id=video_id,
            **kwargs,
        )
    ...
    def unlike_video(
        ...
        raw_response = self.raw.unlike_video(
            video_id=video_id,
        )
