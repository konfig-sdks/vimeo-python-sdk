...
class LikeVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alike_video(
        self,
        video_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._like_video_mapped_args(
            video_id=video_id,
        )
        return await self._alike_video_oapg(
    ...
    def like_video(
        ...
        return self._like_video_oapg(
            path_params=args.path,
        )

class LikeVideo(BaseApi):
    ...
    async def alike_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alike_video(
            video_id=video_id,
            **kwargs,
        )
    ...
    def like_video(
        ...
        raw_response = self.raw.like_video(
            video_id=video_id,
        )
