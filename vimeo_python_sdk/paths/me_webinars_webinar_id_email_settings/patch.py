...
from vimeo_python_sdk.model.webinar_emails_customize_preferences_request import WebinarEmailsCustomizePreferencesRequest as WebinarEmailsCustomizePreferencesRequestSchema
from vimeo_python_sdk.model.error import Error as ErrorSchema
from vimeo_python_sdk.model.webinar_emails_customize_preferences_request_email_preferences import WebinarEmailsCustomizePreferencesRequestEmailPreferences as WebinarEmailsCustomizePreferencesRequestEmailPreferencesSchema
...
from vimeo_python_sdk.type.webinar_emails_customize_preferences_request import WebinarEmailsCustomizePreferencesRequest

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.webinar_emails_customize_preferences_request import WebinarEmailsCustomizePreferencesRequest as WebinarEmailsCustomizePreferencesRequestPydantic
from vimeo_python_sdk.pydantic.webinar_email_settings import WebinarEmailSettings as WebinarEmailSettingsPydantic
from vimeo_python_sdk.pydantic.webinar_emails_customize_preferences_request_email_preferences import WebinarEmailsCustomizePreferencesRequestEmailPreferences as WebinarEmailsCustomizePreferencesRequestEmailPreferencesPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoWebinarEmailSettingsjson = WebinarEmailsCustomizePreferencesRequestSchema


request_body_webinar_emails_customize_preferences_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _customize_preferences_mapped_args(
        self,
        webinar_id: str,
        ...
        email_preferences: typing.Optional[WebinarEmailsCustomizePreferencesRequestEmailPreferences] = None,
    ...
    async def _acustomize_preferences_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/webinars/{webinar_id}/email_settings',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_webinar_emails_customize_preferences_request.serialize(body, content_type)
    ...
    def _customize_preferences_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CustomizePreferencesRaw(BaseApi):
    ...
    async def acustomize_preferences(
        ...
        **kwargs,
        ...
        args = self._customize_preferences_mapped_args(
        ...
        return await self._acustomize_preferences_oapg(
            body=args.body,
    ...
    def customize_preferences(
        ...
        return self._customize_preferences_oapg(
            body=args.body,
            path_params=args.path,
        )

class CustomizePreferences(BaseApi):
    ...
    async def acustomize_preferences(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acustomize_preferences(
            webinar_id=webinar_id,
            accent_color=accent_color,
            custom_link=custom_link,
            email_event_reminder_24_hrs=email_event_reminder_24_hrs,
    ...
    def customize_preferences(
        ...
        raw_response = self.raw.customize_preferences(
            webinar_id=webinar_id,
            accent_color=accent_color,
            custom_link=custom_link,
            email_event_reminder_24_hrs=email_event_reminder_24_hrs,
