...
class BaseApi(api_client.Api):
    ...
    def _get_customization_data_mapped_args(
        self,
        webinar_id: str,
    ...
    async def _aget_customization_data_oapg(
        self,
    ...
    def _get_customization_data_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCustomizationDataRaw(BaseApi):
    ...
    async def aget_customization_data(
        ...
        **kwargs,
        ...
        args = self._get_customization_data_mapped_args(
            webinar_id=webinar_id,
        )
        return await self._aget_customization_data_oapg(
    ...
    def get_customization_data(
        ...
        return self._get_customization_data_oapg(
            path_params=args.path,
        )

class GetCustomizationData(BaseApi):
    ...
    async def aget_customization_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_customization_data(
            webinar_id=webinar_id,
            **kwargs,
        )
        if validate:
    ...
    def get_customization_data(
        ...
        raw_response = self.raw.get_customization_data(
            webinar_id=webinar_id,
        )
        if validate:
            return WebinarEmailSettingsPydantic(**raw_response.body)
