...
class BaseApi(api_client.Api):
    ...
    def _get_specific_user_logo_mapped_args(
        self,
    ...
    async def _aget_specific_user_logo_oapg(
        self,
    ...
    def _get_specific_user_logo_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificUserLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_user_logo(
        self,
        logo_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_user_logo_mapped_args(
            logo_id=logo_id,
        )
        return await self._aget_specific_user_logo_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_user_logo(
        self,
        logo_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_user_logo_oapg(
            path_params=args.path,
        )

class GetSpecificUserLogo(BaseApi):
    ...
    async def aget_specific_user_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_user_logo(
            logo_id=logo_id,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_user_logo(
        ...
        raw_response = self.raw.get_specific_user_logo(
            logo_id=logo_id,
        )
        if validate:
            return PicturePydantic(**raw_response.body)
