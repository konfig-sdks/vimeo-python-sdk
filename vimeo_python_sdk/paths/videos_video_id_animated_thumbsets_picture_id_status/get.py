...
# Path params
PictureIdSchema = schemas.StrSchema
VideoIdSchema = schemas.NumberSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'picture_id': typing.Union[PictureIdSchema, str, ],
...
class BaseApi(api_client.Api):
    ...
    def _get_status_of_set_mapped_args(
        self,
        picture_id: str,
    ...
    async def _aget_status_of_set_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/videos/{video_id}/animated_thumbsets/{picture_id}/status',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetStatusOfSetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_status_of_set(
        self,
        picture_id: str,
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_status_of_set_mapped_args(
            picture_id=picture_id,
            video_id=video_id,
        )
        return await self._aget_status_of_set_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_status_of_set(
        self,
        picture_id: str,
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_status_of_set_oapg(
            path_params=args.path,
        )

class GetStatusOfSet(BaseApi):
    ...
    async def aget_status_of_set(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_status_of_set(
            picture_id=picture_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_status_of_set(
        ...
        raw_response = self.raw.get_status_of_set(
            picture_id=picture_id,
            video_id=video_id,
        )
        if validate:
