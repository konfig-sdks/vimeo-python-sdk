...
class BaseApi(api_client.Api):
    ...
    def _remove_video_from_showcase_mapped_args(
        self,
    ...
    async def _aremove_video_from_showcase_oapg(
        self,
    ...
    def _remove_video_from_showcase_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveVideoFromShowcaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_video_from_showcase(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_video_from_showcase_mapped_args(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
        )
        return await self._aremove_video_from_showcase_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_video_from_showcase(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        ...
        return self._remove_video_from_showcase_oapg(
            path_params=args.path,
        )

class RemoveVideoFromShowcase(BaseApi):
    ...
    async def aremove_video_from_showcase(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_video_from_showcase(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
            **kwargs,
    ...
    def remove_video_from_showcase(
        ...
        raw_response = self.raw.remove_video_from_showcase(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
        )
