...
class BaseApi(api_client.Api):
    ...
    def _add_to_showcase_0_mapped_args(
        self,
    ...
    async def _aadd_to_showcase_0_oapg(
        self,
...
class AddToShowcase0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_showcase_0(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_to_showcase_0_mapped_args(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
        )
        return await self._aadd_to_showcase_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def add_to_showcase_0(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        ...
        return self._add_to_showcase_0_oapg(
            path_params=args.path,
        )

class AddToShowcase0(BaseApi):
    ...
    async def aadd_to_showcase_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_to_showcase_0(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
            **kwargs,
    ...
    def add_to_showcase_0(
        ...
        raw_response = self.raw.add_to_showcase_0(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
        )
