...
class BaseApi(api_client.Api):
    ...
    def _remove_single_video_mapped_args(
        self,
    ...
    async def _aremove_single_video_oapg(
        self,
...
class RemoveSingleVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_single_video(
        self,
        project_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_single_video_mapped_args(
            project_id=project_id,
            video_id=video_id,
        )
        return await self._aremove_single_video_oapg(
    ...
    def remove_single_video(
        ...
        return self._remove_single_video_oapg(
            path_params=args.path,
        )

class RemoveSingleVideo(BaseApi):
    ...
    async def aremove_single_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_single_video(
            project_id=project_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def remove_single_video(
        ...
        raw_response = self.raw.remove_single_video(
            project_id=project_id,
            video_id=video_id,
        )
