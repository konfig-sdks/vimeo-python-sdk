...
class BaseApi(api_client.Api):
    ...
    def _get_video_in_category_mapped_args(
        self,
        category: str,
    ...
    async def _aget_video_in_category_oapg(
        self,
    ...
    def _get_video_in_category_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetVideoInCategoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_video_in_category(
        self,
        category: str,
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_video_in_category_mapped_args(
            category=category,
            video_id=video_id,
        )
        return await self._aget_video_in_category_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_video_in_category(
        self,
        category: str,
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_video_in_category_oapg(
            path_params=args.path,
        )

class GetVideoInCategory(BaseApi):
    ...
    async def aget_video_in_category(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_video_in_category(
            category=category,
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_video_in_category(
        ...
        raw_response = self.raw.get_video_in_category(
            category=category,
            video_id=video_id,
        )
        if validate:
