...
from vimeo_python_sdk.model.live_event_thumbnails_create_thumbnail_for_event_request1 import LiveEventThumbnailsCreateThumbnailForEventRequest1 as LiveEventThumbnailsCreateThumbnailForEventRequest1Schema

from vimeo_python_sdk.type.picture import Picture
from vimeo_python_sdk.type.error import Error
from vimeo_python_sdk.type.live_event_thumbnails_create_thumbnail_for_event_request1 import LiveEventThumbnailsCreateThumbnailForEventRequest1
...
from vimeo_python_sdk.pydantic.live_event_thumbnails_create_thumbnail_for_event_request1 import LiveEventThumbnailsCreateThumbnailForEventRequest1 as LiveEventThumbnailsCreateThumbnailForEventRequest1Pydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoPicturejson = LiveEventThumbnailsCreateThumbnailForEventRequest1Schema


request_body_live_event_thumbnails_create_thumbnail_for_event_request1 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_thumbnail_for_event_0_mapped_args(
        self,
    ...
    async def _acreate_thumbnail_for_event_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/live_events/{live_event_id}/pictures',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_thumbnails_create_thumbnail_for_event_request1.serialize(body, content_type)
    ...
    def _create_thumbnail_for_event_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateThumbnailForEvent0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_thumbnail_for_event_0(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._create_thumbnail_for_event_0_mapped_args(
            live_event_id=live_event_id,
            user_id=user_id,
            active=active,
        )
        return await self._acreate_thumbnail_for_event_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_thumbnail_for_event_0(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
        ...
        return self._create_thumbnail_for_event_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateThumbnailForEvent0(BaseApi):
    ...
    async def acreate_thumbnail_for_event_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_thumbnail_for_event_0(
            live_event_id=live_event_id,
            user_id=user_id,
            active=active,
            **kwargs,
    ...
    def create_thumbnail_for_event_0(
        ...
        raw_response = self.raw.create_thumbnail_for_event_0(
            live_event_id=live_event_id,
            user_id=user_id,
            active=active,
        )
