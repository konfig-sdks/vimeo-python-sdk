...
class VodRaw(BaseApi):
    ...
    async def avod(
        ...
        **kwargs,
        ...
        args = self._vod_mapped_args(
            ondemand_id=ondemand_id,
        )
        return await self._avod_oapg(
...
class Vod(BaseApi):
    ...
    async def avod(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avod(
            ondemand_id=ondemand_id,
            **kwargs,
        )
        if validate:
