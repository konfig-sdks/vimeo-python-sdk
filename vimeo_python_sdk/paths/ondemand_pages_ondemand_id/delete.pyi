...
class BaseApi(api_client.Api):
    ...
    def _delete_on_demand_page_mapped_args(
        self,
    ...
    async def _adelete_on_demand_page_oapg(
        self,
    ...
    def _delete_on_demand_page_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteOnDemandPageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_on_demand_page(
        self,
        ondemand_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_on_demand_page_mapped_args(
            ondemand_id=ondemand_id,
        )
        return await self._adelete_on_demand_page_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_on_demand_page(
        self,
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_on_demand_page_oapg(
            path_params=args.path,
        )

class DeleteOnDemandPage(BaseApi):
    ...
    async def adelete_on_demand_page(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_on_demand_page(
            ondemand_id=ondemand_id,
            **kwargs,
        )
    ...
    def delete_on_demand_page(
        ...
        raw_response = self.raw.delete_on_demand_page(
            ondemand_id=ondemand_id,
        )
