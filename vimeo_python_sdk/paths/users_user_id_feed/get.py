...
from vimeo_python_sdk.model.get_feed_response import GetFeedResponse as GetFeedResponseSchema

from vimeo_python_sdk.type.get_feed_response import GetFeedResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.get_feed_response import GetFeedResponse as GetFeedResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoActivityjson = GetFeedResponseSchema
...
class Feed(BaseApi):
    ...
    async def afeed(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetFeedResponsePydantic:
        raw_response = await self.raw.afeed(
            user_id=user_id,
            offset=offset,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[GetFeedResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetFeedResponsePydantic, raw_response.body)
