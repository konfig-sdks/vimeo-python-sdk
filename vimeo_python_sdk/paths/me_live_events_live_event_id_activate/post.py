...
from vimeo_python_sdk.model.live_event_activation_create_rtmp_links_request1 import LiveEventActivationCreateRtmpLinksRequest1 as LiveEventActivationCreateRtmpLinksRequest1Schema
...
from vimeo_python_sdk.type.live_event_activation_create_rtmp_links_request1 import LiveEventActivationCreateRtmpLinksRequest1
...
from vimeo_python_sdk.pydantic.live_event_activation_create_rtmp_links_request1 import LiveEventActivationCreateRtmpLinksRequest1 as LiveEventActivationCreateRtmpLinksRequest1Pydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoVideojson = LiveEventActivationCreateRtmpLinksRequest1Schema


request_body_live_event_activation_create_rtmp_links_request1 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_rtmp_links_0_mapped_args(
        self,
    ...
    async def _acreate_rtmp_links_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/live_events/{live_event_id}/activate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_activation_create_rtmp_links_request1.serialize(body, content_type)
...
class CreateRtmpLinks0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_rtmp_links_0(
        self,
        live_event_id: typing.Union[int, float],
        cloud_composing_streaming: typing.Optional[bool] = None,
        streaming_start_requested: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._create_rtmp_links_0_mapped_args(
        ...
        return await self._acreate_rtmp_links_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_rtmp_links_0(
        self,
        live_event_id: typing.Union[int, float],
        cloud_composing_streaming: typing.Optional[bool] = None,
        streaming_start_requested: typing.Optional[bool] = None,
        ...
        return self._create_rtmp_links_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateRtmpLinks0(BaseApi):
    ...
    async def acreate_rtmp_links_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_rtmp_links_0(
            live_event_id=live_event_id,
            cloud_composing_streaming=cloud_composing_streaming,
            streaming_start_requested=streaming_start_requested,
            **kwargs,
    ...
    def create_rtmp_links_0(
        ...
        raw_response = self.raw.create_rtmp_links_0(
            live_event_id=live_event_id,
            cloud_composing_streaming=cloud_composing_streaming,
            streaming_start_requested=streaming_start_requested,
        )
