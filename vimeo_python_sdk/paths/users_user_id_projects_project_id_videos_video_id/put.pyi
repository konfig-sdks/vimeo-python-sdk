...
class BaseApi(api_client.Api):
    ...
    def _add_single_folder_video_mapped_args(
        self,
    ...
    async def _aadd_single_folder_video_oapg(
        self,
    ...
    def _add_single_folder_video_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddSingleFolderVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_single_folder_video(
        self,
        project_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_single_folder_video_mapped_args(
            project_id=project_id,
            user_id=user_id,
            video_id=video_id,
        )
        return await self._aadd_single_folder_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def add_single_folder_video(
        self,
        project_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        ...
        return self._add_single_folder_video_oapg(
            path_params=args.path,
        )

class AddSingleFolderVideo(BaseApi):
    ...
    async def aadd_single_folder_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_single_folder_video(
            project_id=project_id,
            user_id=user_id,
            video_id=video_id,
            **kwargs,
    ...
    def add_single_folder_video(
        ...
        raw_response = self.raw.add_single_folder_video(
            project_id=project_id,
            user_id=user_id,
            video_id=video_id,
        )
