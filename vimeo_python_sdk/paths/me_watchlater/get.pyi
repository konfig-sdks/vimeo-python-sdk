...
from vimeo_python_sdk.model.watch_later_queue_essentials_get_videos_in_queue_response import WatchLaterQueueEssentialsGetVideosInQueueResponse as WatchLaterQueueEssentialsGetVideosInQueueResponseSchema

from vimeo_python_sdk.type.watch_later_queue_essentials_get_videos_in_queue_response import WatchLaterQueueEssentialsGetVideosInQueueResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.watch_later_queue_essentials_get_videos_in_queue_response import WatchLaterQueueEssentialsGetVideosInQueueResponse as WatchLaterQueueEssentialsGetVideosInQueueResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = WatchLaterQueueEssentialsGetVideosInQueueResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WatchLaterQueueEssentialsGetVideosInQueueResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_videos_in_queue_mapped_args(
        self,
    ...
    async def _aget_videos_in_queue_oapg(
        self,
...
class GetVideosInQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_videos_in_queue(
        self,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        filter_embeddable: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_videos_in_queue_mapped_args(
            direction=direction,
            filter=filter,
        ...
        return await self._aget_videos_in_queue_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_videos_in_queue(
        self,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        filter_embeddable: typing.Optional[bool] = None,
        ...
        return self._get_videos_in_queue_oapg(
            query_params=args.query,
        )

class GetVideosInQueue(BaseApi):
    ...
    async def aget_videos_in_queue(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WatchLaterQueueEssentialsGetVideosInQueueResponsePydantic:
        raw_response = await self.raw.aget_videos_in_queue(
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
            page=page,
        ...
        if validate:
            return RootModel[WatchLaterQueueEssentialsGetVideosInQueueResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(WatchLaterQueueEssentialsGetVideosInQueueResponsePydantic, raw_response.body)
    ...
    def get_videos_in_queue(
        ...
        raw_response = self.raw.get_videos_in_queue(
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
            page=page,
