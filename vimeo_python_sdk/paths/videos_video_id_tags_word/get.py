...
SchemaFor404ResponseBodyApplicationVndVimeoTagjson = LegacyErrorSchema
...
_response_for_404 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.tag+json': api_client.MediaType(
            schema=SchemaFor404ResponseBodyApplicationVndVimeoTagjson),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _check_tag_video_mapped_args(
        self,
    ...
    async def _acheck_tag_video_oapg(
        self,
...
class CheckTagVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_tag_video(
        self,
        video_id: typing.Union[int, float],
        word: str,
        **kwargs,
        ...
        args = self._check_tag_video_mapped_args(
            video_id=video_id,
            word=word,
        )
        return await self._acheck_tag_video_oapg(
    ...
    def check_tag_video(
        ...
        return self._check_tag_video_oapg(
            path_params=args.path,
        )

class CheckTagVideo(BaseApi):
    ...
    async def acheck_tag_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_tag_video(
            video_id=video_id,
            word=word,
            **kwargs,
        )
    ...
    def check_tag_video(
        ...
        raw_response = self.raw.check_tag_video(
            video_id=video_id,
            word=word,
        )
        if validate:
