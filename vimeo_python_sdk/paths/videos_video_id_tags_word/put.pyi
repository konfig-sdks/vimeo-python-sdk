...
from vimeo_python_sdk.model.tag import Tag as TagSchema
...
from vimeo_python_sdk.pydantic.tag import Tag as TagPydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoTagjson = TagSchema
...
class BaseApi(api_client.Api):
    ...
    def _add_tag_to_video_mapped_args(
        self,
    ...
    async def _aadd_tag_to_video_oapg(
        self,
...
class AddTagToVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_tag_to_video(
        self,
        video_id: typing.Union[int, float],
        word: str,
        **kwargs,
        ...
        args = self._add_tag_to_video_mapped_args(
            video_id=video_id,
            word=word,
        )
        return await self._aadd_tag_to_video_oapg(
    ...
    def add_tag_to_video(
        ...
        return self._add_tag_to_video_oapg(
            path_params=args.path,
        )

class AddTagToVideo(BaseApi):
    ...
    async def aadd_tag_to_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_tag_to_video(
            video_id=video_id,
            word=word,
            **kwargs,
        )
    ...
    def add_tag_to_video(
        ...
        raw_response = self.raw.add_tag_to_video(
            video_id=video_id,
            word=word,
        )
        if validate:
