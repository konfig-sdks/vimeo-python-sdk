...
class Video0Raw(BaseApi):
    ...
    async def avideo_0(
        ...
        **kwargs,
        ...
        args = self._video_0_mapped_args(
            user_id=user_id,
            video_id=video_id,
        )
        return await self._avideo_0_oapg(
    ...
    def video_0(
        ...
        return self._video_0_oapg(
            path_params=args.path,
        )

class Video0(BaseApi):
    ...
    async def avideo_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avideo_0(
            user_id=user_id,
            video_id=video_id,
            **kwargs,
        )
