...
from vimeo_python_sdk.model.showcases_showcase_videos_get_showcase_videos_response import ShowcasesShowcaseVideosGetShowcaseVideosResponse as ShowcasesShowcaseVideosGetShowcaseVideosResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.showcases_showcase_videos_get_showcase_videos_response import ShowcasesShowcaseVideosGetShowcaseVideosResponse
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.showcases_showcase_videos_get_showcase_videos_response import ShowcasesShowcaseVideosGetShowcaseVideosResponse as ShowcasesShowcaseVideosGetShowcaseVideosResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = ShowcasesShowcaseVideosGetShowcaseVideosResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShowcasesShowcaseVideosGetShowcaseVideosResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_showcase_videos_mapped_args(
        self,
    ...
    async def _aget_showcase_videos_oapg(
        self,
...
class GetShowcaseVideosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_showcase_videos(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        containing_uri: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_showcase_videos_mapped_args(
            album_id=album_id,
            user_id=user_id,
        ...
        return await self._aget_showcase_videos_oapg(
    ...
    def get_showcase_videos(
        ...
        return self._get_showcase_videos_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetShowcaseVideos(BaseApi):
    ...
    async def aget_showcase_videos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShowcasesShowcaseVideosGetShowcaseVideosResponsePydantic:
        raw_response = await self.raw.aget_showcase_videos(
            album_id=album_id,
            user_id=user_id,
            containing_uri=containing_uri,
            direction=direction,
        ...
        if validate:
            return RootModel[ShowcasesShowcaseVideosGetShowcaseVideosResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ShowcasesShowcaseVideosGetShowcaseVideosResponsePydantic, raw_response.body)
    ...
    def get_showcase_videos(
        ...
        raw_response = self.raw.get_showcase_videos(
            album_id=album_id,
            user_id=user_id,
            containing_uri=containing_uri,
            direction=direction,
