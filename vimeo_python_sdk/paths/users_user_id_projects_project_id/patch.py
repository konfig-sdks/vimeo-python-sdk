...
from vimeo_python_sdk.model.edit_project_request import EditProjectRequest as EditProjectRequestSchema

from vimeo_python_sdk.type.edit_project_request import EditProjectRequest
from vimeo_python_sdk.type.error import Error
from vimeo_python_sdk.type.project import Project

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.edit_project_request import EditProjectRequest as EditProjectRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EditProjectRequestSchema


request_body_edit_project_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _aproject_2_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_edit_project_request.serialize(body, content_type)
...
class Project2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aproject_2(
        self,
        name: str,
        project_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._project_2_mapped_args(
            name=name,
            project_id=project_id,
            user_id=user_id,
        )
        return await self._aproject_2_oapg(
            body=args.body,
    ...
    def project_2(
        ...
        return self._project_2_oapg(
            body=args.body,
            path_params=args.path,
        )

class Project2(BaseApi):
    ...
    async def aproject_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aproject_2(
            name=name,
            project_id=project_id,
            user_id=user_id,
            **kwargs,
    ...
    def project_2(
        ...
        raw_response = self.raw.project_2(
            name=name,
            project_id=project_id,
            user_id=user_id,
        )
