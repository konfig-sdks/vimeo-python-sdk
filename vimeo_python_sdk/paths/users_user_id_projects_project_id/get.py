...
class Project0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aproject_0(
        self,
        project_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._project_0_mapped_args(
            project_id=project_id,
            user_id=user_id,
        )
        return await self._aproject_0_oapg(
    ...
    def project_0(
        ...
        return self._project_0_oapg(
            path_params=args.path,
        )

class Project0(BaseApi):
    ...
    async def aproject_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aproject_0(
            project_id=project_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def project_0(
        ...
        raw_response = self.raw.project_0(
            project_id=project_id,
            user_id=user_id,
        )
        if validate:
