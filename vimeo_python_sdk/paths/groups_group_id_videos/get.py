...
from vimeo_python_sdk.model.groups_videos_get_all_group_videos_response import GroupsVideosGetAllGroupVideosResponse as GroupsVideosGetAllGroupVideosResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.groups_videos_get_all_group_videos_response import GroupsVideosGetAllGroupVideosResponse
...
from vimeo_python_sdk.pydantic.groups_videos_get_all_group_videos_response import GroupsVideosGetAllGroupVideosResponse as GroupsVideosGetAllGroupVideosResponsePydantic
...
# Path params
GroupIdSchema = schemas.NumberSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'group_id': typing.Union[GroupIdSchema, decimal.Decimal, int, float, ],
    }
)
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = GroupsVideosGetAllGroupVideosResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GroupsVideosGetAllGroupVideosResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_group_videos_mapped_args(
        self,
    ...
    async def _aget_all_group_videos_oapg(
        self,
    ...
    def _get_all_group_videos_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAllGroupVideosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_group_videos(
        self,
        group_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_group_videos_mapped_args(
            group_id=group_id,
            direction=direction,
            filter=filter,
        ...
        return await self._aget_all_group_videos_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_group_videos(
        self,
        group_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        return self._get_all_group_videos_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllGroupVideos(BaseApi):
    ...
    async def aget_all_group_videos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GroupsVideosGetAllGroupVideosResponsePydantic:
        raw_response = await self.raw.aget_all_group_videos(
            group_id=group_id,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
        ...
        if validate:
            return RootModel[GroupsVideosGetAllGroupVideosResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GroupsVideosGetAllGroupVideosResponsePydantic, raw_response.body)
    ...
    def get_all_group_videos(
        ...
        raw_response = self.raw.get_all_group_videos(
            group_id=group_id,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
