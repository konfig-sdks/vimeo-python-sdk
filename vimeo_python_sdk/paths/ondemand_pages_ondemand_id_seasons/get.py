...
from vimeo_python_sdk.model.on_demand_seasons_list_all_response import OnDemandSeasonsListAllResponse as OnDemandSeasonsListAllResponseSchema

from vimeo_python_sdk.type.on_demand_seasons_list_all_response import OnDemandSeasonsListAllResponse
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.on_demand_seasons_list_all_response import OnDemandSeasonsListAllResponse as OnDemandSeasonsListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoOndemandSeasonjson = OnDemandSeasonsListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OnDemandSeasonsListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OnDemandSeasonsListAllResponsePydantic:
        ...
        if validate:
            return RootModel[OnDemandSeasonsListAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OnDemandSeasonsListAllResponsePydantic, raw_response.body)
