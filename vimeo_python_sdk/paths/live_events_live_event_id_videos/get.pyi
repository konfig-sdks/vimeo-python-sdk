...
from vimeo_python_sdk.model.live_event_videos_list_live_event_videos_response import LiveEventVideosListLiveEventVideosResponse as LiveEventVideosListLiveEventVideosResponseSchema

from vimeo_python_sdk.type.error import Error
from vimeo_python_sdk.type.live_event_videos_list_live_event_videos_response import LiveEventVideosListLiveEventVideosResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.live_event_videos_list_live_event_videos_response import LiveEventVideosListLiveEventVideosResponse as LiveEventVideosListLiveEventVideosResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = LiveEventVideosListLiveEventVideosResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LiveEventVideosListLiveEventVideosResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_live_event_videos_mapped_args(
        self,
    ...
    async def _alist_live_event_videos_oapg(
        self,
    ...
    def _list_live_event_videos_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListLiveEventVideosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_live_event_videos(
        self,
        live_event_id: typing.Union[int, float],
        containing_uri: typing.Optional[str] = None,
        direction: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_live_event_videos_mapped_args(
        ...
        return await self._alist_live_event_videos_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_live_event_videos(
        self,
        live_event_id: typing.Union[int, float],
        containing_uri: typing.Optional[str] = None,
        direction: typing.Optional[str] = None,
        ...
        return self._list_live_event_videos_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListLiveEventVideos(BaseApi):
    ...
    async def alist_live_event_videos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LiveEventVideosListLiveEventVideosResponsePydantic:
        raw_response = await self.raw.alist_live_event_videos(
            live_event_id=live_event_id,
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
        ...
        if validate:
            return RootModel[LiveEventVideosListLiveEventVideosResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(LiveEventVideosListLiveEventVideosResponsePydantic, raw_response.body)
    ...
    def list_live_event_videos(
        ...
        raw_response = self.raw.list_live_event_videos(
            live_event_id=live_event_id,
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
