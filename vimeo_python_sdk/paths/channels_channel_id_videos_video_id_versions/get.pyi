...
from vimeo_python_sdk.model.videos_versions_get_all_video_versions_response import VideosVersionsGetAllVideoVersionsResponse as VideosVersionsGetAllVideoVersionsResponseSchema
...
from vimeo_python_sdk.type.videos_versions_get_all_video_versions_response import VideosVersionsGetAllVideoVersionsResponse
...
from vimeo_python_sdk.pydantic.videos_versions_get_all_video_versions_response import VideosVersionsGetAllVideoVersionsResponse as VideosVersionsGetAllVideoVersionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideoVersionjson = VideosVersionsGetAllVideoVersionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VideosVersionsGetAllVideoVersionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_video_versions_mapped_args(
        self,
    ...
    async def _aget_all_video_versions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/channels/{channel_id}/videos/{video_id}/versions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_all_video_versions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAllVideoVersionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_video_versions(
        self,
        channel_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        page: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_video_versions_mapped_args(
            channel_id=channel_id,
            video_id=video_id,
            page=page,
            per_page=per_page,
        )
        return await self._aget_all_video_versions_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_video_versions(
        self,
        channel_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        page: typing.Optional[typing.Union[int, float]] = None,
        ...
        return self._get_all_video_versions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllVideoVersions(BaseApi):
    ...
    async def aget_all_video_versions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VideosVersionsGetAllVideoVersionsResponsePydantic:
        raw_response = await self.raw.aget_all_video_versions(
            channel_id=channel_id,
            video_id=video_id,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[VideosVersionsGetAllVideoVersionsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VideosVersionsGetAllVideoVersionsResponsePydantic, raw_response.body)
    ...
    def get_all_video_versions(
        ...
        raw_response = self.raw.get_all_video_versions(
            channel_id=channel_id,
            video_id=video_id,
            page=page,
            per_page=per_page,
