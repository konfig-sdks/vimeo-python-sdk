...
class BaseApi(api_client.Api):
    ...
    def _unsubscribe_user_from_channel_mapped_args(
        self,
    ...
    async def _aunsubscribe_user_from_channel_oapg(
        self,
    ...
    def _unsubscribe_user_from_channel_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UnsubscribeUserFromChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunsubscribe_user_from_channel(
        self,
        channel_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unsubscribe_user_from_channel_mapped_args(
            channel_id=channel_id,
        )
        return await self._aunsubscribe_user_from_channel_oapg(
    ...
    def unsubscribe_user_from_channel(
        ...
        return self._unsubscribe_user_from_channel_oapg(
            path_params=args.path,
        )

class UnsubscribeUserFromChannel(BaseApi):
    ...
    async def aunsubscribe_user_from_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunsubscribe_user_from_channel(
            channel_id=channel_id,
            **kwargs,
        )
    ...
    def unsubscribe_user_from_channel(
        ...
        raw_response = self.raw.unsubscribe_user_from_channel(
            channel_id=channel_id,
        )
