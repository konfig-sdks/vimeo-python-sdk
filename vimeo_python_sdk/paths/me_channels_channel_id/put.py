...
class BaseApi(api_client.Api):
    ...
    def _subscribe_user_to_channel_mapped_args(
        self,
    ...
    async def _asubscribe_user_to_channel_oapg(
        self,
    ...
    def _subscribe_user_to_channel_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SubscribeUserToChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubscribe_user_to_channel(
        self,
        channel_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._subscribe_user_to_channel_mapped_args(
            channel_id=channel_id,
        )
        return await self._asubscribe_user_to_channel_oapg(
    ...
    def subscribe_user_to_channel(
        ...
        return self._subscribe_user_to_channel_oapg(
            path_params=args.path,
        )

class SubscribeUserToChannel(BaseApi):
    ...
    async def asubscribe_user_to_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asubscribe_user_to_channel(
            channel_id=channel_id,
            **kwargs,
        )
    ...
    def subscribe_user_to_channel(
        ...
        raw_response = self.raw.subscribe_user_to_channel(
            channel_id=channel_id,
        )
