...
class Webinar0Raw(BaseApi):
    ...
    async def awebinar_0(
        ...
        **kwargs,
        ...
        args = self._webinar_0_mapped_args(
            user_id=user_id,
            webinar_id=webinar_id,
        )
        return await self._awebinar_0_oapg(
    ...
    def webinar_0(
        ...
        return self._webinar_0_oapg(
            path_params=args.path,
        )

class Webinar0(BaseApi):
    ...
    async def awebinar_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.awebinar_0(
            user_id=user_id,
            webinar_id=webinar_id,
            **kwargs,
        )
    ...
    def webinar_0(
        ...
        raw_response = self.raw.webinar_0(
            user_id=user_id,
            webinar_id=webinar_id,
        )
        if validate:
