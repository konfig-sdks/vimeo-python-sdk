...
SchemaFor400ResponseBodyApplicationVndVimeoAuthjson = LegacyErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _token_0_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _atoken_0_oapg(
        self,
...
class Token0Raw(BaseApi):
    ...
    async def atoken_0(
        ...
        **kwargs,
        ...
        args = self._token_0_mapped_args(
        )
        return await self._atoken_0_oapg(
            **kwargs,
        )
    ...
    def token_0(
        ...
        return self._token_0_oapg(
        )

class Token0(BaseApi):
    ...
    async def atoken_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atoken_0(
            **kwargs,
        )
