...
class BaseApi(api_client.Api):
    ...
    def _specific_promotion_get_mapped_args(
        self,
    ...
    async def _aspecific_promotion_get_oapg(
        self,
    ...
    def _specific_promotion_get_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SpecificPromotionGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aspecific_promotion_get(
        self,
        ondemand_id: typing.Union[int, float],
        promotion_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._specific_promotion_get_mapped_args(
            ondemand_id=ondemand_id,
            promotion_id=promotion_id,
        )
        return await self._aspecific_promotion_get_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def specific_promotion_get(
        self,
        ondemand_id: typing.Union[int, float],
        promotion_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._specific_promotion_get_oapg(
            path_params=args.path,
        )

class SpecificPromotionGet(BaseApi):
    ...
    async def aspecific_promotion_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aspecific_promotion_get(
            ondemand_id=ondemand_id,
            promotion_id=promotion_id,
            **kwargs,
        )
    ...
    def specific_promotion_get(
        ...
        raw_response = self.raw.specific_promotion_get(
            ondemand_id=ondemand_id,
            promotion_id=promotion_id,
        )
        if validate:
