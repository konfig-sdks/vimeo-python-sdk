...
class BaseApi(api_client.Api):
    ...
    def _get_specific_webinar_0_mapped_args(
        self,
        webinar_id: str,
    ...
    async def _aget_specific_webinar_0_oapg(
        self,
    ...
    def _get_specific_webinar_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificWebinar0Raw(BaseApi):
    ...
    async def aget_specific_webinar_0(
        ...
        **kwargs,
        ...
        args = self._get_specific_webinar_0_mapped_args(
            webinar_id=webinar_id,
        )
        return await self._aget_specific_webinar_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="webinar\essentials")
    def get_specific_webinar_0(
        self,
        webinar_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_webinar_0_oapg(
            path_params=args.path,
        )

class GetSpecificWebinar0(BaseApi):
    ...
    async def aget_specific_webinar_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_webinar_0(
            webinar_id=webinar_id,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_webinar_0(
        ...
        raw_response = self.raw.get_specific_webinar_0(
            webinar_id=webinar_id,
        )
        if validate:
            return WebinarPydantic(**raw_response.body)
