...
from vimeo_python_sdk.model.live_event_low_latency_toggle_option_request2 import LiveEventLowLatencyToggleOptionRequest2 as LiveEventLowLatencyToggleOptionRequest2Schema
...
from vimeo_python_sdk.type.live_event_low_latency_toggle_option_request2 import LiveEventLowLatencyToggleOptionRequest2
...
from vimeo_python_sdk.pydantic.live_event_low_latency_toggle_option_request2 import LiveEventLowLatencyToggleOptionRequest2 as LiveEventLowLatencyToggleOptionRequest2Pydantic
...
# body param
SchemaForRequestBodyApplicationApplicationVndVimeoLiveLowLatencyjson = LiveEventLowLatencyToggleOptionRequest2Schema


request_body_live_event_low_latency_toggle_option_request2 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _toggle_option_1_mapped_args(
        self,
    ...
    async def _atoggle_option_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/live_events/{live_event_id}/low_latency',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_low_latency_toggle_option_request2.serialize(body, content_type)
...
class ToggleOption1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atoggle_option_1(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        low_latency: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._toggle_option_1_mapped_args(
            live_event_id=live_event_id,
            user_id=user_id,
            low_latency=low_latency,
        )
        return await self._atoggle_option_1_oapg(
            body=args.body,
    ...
    def toggle_option_1(
        ...
        return self._toggle_option_1_oapg(
            body=args.body,
            path_params=args.path,
        )

class ToggleOption1(BaseApi):
    ...
    async def atoggle_option_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atoggle_option_1(
            live_event_id=live_event_id,
            user_id=user_id,
            low_latency=low_latency,
            **kwargs,
    ...
    def toggle_option_1(
        ...
        raw_response = self.raw.toggle_option_1(
            live_event_id=live_event_id,
            user_id=user_id,
            low_latency=low_latency,
        )
