...
from vimeo_python_sdk.model.live_event_thumbnails_create_thumbnail_for_event_request import LiveEventThumbnailsCreateThumbnailForEventRequest as LiveEventThumbnailsCreateThumbnailForEventRequestSchema

from vimeo_python_sdk.type.live_event_thumbnails_create_thumbnail_for_event_request import LiveEventThumbnailsCreateThumbnailForEventRequest
...
from vimeo_python_sdk.pydantic.live_event_thumbnails_create_thumbnail_for_event_request import LiveEventThumbnailsCreateThumbnailForEventRequest as LiveEventThumbnailsCreateThumbnailForEventRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoPicturejson = LiveEventThumbnailsCreateThumbnailForEventRequestSchema


request_body_live_event_thumbnails_create_thumbnail_for_event_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_thumbnail_for_event_mapped_args(
        self,
    ...
    async def _acreate_thumbnail_for_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/live_events/{live_event_id}/pictures',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_thumbnails_create_thumbnail_for_event_request.serialize(body, content_type)
    ...
    def _create_thumbnail_for_event_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateThumbnailForEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_thumbnail_for_event(
        self,
        live_event_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._create_thumbnail_for_event_mapped_args(
            live_event_id=live_event_id,
            active=active,
        )
        return await self._acreate_thumbnail_for_event_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_thumbnail_for_event(
        self,
        live_event_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
    ) -> typing.Union[
        ...
        return self._create_thumbnail_for_event_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateThumbnailForEvent(BaseApi):
    ...
    async def acreate_thumbnail_for_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_thumbnail_for_event(
            live_event_id=live_event_id,
            active=active,
            **kwargs,
        )
    ...
    def create_thumbnail_for_event(
        ...
        raw_response = self.raw.create_thumbnail_for_event(
            live_event_id=live_event_id,
            active=active,
        )
        if validate:
