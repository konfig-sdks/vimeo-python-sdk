...
class Comment0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acomment_0(
        self,
        comment_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._comment_0_mapped_args(
            comment_id=comment_id,
            video_id=video_id,
        )
        return await self._acomment_0_oapg(
    ...
    def comment_0(
        ...
        return self._comment_0_oapg(
            path_params=args.path,
        )

class Comment0(BaseApi):
    ...
    async def acomment_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acomment_0(
            comment_id=comment_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def comment_0(
        ...
        raw_response = self.raw.comment_0(
            comment_id=comment_id,
            video_id=video_id,
        )
        if validate:
