...
class Comment1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acomment_1(
        self,
        comment_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._comment_1_mapped_args(
            comment_id=comment_id,
            video_id=video_id,
        )
        return await self._acomment_1_oapg(
    ...
    def comment_1(
        ...
        return self._comment_1_oapg(
            path_params=args.path,
        )

class Comment1(BaseApi):
    ...
    async def acomment_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acomment_1(
            comment_id=comment_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def comment_1(
        ...
        raw_response = self.raw.comment_1(
            comment_id=comment_id,
            video_id=video_id,
        )
