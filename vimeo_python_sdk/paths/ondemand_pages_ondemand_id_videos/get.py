...
from vimeo_python_sdk.model.on_demand_videos_get_all_videos_response import OnDemandVideosGetAllVideosResponse as OnDemandVideosGetAllVideosResponseSchema

from vimeo_python_sdk.type.on_demand_videos_get_all_videos_response import OnDemandVideosGetAllVideosResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.on_demand_videos_get_all_videos_response import OnDemandVideosGetAllVideosResponse as OnDemandVideosGetAllVideosResponsePydantic
...
class FilterSchema(
    ...
    @schemas.classproperty
    def MAIN_VIEWABLE(cls):
        return cls("main.viewable")
...
SchemaFor200ResponseBodyApplicationVndVimeoOndemandVideojson = OnDemandVideosGetAllVideosResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OnDemandVideosGetAllVideosResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_videos_mapped_args(
        self,
    ...
    async def _aget_all_videos_oapg(
        self,
...
class GetAllVideosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_videos(
        self,
        ondemand_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_videos_mapped_args(
        ...
        return await self._aget_all_videos_oapg(
    ...
    def get_all_videos(
        ...
        return self._get_all_videos_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllVideos(BaseApi):
    ...
    async def aget_all_videos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OnDemandVideosGetAllVideosResponsePydantic:
        raw_response = await self.raw.aget_all_videos(
            ondemand_id=ondemand_id,
            direction=direction,
            filter=filter,
            page=page,
        ...
        if validate:
            return RootModel[OnDemandVideosGetAllVideosResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OnDemandVideosGetAllVideosResponsePydantic, raw_response.body)
    ...
    def get_all_videos(
        ...
        raw_response = self.raw.get_all_videos(
            ondemand_id=ondemand_id,
            direction=direction,
            filter=filter,
            page=page,
