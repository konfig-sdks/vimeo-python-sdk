...
class RegionRaw(BaseApi):
    ...
    async def aregion(
        ...
        **kwargs,
        ...
        args = self._region_mapped_args(
            country=country,
        )
        return await self._aregion_oapg(
...
class Region(BaseApi):
    ...
    async def aregion(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aregion(
            country=country,
            **kwargs,
        )
        if validate:
