...
class BaseApi(api_client.Api):
    ...
    def _add_background_to_page_mapped_args(
        self,
    ...
    async def _aadd_background_to_page_oapg(
        self,
    ...
    def _add_background_to_page_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddBackgroundToPageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_background_to_page(
        self,
        ondemand_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._add_background_to_page_mapped_args(
            ondemand_id=ondemand_id,
        )
        return await self._aadd_background_to_page_oapg(
    ...
    def add_background_to_page(
        ...
        return self._add_background_to_page_oapg(
            path_params=args.path,
        )

class AddBackgroundToPage(BaseApi):
    ...
    async def aadd_background_to_page(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_background_to_page(
            ondemand_id=ondemand_id,
            **kwargs,
        )
        if validate:
    ...
    def add_background_to_page(
        ...
        raw_response = self.raw.add_background_to_page(
            ondemand_id=ondemand_id,
        )
        if validate:
            return PicturePydantic(**raw_response.body)
