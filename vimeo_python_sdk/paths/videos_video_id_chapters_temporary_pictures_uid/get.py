...
class BaseApi(api_client.Api):
    ...
    def _get_single_chapter_thumbnail_mapped_args(
        self,
    ...
    async def _aget_single_chapter_thumbnail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/videos/{video_id}/chapters/temporary/pictures/{uid}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_single_chapter_thumbnail_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSingleChapterThumbnailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_chapter_thumbnail(
        self,
        video_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_single_chapter_thumbnail_mapped_args(
            video_id=video_id,
        )
        return await self._aget_single_chapter_thumbnail_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_single_chapter_thumbnail(
        self,
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_single_chapter_thumbnail_oapg(
            path_params=args.path,
        )

class GetSingleChapterThumbnail(BaseApi):
    ...
    async def aget_single_chapter_thumbnail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_chapter_thumbnail(
            video_id=video_id,
            **kwargs,
        )
        if validate:
    ...
    def get_single_chapter_thumbnail(
        ...
        raw_response = self.raw.get_single_chapter_thumbnail(
            video_id=video_id,
        )
        if validate:
            return PicturePydantic(**raw_response.body)
