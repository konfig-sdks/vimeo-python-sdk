...
class BaseApi(api_client.Api):
    ...
    def _delete_user_credit_mapped_args(
        self,
    ...
    async def _adelete_user_credit_oapg(
        self,
...
class DeleteUserCreditRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_user_credit(
        self,
        credit_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_user_credit_mapped_args(
            credit_id=credit_id,
            video_id=video_id,
        )
        return await self._adelete_user_credit_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_user_credit(
        self,
        credit_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._delete_user_credit_oapg(
            path_params=args.path,
        )

class DeleteUserCredit(BaseApi):
    ...
    async def adelete_user_credit(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_user_credit(
            credit_id=credit_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def delete_user_credit(
        ...
        raw_response = self.raw.delete_user_credit(
            credit_id=credit_id,
            video_id=video_id,
        )
