...
class PictureRaw(BaseApi):
    ...
    async def apicture(
        ...
        **kwargs,
        ...
        args = self._picture_mapped_args(
            user_id=user_id,
        )
        return await self._apicture_oapg(
    ...
    def picture(
        ...
        return self._picture_oapg(
            path_params=args.path,
        )

class Picture(BaseApi):
    ...
    async def apicture(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apicture(
            user_id=user_id,
            **kwargs,
        )
        if validate:
