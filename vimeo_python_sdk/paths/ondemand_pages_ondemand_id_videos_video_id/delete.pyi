...
class BaseApi(api_client.Api):
    ...
    def _remove_from_page_mapped_args(
        self,
    ...
    async def _aremove_from_page_oapg(
        self,
...
class RemoveFromPageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_page(
        self,
        ondemand_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_from_page_mapped_args(
            ondemand_id=ondemand_id,
            video_id=video_id,
        )
        return await self._aremove_from_page_oapg(
    ...
    def remove_from_page(
        ...
        return self._remove_from_page_oapg(
            path_params=args.path,
        )

class RemoveFromPage(BaseApi):
    ...
    async def aremove_from_page(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_page(
            ondemand_id=ondemand_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def remove_from_page(
        ...
        raw_response = self.raw.remove_from_page(
            ondemand_id=ondemand_id,
            video_id=video_id,
        )
