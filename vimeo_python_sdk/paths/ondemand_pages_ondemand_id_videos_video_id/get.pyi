...
SchemaFor200ResponseBodyApplicationVndVimeoOndemandVideojson = VideoSchema
...
class BaseApi(api_client.Api):
    ...
    def _specific_video_get_mapped_args(
        self,
    ...
    async def _aspecific_video_get_oapg(
        self,
...
class SpecificVideoGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aspecific_video_get(
        self,
        ondemand_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._specific_video_get_mapped_args(
            ondemand_id=ondemand_id,
            video_id=video_id,
        )
        return await self._aspecific_video_get_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def specific_video_get(
        self,
        ondemand_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._specific_video_get_oapg(
            path_params=args.path,
        )

class SpecificVideoGet(BaseApi):
    ...
    async def aspecific_video_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aspecific_video_get(
            ondemand_id=ondemand_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def specific_video_get(
        ...
        raw_response = self.raw.specific_video_get(
            ondemand_id=ondemand_id,
            video_id=video_id,
        )
        if validate:
