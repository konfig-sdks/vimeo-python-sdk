...
class BaseApi(api_client.Api):
    ...
    def _remove_moderator_mapped_args(
        self,
    ...
    async def _aremove_moderator_oapg(
        self,
...
class RemoveModeratorRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_moderator(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_moderator_mapped_args(
            channel_id=channel_id,
            user_id=user_id,
        )
        return await self._aremove_moderator_oapg(
    ...
    def remove_moderator(
        ...
        return self._remove_moderator_oapg(
            path_params=args.path,
        )

class RemoveModerator(BaseApi):
    ...
    async def aremove_moderator(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_moderator(
            channel_id=channel_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def remove_moderator(
        ...
        raw_response = self.raw.remove_moderator(
            channel_id=channel_id,
            user_id=user_id,
        )
