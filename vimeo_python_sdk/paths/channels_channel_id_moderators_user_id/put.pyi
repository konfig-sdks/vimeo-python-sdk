...
class BaseApi(api_client.Api):
    ...
    def _add_moderator_to_channel_mapped_args(
        self,
    ...
    async def _aadd_moderator_to_channel_oapg(
        self,
    ...
    def _add_moderator_to_channel_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddModeratorToChannelRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_moderator_to_channel(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_moderator_to_channel_mapped_args(
            channel_id=channel_id,
            user_id=user_id,
        )
        return await self._aadd_moderator_to_channel_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def add_moderator_to_channel(
        self,
        channel_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._add_moderator_to_channel_oapg(
            path_params=args.path,
        )

class AddModeratorToChannel(BaseApi):
    ...
    async def aadd_moderator_to_channel(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_moderator_to_channel(
            channel_id=channel_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def add_moderator_to_channel(
        ...
        raw_response = self.raw.add_moderator_to_channel(
            channel_id=channel_id,
            user_id=user_id,
        )
