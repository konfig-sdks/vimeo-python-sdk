...
class BaseApi(api_client.Api):
    ...
    def _delete_registrant_record_mapped_args(
        self,
        registrant_id: str,
        webinar_id: str,
    ...
    async def _adelete_registrant_record_oapg(
        self,
    ...
    def _delete_registrant_record_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteRegistrantRecordRaw(BaseApi):
    ...
    async def adelete_registrant_record(
        ...
        **kwargs,
        ...
        args = self._delete_registrant_record_mapped_args(
            registrant_id=registrant_id,
            webinar_id=webinar_id,
        )
        return await self._adelete_registrant_record_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="webinar\registrations")
    def delete_registrant_record(
        self,
        registrant_id: str,
        webinar_id: str,
    ) -> typing.Union[
        ...
        return self._delete_registrant_record_oapg(
            path_params=args.path,
        )

class DeleteRegistrantRecord(BaseApi):
    ...
    async def adelete_registrant_record(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_registrant_record(
            registrant_id=registrant_id,
            webinar_id=webinar_id,
            **kwargs,
        )
    ...
    def delete_registrant_record(
        ...
        raw_response = self.raw.delete_registrant_record(
            registrant_id=registrant_id,
            webinar_id=webinar_id,
        )
