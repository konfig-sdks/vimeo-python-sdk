...
class BaseApi(api_client.Api):
    ...
    def _get_url_for_event_stream_mapped_args(
        self,
    ...
    async def _aget_url_for_event_stream_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/live_events/{live_event_id}/m3u8_playback',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_url_for_event_stream_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUrlForEventStreamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_url_for_event_stream(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        max_fps_fhd: typing.Optional[typing.Union[int, float]] = None,
        **kwargs,
        ...
        args = self._get_url_for_event_stream_mapped_args(
            live_event_id=live_event_id,
            user_id=user_id,
            max_fps_fhd=max_fps_fhd,
        )
        return await self._aget_url_for_event_stream_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_url_for_event_stream(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        max_fps_fhd: typing.Optional[typing.Union[int, float]] = None,
        ...
        return self._get_url_for_event_stream_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUrlForEventStream(BaseApi):
    ...
    async def aget_url_for_event_stream(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_url_for_event_stream(
            live_event_id=live_event_id,
            user_id=user_id,
            max_fps_fhd=max_fps_fhd,
            **kwargs,
    ...
    def get_url_for_event_stream(
        ...
        raw_response = self.raw.get_url_for_event_stream(
            live_event_id=live_event_id,
            user_id=user_id,
            max_fps_fhd=max_fps_fhd,
        )
