...
SchemaFor401ResponseBodyApplicationVndVimeoCategoryjson = ErrorSchema
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.category+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndVimeoCategoryjson),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _remove_channel_from_category_mapped_args(
        self,
        category: str,
    ...
    async def _aremove_channel_from_category_oapg(
        self,
    ...
    def _remove_channel_from_category_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveChannelFromCategoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_channel_from_category(
        self,
        category: str,
        channel_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_channel_from_category_mapped_args(
            category=category,
            channel_id=channel_id,
        )
        return await self._aremove_channel_from_category_oapg(
    ...
    def remove_channel_from_category(
        ...
        return self._remove_channel_from_category_oapg(
            path_params=args.path,
        )

class RemoveChannelFromCategory(BaseApi):
    ...
    async def aremove_channel_from_category(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_channel_from_category(
            category=category,
            channel_id=channel_id,
            **kwargs,
        )
    ...
    def remove_channel_from_category(
        ...
        raw_response = self.raw.remove_channel_from_category(
            category=category,
            channel_id=channel_id,
        )
