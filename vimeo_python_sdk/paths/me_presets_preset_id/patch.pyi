...
from vimeo_python_sdk.model.embed_presets_essentials_edit_preset_request import EmbedPresetsEssentialsEditPresetRequest as EmbedPresetsEssentialsEditPresetRequestSchema
...
from vimeo_python_sdk.type.embed_presets_essentials_edit_preset_request import EmbedPresetsEssentialsEditPresetRequest
...
from vimeo_python_sdk.pydantic.embed_presets_essentials_edit_preset_request import EmbedPresetsEssentialsEditPresetRequest as EmbedPresetsEssentialsEditPresetRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoPresetjson = EmbedPresetsEssentialsEditPresetRequestSchema


request_body_embed_presets_essentials_edit_preset_request = api_client.RequestBody(
    content={
    ...
    async def _aedit_preset_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_embed_presets_essentials_edit_preset_request.serialize(body, content_type)
...
class EditPresetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_preset(
        self,
        preset_id: typing.Union[int, float],
        outro: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._edit_preset_mapped_args(
            preset_id=preset_id,
            outro=outro,
        )
        return await self._aedit_preset_oapg(
            body=args.body,
    ...
    def edit_preset(
        ...
        return self._edit_preset_oapg(
            body=args.body,
            path_params=args.path,
        )

class EditPreset(BaseApi):
    ...
    async def aedit_preset(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aedit_preset(
            preset_id=preset_id,
            outro=outro,
            **kwargs,
        )
    ...
    def edit_preset(
        ...
        raw_response = self.raw.edit_preset(
            preset_id=preset_id,
            outro=outro,
        )
        if validate:
