...
class BaseApi(api_client.Api):
    ...
    def _get_specific_preset_mapped_args(
        self,
    ...
    async def _aget_specific_preset_oapg(
        self,
...
class GetSpecificPresetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_preset(
        self,
        preset_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_preset_mapped_args(
            preset_id=preset_id,
        )
        return await self._aget_specific_preset_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_preset(
        self,
        preset_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_preset_oapg(
            path_params=args.path,
        )

class GetSpecificPreset(BaseApi):
    ...
    async def aget_specific_preset(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_preset(
            preset_id=preset_id,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_preset(
        ...
        raw_response = self.raw.get_specific_preset(
            preset_id=preset_id,
        )
        if validate:
            return PresetPydantic(**raw_response.body)
