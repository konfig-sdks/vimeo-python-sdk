...
class BaseApi(api_client.Api):
    ...
    def _get_folder_contents_mapped_args(
        self,
    ...
    async def _aget_folder_contents_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/projects/{project_id}/items',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetFolderContentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_folder_contents(
        self,
        project_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_folder_contents_mapped_args(
        ...
        return await self._aget_folder_contents_oapg(
    ...
    def get_folder_contents(
        ...
        return self._get_folder_contents_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFolderContents(BaseApi):
    ...
    async def aget_folder_contents(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_folder_contents(
            project_id=project_id,
            user_id=user_id,
            direction=direction,
            filter=filter,
    ...
    def get_folder_contents(
        ...
        raw_response = self.raw.get_folder_contents(
            project_id=project_id,
            user_id=user_id,
            direction=direction,
            filter=filter,
