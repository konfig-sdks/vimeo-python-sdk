...
class BaseApi(api_client.Api):
    ...
    def _get_playback_url_for_event_stream_mapped_args(
        self,
    ...
    async def _aget_playback_url_for_event_stream_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/videos/{video_id}/m3u8_playback',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_playback_url_for_event_stream_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPlaybackUrlForEventStreamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_playback_url_for_event_stream(
        self,
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_playback_url_for_event_stream_mapped_args(
            user_id=user_id,
            video_id=video_id,
        )
        return await self._aget_playback_url_for_event_stream_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_playback_url_for_event_stream(
        self,
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_playback_url_for_event_stream_oapg(
            path_params=args.path,
        )

class GetPlaybackUrlForEventStream(BaseApi):
    ...
    async def aget_playback_url_for_event_stream(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_playback_url_for_event_stream(
            user_id=user_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def get_playback_url_for_event_stream(
        ...
        raw_response = self.raw.get_playback_url_for_event_stream(
            user_id=user_id,
            video_id=video_id,
        )
