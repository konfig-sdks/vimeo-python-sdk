...
class BaseApi(api_client.Api):
    ...
    def _delete_text_track_mapped_args(
        self,
    ...
    async def _adelete_text_track_oapg(
        self,
...
class DeleteTextTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_text_track(
        self,
        texttrack_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_text_track_mapped_args(
            texttrack_id=texttrack_id,
            video_id=video_id,
        )
        return await self._adelete_text_track_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_text_track(
        self,
        texttrack_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._delete_text_track_oapg(
            path_params=args.path,
        )

class DeleteTextTrack(BaseApi):
    ...
    async def adelete_text_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_text_track(
            texttrack_id=texttrack_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def delete_text_track(
        ...
        raw_response = self.raw.delete_text_track(
            texttrack_id=texttrack_id,
            video_id=video_id,
        )
