...
from vimeo_python_sdk.model.available_users_response import AvailableUsersResponse as AvailableUsersResponseSchema

from vimeo_python_sdk.type.available_users_response import AvailableUsersResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.available_users_response import AvailableUsersResponse as AvailableUsersResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoUserjson = AvailableUsersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AvailableUsersResponse
    ...
    async def _ausers_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/videos/{video_id}/credits/available_users',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Users(BaseApi):
    ...
    async def ausers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AvailableUsersResponsePydantic:
        ...
        if validate:
            return RootModel[AvailableUsersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AvailableUsersResponsePydantic, raw_response.body)
