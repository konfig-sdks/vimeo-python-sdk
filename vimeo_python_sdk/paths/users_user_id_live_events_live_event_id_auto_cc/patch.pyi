...
from vimeo_python_sdk.model.live_event_automated_closed_captions_edit_preference_for_event_request1 import LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest1 as LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest1Schema

from vimeo_python_sdk.type.error import Error
from vimeo_python_sdk.type.live_event_automated_closed_captions_edit_preference_for_event_request1 import LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest1
...
from vimeo_python_sdk.pydantic.live_event_automated_closed_captions_edit_preference_for_event_request1 import LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest1 as LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest1Pydantic
...
# body param
SchemaForRequestBodyApplicationApplicationVndVimeoLiveAutoCcjson = LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest1Schema


request_body_live_event_automated_closed_captions_edit_preference_for_event_request1 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _edit_preference_for_event_0_mapped_args(
        self,
    ...
    async def _aedit_preference_for_event_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/live_events/{live_event_id}/auto_cc',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_live_event_automated_closed_captions_edit_preference_for_event_request1.serialize(body, content_type)
    ...
    def _edit_preference_for_event_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EditPreferenceForEvent0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_preference_for_event_0(
        self,
        auto_cc_enabled: bool,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        **kwargs,
        ...
        args = self._edit_preference_for_event_0_mapped_args(
        ...
        return await self._aedit_preference_for_event_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def edit_preference_for_event_0(
        self,
        auto_cc_enabled: bool,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        return self._edit_preference_for_event_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class EditPreferenceForEvent0(BaseApi):
    ...
    async def aedit_preference_for_event_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aedit_preference_for_event_0(
            auto_cc_enabled=auto_cc_enabled,
            live_event_id=live_event_id,
            user_id=user_id,
            auto_cc_keywords=auto_cc_keywords,
    ...
    def edit_preference_for_event_0(
        ...
        raw_response = self.raw.edit_preference_for_event_0(
            auto_cc_enabled=auto_cc_enabled,
            live_event_id=live_event_id,
            user_id=user_id,
            auto_cc_keywords=auto_cc_keywords,
