...
class BaseApi(api_client.Api):
    ...
    def _check_user_purchases_and_rentals_mapped_args(
        self,
    ...
    async def _acheck_user_purchases_and_rentals_oapg(
        self,
    ...
    def _check_user_purchases_and_rentals_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckUserPurchasesAndRentalsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_user_purchases_and_rentals(
        self,
        ondemand_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_user_purchases_and_rentals_mapped_args(
            ondemand_id=ondemand_id,
        )
        return await self._acheck_user_purchases_and_rentals_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_user_purchases_and_rentals(
        self,
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._check_user_purchases_and_rentals_oapg(
            path_params=args.path,
        )

class CheckUserPurchasesAndRentals(BaseApi):
    ...
    async def acheck_user_purchases_and_rentals(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_user_purchases_and_rentals(
            ondemand_id=ondemand_id,
            **kwargs,
        )
        if validate:
    ...
    def check_user_purchases_and_rentals(
        ...
        raw_response = self.raw.check_user_purchases_and_rentals(
            ondemand_id=ondemand_id,
        )
        if validate:
            return OnDemandPagePydantic(**raw_response.body)
