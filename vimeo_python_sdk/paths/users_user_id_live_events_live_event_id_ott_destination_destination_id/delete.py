...
class BaseApi(api_client.Api):
    ...
    def _delete_ott_destination_mapped_args(
        self,
    ...
    async def _adelete_ott_destination_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/live_events/{live_event_id}/ott_destination/{destination_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_ott_destination_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteOttDestinationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_ott_destination(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_ott_destination_mapped_args(
            live_event_id=live_event_id,
            user_id=user_id,
        )
        return await self._adelete_ott_destination_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_ott_destination(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._delete_ott_destination_oapg(
            path_params=args.path,
        )

class DeleteOttDestination(BaseApi):
    ...
    async def adelete_ott_destination(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_ott_destination(
            live_event_id=live_event_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def delete_ott_destination(
        ...
        raw_response = self.raw.delete_ott_destination(
            live_event_id=live_event_id,
            user_id=user_id,
        )
