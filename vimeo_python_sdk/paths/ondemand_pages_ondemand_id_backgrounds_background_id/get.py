...
class BaseApi(api_client.Api):
    ...
    def _get_specific_background_mapped_args(
        self,
    ...
    async def _aget_specific_background_oapg(
        self,
    ...
    def _get_specific_background_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificBackgroundRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_background(
        self,
        background_id: typing.Union[int, float],
        ondemand_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_background_mapped_args(
            background_id=background_id,
            ondemand_id=ondemand_id,
        )
        return await self._aget_specific_background_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_background(
        self,
        background_id: typing.Union[int, float],
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_specific_background_oapg(
            path_params=args.path,
        )

class GetSpecificBackground(BaseApi):
    ...
    async def aget_specific_background(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_background(
            background_id=background_id,
            ondemand_id=ondemand_id,
            **kwargs,
        )
    ...
    def get_specific_background(
        ...
        raw_response = self.raw.get_specific_background(
            background_id=background_id,
            ondemand_id=ondemand_id,
        )
        if validate:
