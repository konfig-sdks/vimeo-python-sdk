...
class BaseApi(api_client.Api):
    ...
    def _delete_thumbnail_for_event_0_mapped_args(
        self,
    ...
    async def _adelete_thumbnail_for_event_0_oapg(
        self,
    ...
    def _delete_thumbnail_for_event_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteThumbnailForEvent0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_thumbnail_for_event_0(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_thumbnail_for_event_0_mapped_args(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
        )
        return await self._adelete_thumbnail_for_event_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_thumbnail_for_event_0(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        return self._delete_thumbnail_for_event_0_oapg(
            path_params=args.path,
        )

class DeleteThumbnailForEvent0(BaseApi):
    ...
    async def adelete_thumbnail_for_event_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_thumbnail_for_event_0(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
            **kwargs,
    ...
    def delete_thumbnail_for_event_0(
        ...
        raw_response = self.raw.delete_thumbnail_for_event_0(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
        )
