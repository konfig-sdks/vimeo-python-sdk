...
from vimeo_python_sdk.model.live_event_thumbnails_edit_event_thumbnail_request import LiveEventThumbnailsEditEventThumbnailRequest as LiveEventThumbnailsEditEventThumbnailRequestSchema
...
from vimeo_python_sdk.type.live_event_thumbnails_edit_event_thumbnail_request import LiveEventThumbnailsEditEventThumbnailRequest
...
from vimeo_python_sdk.pydantic.live_event_thumbnails_edit_event_thumbnail_request import LiveEventThumbnailsEditEventThumbnailRequest as LiveEventThumbnailsEditEventThumbnailRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoPicturejson = LiveEventThumbnailsEditEventThumbnailRequestSchema


request_body_live_event_thumbnails_edit_event_thumbnail_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _edit_event_thumbnail_mapped_args(
        self,
    ...
    async def _aedit_event_thumbnail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/live_events/{live_event_id}/pictures/{thumbnail_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_live_event_thumbnails_edit_event_thumbnail_request.serialize(body, content_type)
    ...
    def _edit_event_thumbnail_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EditEventThumbnailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_event_thumbnail(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        **kwargs,
        ...
        args = self._edit_event_thumbnail_mapped_args(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
            active=active,
        )
        return await self._aedit_event_thumbnail_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def edit_event_thumbnail(
        self,
        live_event_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        return self._edit_event_thumbnail_oapg(
            body=args.body,
            path_params=args.path,
        )

class EditEventThumbnail(BaseApi):
    ...
    async def aedit_event_thumbnail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aedit_event_thumbnail(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
            active=active,
    ...
    def edit_event_thumbnail(
        ...
        raw_response = self.raw.edit_event_thumbnail(
            live_event_id=live_event_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
            active=active,
