...
from vimeo_python_sdk.model.get_comments_response import GetCommentsResponse as GetCommentsResponseSchema

from vimeo_python_sdk.type.get_comments_response import GetCommentsResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.get_comments_response import GetCommentsResponse as GetCommentsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoCommentjson = GetCommentsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetCommentsResponse
...
class Comments(BaseApi):
    ...
    async def acomments(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[GetCommentsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetCommentsResponsePydantic, raw_response.body)
