...
from vimeo_python_sdk.model.get_appearances_response import GetAppearancesResponse as GetAppearancesResponseSchema

from vimeo_python_sdk.type.get_appearances_response import GetAppearancesResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.get_appearances_response import GetAppearancesResponse as GetAppearancesResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = GetAppearancesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetAppearancesResponse
...
class AppearancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aappearances(
        self,
        user_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._appearances_mapped_args(
            user_id=user_id,
            direction=direction,
            filter=filter,
        ...
        return await self._aappearances_oapg(
    ...
    def appearances(
        ...
        return self._appearances_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class Appearances(BaseApi):
    ...
    async def aappearances(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetAppearancesResponsePydantic:
        raw_response = await self.raw.aappearances(
            user_id=user_id,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
        ...
        if validate:
            return RootModel[GetAppearancesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetAppearancesResponsePydantic, raw_response.body)
    ...
    def appearances(
        ...
        raw_response = self.raw.appearances(
            user_id=user_id,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
