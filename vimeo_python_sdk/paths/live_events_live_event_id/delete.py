...
class BaseApi(api_client.Api):
    ...
    def _delete_specific_live_event_mapped_args(
        self,
    ...
    async def _adelete_specific_live_event_oapg(
        self,
    ...
    def _delete_specific_live_event_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteSpecificLiveEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_specific_live_event(
        self,
        live_event_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_specific_live_event_mapped_args(
            live_event_id=live_event_id,
        )
        return await self._adelete_specific_live_event_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_specific_live_event(
        self,
        live_event_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_specific_live_event_oapg(
            path_params=args.path,
        )

class DeleteSpecificLiveEvent(BaseApi):
    ...
    async def adelete_specific_live_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_specific_live_event(
            live_event_id=live_event_id,
            **kwargs,
        )
    ...
    def delete_specific_live_event(
        ...
        raw_response = self.raw.delete_specific_live_event(
            live_event_id=live_event_id,
        )
