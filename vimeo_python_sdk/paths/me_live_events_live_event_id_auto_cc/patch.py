...
from vimeo_python_sdk.model.live_event_automated_closed_captions_edit_preference_for_event_request import LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest as LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequestSchema

from vimeo_python_sdk.type.live_event_automated_closed_captions_edit_preference_for_event_request import LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest
...
from vimeo_python_sdk.pydantic.live_event_automated_closed_captions_edit_preference_for_event_request import LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest as LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequestPydantic
...
# body param
SchemaForRequestBodyApplicationApplicationVndVimeoLiveAutoCcjson = LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequestSchema


request_body_live_event_automated_closed_captions_edit_preference_for_event_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _edit_preference_for_event_mapped_args(
        self,
    ...
    async def _aedit_preference_for_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/live_events/{live_event_id}/auto_cc',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_live_event_automated_closed_captions_edit_preference_for_event_request.serialize(body, content_type)
    ...
    def _edit_preference_for_event_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EditPreferenceForEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_preference_for_event(
        self,
        auto_cc_enabled: bool,
        live_event_id: typing.Union[int, float],
        auto_cc_keywords: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._edit_preference_for_event_mapped_args(
            auto_cc_enabled=auto_cc_enabled,
            live_event_id=live_event_id,
            auto_cc_keywords=auto_cc_keywords,
            auto_cc_lang=auto_cc_lang,
        )
        return await self._aedit_preference_for_event_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def edit_preference_for_event(
        self,
        auto_cc_enabled: bool,
        live_event_id: typing.Union[int, float],
        auto_cc_keywords: typing.Optional[str] = None,
        ...
        return self._edit_preference_for_event_oapg(
            body=args.body,
            path_params=args.path,
        )

class EditPreferenceForEvent(BaseApi):
    ...
    async def aedit_preference_for_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aedit_preference_for_event(
            auto_cc_enabled=auto_cc_enabled,
            live_event_id=live_event_id,
            auto_cc_keywords=auto_cc_keywords,
            auto_cc_lang=auto_cc_lang,
    ...
    def edit_preference_for_event(
        ...
        raw_response = self.raw.edit_preference_for_event(
            auto_cc_enabled=auto_cc_enabled,
            live_event_id=live_event_id,
            auto_cc_keywords=auto_cc_keywords,
            auto_cc_lang=auto_cc_lang,
