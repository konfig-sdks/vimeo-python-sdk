...
class BaseApi(api_client.Api):
    ...
    def _add_custom_logo_mapped_args(
        self,
    ...
    async def _aadd_custom_logo_oapg(
        self,
...
class AddCustomLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_custom_logo(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_custom_logo_mapped_args(
            album_id=album_id,
            user_id=user_id,
        )
        return await self._aadd_custom_logo_oapg(
    ...
    def add_custom_logo(
        ...
        return self._add_custom_logo_oapg(
            path_params=args.path,
        )

class AddCustomLogo(BaseApi):
    ...
    async def aadd_custom_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_custom_logo(
            album_id=album_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def add_custom_logo(
        ...
        raw_response = self.raw.add_custom_logo(
            album_id=album_id,
            user_id=user_id,
        )
        if validate:
