...
class BaseApi(api_client.Api):
    ...
    def _delete_user_videos_mapped_args(
        self,
        uris: str,
    ...
    async def _adelete_user_videos_oapg(
        self,
...
class DeleteUserVideosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_user_videos(
        self,
        uris: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_user_videos_mapped_args(
            uris=uris,
        )
        return await self._adelete_user_videos_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def delete_user_videos(
        self,
        uris: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_user_videos_oapg(
            query_params=args.query,
        )

class DeleteUserVideos(BaseApi):
    ...
    async def adelete_user_videos(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_user_videos(
            uris=uris,
            **kwargs,
        )
    ...
    def delete_user_videos(
        ...
        raw_response = self.raw.delete_user_videos(
            uris=uris,
        )
