...
from vimeo_python_sdk.model.videos_essentials_get_all_user_videos_response import VideosEssentialsGetAllUserVideosResponse as VideosEssentialsGetAllUserVideosResponseSchema

from vimeo_python_sdk.type.videos_essentials_get_all_user_videos_response import VideosEssentialsGetAllUserVideosResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.videos_essentials_get_all_user_videos_response import VideosEssentialsGetAllUserVideosResponse as VideosEssentialsGetAllUserVideosResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = VideosEssentialsGetAllUserVideosResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VideosEssentialsGetAllUserVideosResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_user_videos_mapped_args(
        self,
    ...
    async def _aget_all_user_videos_oapg(
        self,
...
class GetAllUserVideosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_user_videos(
        self,
        containing_uri: typing.Optional[str] = None,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_user_videos_mapped_args(
        ...
        return await self._aget_all_user_videos_oapg(
    ...
    def get_all_user_videos(
        ...
        return self._get_all_user_videos_oapg(
            query_params=args.query,
        )

class GetAllUserVideos(BaseApi):
    ...
    async def aget_all_user_videos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VideosEssentialsGetAllUserVideosResponsePydantic:
        raw_response = await self.raw.aget_all_user_videos(
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
        ...
        if validate:
            return RootModel[VideosEssentialsGetAllUserVideosResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VideosEssentialsGetAllUserVideosResponsePydantic, raw_response.body)
    ...
    def get_all_user_videos(
        ...
        raw_response = self.raw.get_all_user_videos(
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
