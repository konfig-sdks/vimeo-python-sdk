...
class BaseApi(api_client.Api):
    ...
    def _get_specific_logo_mapped_args(
        self,
    ...
    async def _aget_specific_logo_oapg(
        self,
...
class GetSpecificLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_logo(
        self,
        album_id: typing.Union[int, float],
        logo_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_logo_mapped_args(
            album_id=album_id,
            logo_id=logo_id,
            user_id=user_id,
        )
        return await self._aget_specific_logo_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_logo(
        self,
        album_id: typing.Union[int, float],
        logo_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        return self._get_specific_logo_oapg(
            path_params=args.path,
        )

class GetSpecificLogo(BaseApi):
    ...
    async def aget_specific_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_logo(
            album_id=album_id,
            logo_id=logo_id,
            user_id=user_id,
            **kwargs,
    ...
    def get_specific_logo(
        ...
        raw_response = self.raw.get_specific_logo(
            album_id=album_id,
            logo_id=logo_id,
            user_id=user_id,
        )
