...
class BaseApi(api_client.Api):
    ...
    def _delete_custom_logo_mapped_args(
        self,
    ...
    async def _adelete_custom_logo_oapg(
        self,
...
class DeleteCustomLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_custom_logo(
        self,
        album_id: typing.Union[int, float],
        logo_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_custom_logo_mapped_args(
            album_id=album_id,
            logo_id=logo_id,
            user_id=user_id,
        )
        return await self._adelete_custom_logo_oapg(
    ...
    def delete_custom_logo(
        ...
        return self._delete_custom_logo_oapg(
            path_params=args.path,
        )

class DeleteCustomLogo(BaseApi):
    ...
    async def adelete_custom_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_custom_logo(
            album_id=album_id,
            logo_id=logo_id,
            user_id=user_id,
            **kwargs,
    ...
    def delete_custom_logo(
        ...
        raw_response = self.raw.delete_custom_logo(
            album_id=album_id,
            logo_id=logo_id,
            user_id=user_id,
        )
