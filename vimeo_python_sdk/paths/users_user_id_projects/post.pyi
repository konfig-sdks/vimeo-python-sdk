...
from vimeo_python_sdk.model.create_project_request import CreateProjectRequest as CreateProjectRequestSchema
from vimeo_python_sdk.model.error import Error as ErrorSchema

from vimeo_python_sdk.type.create_project_request import CreateProjectRequest
...
from vimeo_python_sdk.pydantic.create_project_request import CreateProjectRequest as CreateProjectRequestPydantic
...
class ProjectRaw(BaseApi):
    ...
    async def aproject(
        ...
        **kwargs,
        ...
        args = self._project_mapped_args(
            name=name,
            user_id=user_id,
            parent_folder_uri=parent_folder_uri,
        )
        return await self._aproject_oapg(
            body=args.body,
...
class Project(BaseApi):
    ...
    async def aproject(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aproject(
            name=name,
            user_id=user_id,
            parent_folder_uri=parent_folder_uri,
            **kwargs,
