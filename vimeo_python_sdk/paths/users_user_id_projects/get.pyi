...
from vimeo_python_sdk.model.get_projects_response import GetProjectsResponse as GetProjectsResponseSchema

from vimeo_python_sdk.type.error import Error
from vimeo_python_sdk.type.get_projects_response import GetProjectsResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.error import Error as ErrorPydantic
from vimeo_python_sdk.pydantic.get_projects_response import GetProjectsResponse as GetProjectsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetProjectsResponseSchema
...
class ProjectsRaw(BaseApi):
    ...
    async def aprojects(
        ...
        **kwargs,
        ...
        args = self._projects_mapped_args(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        return await self._aprojects_oapg(
...
class Projects(BaseApi):
    ...
    async def aprojects(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetProjectsResponsePydantic:
        raw_response = await self.raw.aprojects(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[GetProjectsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetProjectsResponsePydantic, raw_response.body)
    ...
    def projects(
        ...
        raw_response = self.raw.projects(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
