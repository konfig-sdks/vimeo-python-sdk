...
class BaseApi(api_client.Api):
    ...
    def _get_all_page_promotions_mapped_args(
        self,
    ...
    async def _aget_all_page_promotions_oapg(
        self,
    ...
    def _get_all_page_promotions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAllPagePromotionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_page_promotions(
        self,
        ondemand_id: typing.Union[int, float],
        filter: str,
        page: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_page_promotions_mapped_args(
            ondemand_id=ondemand_id,
            filter=filter,
            page=page,
            per_page=per_page,
        )
        return await self._aget_all_page_promotions_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_page_promotions(
        self,
        ondemand_id: typing.Union[int, float],
        filter: str,
        page: typing.Optional[typing.Union[int, float]] = None,
        ...
        return self._get_all_page_promotions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllPagePromotions(BaseApi):
    ...
    async def aget_all_page_promotions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_page_promotions(
            ondemand_id=ondemand_id,
            filter=filter,
            page=page,
            per_page=per_page,
    ...
    def get_all_page_promotions(
        ...
        raw_response = self.raw.get_all_page_promotions(
            ondemand_id=ondemand_id,
            filter=filter,
            page=page,
            per_page=per_page,
