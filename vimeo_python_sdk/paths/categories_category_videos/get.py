...
from vimeo_python_sdk.model.categories_videos_list_videos_in_category_response import CategoriesVideosListVideosInCategoryResponse as CategoriesVideosListVideosInCategoryResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.categories_videos_list_videos_in_category_response import CategoriesVideosListVideosInCategoryResponse
...
from vimeo_python_sdk.pydantic.categories_videos_list_videos_in_category_response import CategoriesVideosListVideosInCategoryResponse as CategoriesVideosListVideosInCategoryResponsePydantic
...
class FilterSchema(
    ...
    @schemas.classproperty
    def CONDITIONAL_FEATURED(cls):
        return cls("conditional_featured")
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = CategoriesVideosListVideosInCategoryResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CategoriesVideosListVideosInCategoryResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_videos_in_category_mapped_args(
        self,
        category: str,
    ...
    async def _alist_videos_in_category_oapg(
        self,
    ...
    def _list_videos_in_category_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListVideosInCategoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_videos_in_category(
        self,
        category: str,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_videos_in_category_mapped_args(
            category=category,
            direction=direction,
            filter=filter,
        ...
        return await self._alist_videos_in_category_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_videos_in_category(
        self,
        category: str,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        return self._list_videos_in_category_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListVideosInCategory(BaseApi):
    ...
    async def alist_videos_in_category(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CategoriesVideosListVideosInCategoryResponsePydantic:
        raw_response = await self.raw.alist_videos_in_category(
            category=category,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
        ...
        if validate:
            return RootModel[CategoriesVideosListVideosInCategoryResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CategoriesVideosListVideosInCategoryResponsePydantic, raw_response.body)
    ...
    def list_videos_in_category(
        ...
        raw_response = self.raw.list_videos_in_category(
            category=category,
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
