...
class BaseApi(api_client.Api):
    ...
    def _get_specific_page_in_genre_mapped_args(
        self,
        genre_id: str,
    ...
    async def _aget_specific_page_in_genre_oapg(
        self,
    ...
    def _get_specific_page_in_genre_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificPageInGenreRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_page_in_genre(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_page_in_genre_mapped_args(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
        return await self._aget_specific_page_in_genre_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_page_in_genre(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._get_specific_page_in_genre_oapg(
            path_params=args.path,
        )

class GetSpecificPageInGenre(BaseApi):
    ...
    async def aget_specific_page_in_genre(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_page_in_genre(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
            **kwargs,
        )
    ...
    def get_specific_page_in_genre(
        ...
        raw_response = self.raw.get_specific_page_in_genre(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
        if validate:
