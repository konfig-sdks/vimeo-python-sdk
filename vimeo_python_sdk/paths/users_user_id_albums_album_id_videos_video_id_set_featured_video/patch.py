...
class BaseApi(api_client.Api):
    ...
    def _set_featured_video_0_mapped_args(
        self,
    ...
    async def _aset_featured_video_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{user_id}/albums/{album_id}/videos/{video_id}/set_featured_video',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _set_featured_video_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SetFeaturedVideo0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_featured_video_0(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._set_featured_video_0_mapped_args(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
        )
        return await self._aset_featured_video_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def set_featured_video_0(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        ...
        return self._set_featured_video_0_oapg(
            path_params=args.path,
        )

class SetFeaturedVideo0(BaseApi):
    ...
    async def aset_featured_video_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_featured_video_0(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
            **kwargs,
    ...
    def set_featured_video_0(
        ...
        raw_response = self.raw.set_featured_video_0(
            album_id=album_id,
            user_id=user_id,
            video_id=video_id,
        )
