...
class BaseApi(api_client.Api):
    ...
    def _delete_specific_event_mapped_args(
        self,
    ...
    async def _adelete_specific_event_oapg(
        self,
    ...
    def _delete_specific_event_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteSpecificEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_specific_event(
        self,
        live_event_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_specific_event_mapped_args(
            live_event_id=live_event_id,
            user_id=user_id,
        )
        return await self._adelete_specific_event_oapg(
    ...
    def delete_specific_event(
        ...
        return self._delete_specific_event_oapg(
            path_params=args.path,
        )

class DeleteSpecificEvent(BaseApi):
    ...
    async def adelete_specific_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_specific_event(
            live_event_id=live_event_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def delete_specific_event(
        ...
        raw_response = self.raw.delete_specific_event(
            live_event_id=live_event_id,
            user_id=user_id,
        )
