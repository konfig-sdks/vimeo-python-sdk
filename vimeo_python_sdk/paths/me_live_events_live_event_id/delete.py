...
class BaseApi(api_client.Api):
    ...
    def _delete_single_event_mapped_args(
        self,
    ...
    async def _adelete_single_event_oapg(
        self,
...
class DeleteSingleEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_single_event(
        self,
        live_event_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_single_event_mapped_args(
            live_event_id=live_event_id,
        )
        return await self._adelete_single_event_oapg(
    ...
    def delete_single_event(
        ...
        return self._delete_single_event_oapg(
            path_params=args.path,
        )

class DeleteSingleEvent(BaseApi):
    ...
    async def adelete_single_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_single_event(
            live_event_id=live_event_id,
            **kwargs,
        )
    ...
    def delete_single_event(
        ...
        raw_response = self.raw.delete_single_event(
            live_event_id=live_event_id,
        )
