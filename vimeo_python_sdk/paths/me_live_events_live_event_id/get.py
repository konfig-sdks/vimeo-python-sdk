...
class BaseApi(api_client.Api):
    ...
    def _get_specific_live_event_mapped_args(
        self,
    ...
    async def _aget_specific_live_event_oapg(
        self,
    ...
    def _get_specific_live_event_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSpecificLiveEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_live_event(
        self,
        live_event_id: typing.Union[int, float],
        password: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_specific_live_event_mapped_args(
            live_event_id=live_event_id,
            password=password,
        )
        return await self._aget_specific_live_event_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_live_event(
        self,
        live_event_id: typing.Union[int, float],
        password: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_specific_live_event_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSpecificLiveEvent(BaseApi):
    ...
    async def aget_specific_live_event(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_live_event(
            live_event_id=live_event_id,
            password=password,
            **kwargs,
        )
    ...
    def get_specific_live_event(
        ...
        raw_response = self.raw.get_specific_live_event(
            live_event_id=live_event_id,
            password=password,
        )
        if validate:
