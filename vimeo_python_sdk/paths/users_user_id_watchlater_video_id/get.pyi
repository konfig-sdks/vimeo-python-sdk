...
class BaseApi(api_client.Api):
    ...
    def _check_video_in_queue_0_mapped_args(
        self,
    ...
    async def _acheck_video_in_queue_0_oapg(
        self,
    ...
    def _check_video_in_queue_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckVideoInQueue0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_video_in_queue_0(
        self,
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._check_video_in_queue_0_mapped_args(
            user_id=user_id,
            video_id=video_id,
        )
        return await self._acheck_video_in_queue_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_video_in_queue_0(
        self,
        user_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._check_video_in_queue_0_oapg(
            path_params=args.path,
        )

class CheckVideoInQueue0(BaseApi):
    ...
    async def acheck_video_in_queue_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_video_in_queue_0(
            user_id=user_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def check_video_in_queue_0(
        ...
        raw_response = self.raw.check_video_in_queue_0(
            user_id=user_id,
            video_id=video_id,
        )
        if validate:
