...
from vimeo_python_sdk.model.get_showcases_response import GetShowcasesResponse as GetShowcasesResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.get_showcases_response import GetShowcasesResponse
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.get_showcases_response import GetShowcasesResponse as GetShowcasesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetShowcasesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetShowcasesResponse
...
class ShowcasesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashowcases(
        self,
        user_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        page: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._showcases_mapped_args(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        return await self._ashowcases_oapg(
    ...
    def showcases(
        ...
        return self._showcases_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class Showcases(BaseApi):
    ...
    async def ashowcases(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetShowcasesResponsePydantic:
        raw_response = await self.raw.ashowcases(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[GetShowcasesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(GetShowcasesResponsePydantic, raw_response.body)
    ...
    def showcases(
        ...
        raw_response = self.raw.showcases(
            user_id=user_id,
            direction=direction,
            page=page,
            per_page=per_page,
