...
from vimeo_python_sdk.model.on_demand_essentials_get_all_user_pages_response import OnDemandEssentialsGetAllUserPagesResponse as OnDemandEssentialsGetAllUserPagesResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.on_demand_essentials_get_all_user_pages_response import OnDemandEssentialsGetAllUserPagesResponse
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.on_demand_essentials_get_all_user_pages_response import OnDemandEssentialsGetAllUserPagesResponse as OnDemandEssentialsGetAllUserPagesResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoOndemandPagejson = OnDemandEssentialsGetAllUserPagesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OnDemandEssentialsGetAllUserPagesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_user_pages_mapped_args(
        self,
    ...
    async def _aget_all_user_pages_oapg(
        self,
...
class GetAllUserPagesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_user_pages(
        self,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        page: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_user_pages_mapped_args(
            direction=direction,
            filter=filter,
            page=page,
            per_page=per_page,
        ...
        return await self._aget_all_user_pages_oapg(
    ...
    def get_all_user_pages(
        ...
        return self._get_all_user_pages_oapg(
            query_params=args.query,
        )

class GetAllUserPages(BaseApi):
    ...
    async def aget_all_user_pages(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OnDemandEssentialsGetAllUserPagesResponsePydantic:
        raw_response = await self.raw.aget_all_user_pages(
            direction=direction,
            filter=filter,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[OnDemandEssentialsGetAllUserPagesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OnDemandEssentialsGetAllUserPagesResponsePydantic, raw_response.body)
    ...
    def get_all_user_pages(
        ...
        raw_response = self.raw.get_all_user_pages(
            direction=direction,
            filter=filter,
            page=page,
            per_page=per_page,
