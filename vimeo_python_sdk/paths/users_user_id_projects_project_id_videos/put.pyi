...
class BaseApi(api_client.Api):
    ...
    def _add_to_folder_videos_mapped_args(
        self,
    ...
    async def _aadd_to_folder_videos_oapg(
        self,
    ...
    def _add_to_folder_videos_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddToFolderVideosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_folder_videos(
        self,
        project_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        uris: str,
        **kwargs,
        ...
        args = self._add_to_folder_videos_mapped_args(
            project_id=project_id,
            user_id=user_id,
            uris=uris,
        )
        return await self._aadd_to_folder_videos_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def add_to_folder_videos(
        self,
        project_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        uris: str,
        ...
        return self._add_to_folder_videos_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class AddToFolderVideos(BaseApi):
    ...
    async def aadd_to_folder_videos(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_to_folder_videos(
            project_id=project_id,
            user_id=user_id,
            uris=uris,
            **kwargs,
    ...
    def add_to_folder_videos(
        ...
        raw_response = self.raw.add_to_folder_videos(
            project_id=project_id,
            user_id=user_id,
            uris=uris,
        )
