...
class Showcase1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashowcase_1(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._showcase_1_mapped_args(
            album_id=album_id,
            user_id=user_id,
        )
        return await self._ashowcase_1_oapg(
    ...
    def showcase_1(
        ...
        return self._showcase_1_oapg(
            path_params=args.path,
        )

class Showcase1(BaseApi):
    ...
    async def ashowcase_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashowcase_1(
            album_id=album_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def showcase_1(
        ...
        raw_response = self.raw.showcase_1(
            album_id=album_id,
            user_id=user_id,
        )
