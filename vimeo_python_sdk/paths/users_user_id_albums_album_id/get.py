...
class Showcase0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ashowcase_0(
        self,
        album_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._showcase_0_mapped_args(
            album_id=album_id,
            user_id=user_id,
        )
        return await self._ashowcase_0_oapg(
    ...
    def showcase_0(
        ...
        return self._showcase_0_oapg(
            path_params=args.path,
        )

class Showcase0(BaseApi):
    ...
    async def ashowcase_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ashowcase_0(
            album_id=album_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def showcase_0(
        ...
        raw_response = self.raw.showcase_0(
            album_id=album_id,
            user_id=user_id,
        )
        if validate:
