...
class Picture1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apicture_1(
        self,
        portraitset_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._picture_1_mapped_args(
            portraitset_id=portraitset_id,
            user_id=user_id,
        )
        return await self._apicture_1_oapg(
    ...
    def picture_1(
        ...
        return self._picture_1_oapg(
            path_params=args.path,
        )

class Picture1(BaseApi):
    ...
    async def apicture_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apicture_1(
            portraitset_id=portraitset_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def picture_1(
        ...
        raw_response = self.raw.picture_1(
            portraitset_id=portraitset_id,
            user_id=user_id,
        )
