...
from vimeo_python_sdk.model.edit_picture_request import EditPictureRequest as EditPictureRequestSchema
from vimeo_python_sdk.model.picture import Picture as PictureSchema

from vimeo_python_sdk.type.picture import Picture
from vimeo_python_sdk.type.edit_picture_request import EditPictureRequest

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.picture import Picture as PicturePydantic
from vimeo_python_sdk.pydantic.edit_picture_request import EditPictureRequest as EditPictureRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoPicturejson = EditPictureRequestSchema


request_body_edit_picture_request = api_client.RequestBody(
    content={
    ...
    async def _apicture_2_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_edit_picture_request.serialize(body, content_type)
...
class Picture2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apicture_2(
        self,
        portraitset_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        active: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._picture_2_mapped_args(
            portraitset_id=portraitset_id,
            user_id=user_id,
            active=active,
        )
        return await self._apicture_2_oapg(
            body=args.body,
    ...
    def picture_2(
        ...
        return self._picture_2_oapg(
            body=args.body,
            path_params=args.path,
        )

class Picture2(BaseApi):
    ...
    async def apicture_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apicture_2(
            portraitset_id=portraitset_id,
            user_id=user_id,
            active=active,
            **kwargs,
    ...
    def picture_2(
        ...
        raw_response = self.raw.picture_2(
            portraitset_id=portraitset_id,
            user_id=user_id,
            active=active,
        )
