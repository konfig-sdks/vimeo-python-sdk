...
class Picture0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apicture_0(
        self,
        portraitset_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._picture_0_mapped_args(
            portraitset_id=portraitset_id,
            user_id=user_id,
        )
        return await self._apicture_0_oapg(
    ...
    def picture_0(
        ...
        return self._picture_0_oapg(
            path_params=args.path,
        )

class Picture0(BaseApi):
    ...
    async def apicture_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apicture_0(
            portraitset_id=portraitset_id,
            user_id=user_id,
            **kwargs,
        )
    ...
    def picture_0(
        ...
        raw_response = self.raw.picture_0(
            portraitset_id=portraitset_id,
            user_id=user_id,
        )
        if validate:
