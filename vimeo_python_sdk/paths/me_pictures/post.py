...
class BaseApi(api_client.Api):
    ...
    def _add_portrait_image_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aadd_portrait_image_oapg(
        self,
...
class AddPortraitImageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_portrait_image(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._add_portrait_image_mapped_args(
        )
        return await self._aadd_portrait_image_oapg(
            **kwargs,
        )
    
    def add_portrait_image(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._add_portrait_image_oapg(
        )

class AddPortraitImage(BaseApi):
    ...
    async def aadd_portrait_image(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_portrait_image(
            **kwargs,
        )
        if validate:
    ...
    def add_portrait_image(
        ...
        raw_response = self.raw.add_portrait_image(
        )
        if validate:
            return PicturePydantic(**raw_response.body)
        return api_client.construct_model_instance(PicturePydantic, raw_response.body)
