...
from vimeo_python_sdk.model.users_pictures_list_response import UsersPicturesListResponse as UsersPicturesListResponseSchema

from vimeo_python_sdk.type.users_pictures_list_response import UsersPicturesListResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.users_pictures_list_response import UsersPicturesListResponse as UsersPicturesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoPicturejson = UsersPicturesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersPicturesListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersPicturesListResponsePydantic:
        ...
        if validate:
            return RootModel[UsersPicturesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UsersPicturesListResponsePydantic, raw_response.body)
