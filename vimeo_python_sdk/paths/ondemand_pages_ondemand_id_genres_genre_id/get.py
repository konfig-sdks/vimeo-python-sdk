...
class BaseApi(api_client.Api):
    ...
    def _check_genre_association_mapped_args(
        self,
        genre_id: str,
    ...
    async def _acheck_genre_association_oapg(
        self,
    ...
    def _check_genre_association_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckGenreAssociationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_genre_association(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._check_genre_association_mapped_args(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
        return await self._acheck_genre_association_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_genre_association(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._check_genre_association_oapg(
            path_params=args.path,
        )

class CheckGenreAssociation(BaseApi):
    ...
    async def acheck_genre_association(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_genre_association(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
            **kwargs,
        )
    ...
    def check_genre_association(
        ...
        raw_response = self.raw.check_genre_association(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
        if validate:
