...
SchemaFor201ResponseBodyApplicationVndVimeoOndemandGenrejson = OnDemandGenreSchema
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.ondemand.genre+json': api_client.MediaType(
            schema=SchemaFor201ResponseBodyApplicationVndVimeoOndemandGenrejson),
    },
)
SchemaFor400ResponseBodyApplicationVndVimeoOndemandGenrejson = LegacyErrorSchema
...
_response_for_400 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.ondemand.genre+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndVimeoOndemandGenrejson),
    },
)
SchemaFor403ResponseBodyApplicationVndVimeoOndemandGenrejson = LegacyErrorSchema
...
_response_for_403 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.ondemand.genre+json': api_client.MediaType(
            schema=SchemaFor403ResponseBodyApplicationVndVimeoOndemandGenrejson),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _add_genre_to_page_mapped_args(
        self,
        genre_id: str,
    ...
    async def _aadd_genre_to_page_oapg(
        self,
...
class AddGenreToPageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_genre_to_page(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_genre_to_page_mapped_args(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
        return await self._aadd_genre_to_page_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def add_genre_to_page(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._add_genre_to_page_oapg(
            path_params=args.path,
        )

class AddGenreToPage(BaseApi):
    ...
    async def aadd_genre_to_page(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_genre_to_page(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
            **kwargs,
        )
    ...
    def add_genre_to_page(
        ...
        raw_response = self.raw.add_genre_to_page(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
        if validate:
