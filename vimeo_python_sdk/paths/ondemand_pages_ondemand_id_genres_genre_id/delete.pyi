...
class BaseApi(api_client.Api):
    ...
    def _remove_genre_from_page_mapped_args(
        self,
        genre_id: str,
    ...
    async def _aremove_genre_from_page_oapg(
        self,
    ...
    def _remove_genre_from_page_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveGenreFromPageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_genre_from_page(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_genre_from_page_mapped_args(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
        return await self._aremove_genre_from_page_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_genre_from_page(
        self,
        genre_id: str,
        ondemand_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._remove_genre_from_page_oapg(
            path_params=args.path,
        )

class RemoveGenreFromPage(BaseApi):
    ...
    async def aremove_genre_from_page(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_genre_from_page(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
            **kwargs,
        )
    ...
    def remove_genre_from_page(
        ...
        raw_response = self.raw.remove_genre_from_page(
            genre_id=genre_id,
            ondemand_id=ondemand_id,
        )
