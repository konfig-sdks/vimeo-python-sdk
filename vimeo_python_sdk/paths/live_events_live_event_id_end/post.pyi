...
class BaseApi(api_client.Api):
    ...
    def _event_termination_mapped_args(
        self,
    ...
    async def _aevent_termination_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/live_events/{live_event_id}/end',
            auth_settings=_auth,
            headers=_headers,
        )
...
class EventTerminationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevent_termination(
        self,
        live_event_id: typing.Union[int, float],
        clip_id: typing.Optional[typing.Union[int, float]] = None,
        **kwargs,
        ...
        args = self._event_termination_mapped_args(
            live_event_id=live_event_id,
            clip_id=clip_id,
        )
        return await self._aevent_termination_oapg(
    ...
    def event_termination(
        ...
        return self._event_termination_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class EventTermination(BaseApi):
    ...
    async def aevent_termination(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aevent_termination(
            live_event_id=live_event_id,
            clip_id=clip_id,
            **kwargs,
        )
    ...
    def event_termination(
        ...
        raw_response = self.raw.event_termination(
            live_event_id=live_event_id,
            clip_id=clip_id,
        )
        if validate:
