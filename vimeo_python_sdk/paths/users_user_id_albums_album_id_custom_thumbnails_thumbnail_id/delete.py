...
class BaseApi(api_client.Api):
    ...
    def _delete_custom_thumbnail_mapped_args(
        self,
    ...
    async def _adelete_custom_thumbnail_oapg(
        self,
    ...
    def _delete_custom_thumbnail_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteCustomThumbnailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_custom_thumbnail(
        self,
        album_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._delete_custom_thumbnail_mapped_args(
            album_id=album_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
        )
        return await self._adelete_custom_thumbnail_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_custom_thumbnail(
        self,
        album_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        return self._delete_custom_thumbnail_oapg(
            path_params=args.path,
        )

class DeleteCustomThumbnail(BaseApi):
    ...
    async def adelete_custom_thumbnail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_custom_thumbnail(
            album_id=album_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
            **kwargs,
    ...
    def delete_custom_thumbnail(
        ...
        raw_response = self.raw.delete_custom_thumbnail(
            album_id=album_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
        )
