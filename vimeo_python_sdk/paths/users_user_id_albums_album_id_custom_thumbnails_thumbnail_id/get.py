...
class BaseApi(api_client.Api):
    ...
    def _get_specific_thumbnail_mapped_args(
        self,
    ...
    async def _aget_specific_thumbnail_oapg(
        self,
    ...
    def _get_specific_thumbnail_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificThumbnailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_thumbnail(
        self,
        album_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._get_specific_thumbnail_mapped_args(
            album_id=album_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
        )
        return await self._aget_specific_thumbnail_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_thumbnail(
        self,
        album_id: typing.Union[int, float],
        thumbnail_id: typing.Union[int, float],
        user_id: typing.Union[int, float],
        ...
        return self._get_specific_thumbnail_oapg(
            path_params=args.path,
        )

class GetSpecificThumbnail(BaseApi):
    ...
    async def aget_specific_thumbnail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_thumbnail(
            album_id=album_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
            **kwargs,
    ...
    def get_specific_thumbnail(
        ...
        raw_response = self.raw.get_specific_thumbnail(
            album_id=album_id,
            thumbnail_id=thumbnail_id,
            user_id=user_id,
        )
