...
from vimeo_python_sdk.model.categories_groups_get_all_groups_response import CategoriesGroupsGetAllGroupsResponse as CategoriesGroupsGetAllGroupsResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.categories_groups_get_all_groups_response import CategoriesGroupsGetAllGroupsResponse
...
from vimeo_python_sdk.pydantic.categories_groups_get_all_groups_response import CategoriesGroupsGetAllGroupsResponse as CategoriesGroupsGetAllGroupsResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoGroupjson = CategoriesGroupsGetAllGroupsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CategoriesGroupsGetAllGroupsResponse
...
SchemaFor404ResponseBodyApplicationVndVimeoGroupjson = LegacyErrorSchema
...
_response_for_404 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.group+json': api_client.MediaType(
            schema=SchemaFor404ResponseBodyApplicationVndVimeoGroupjson),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_all_groups_mapped_args(
        self,
        category: str,
    ...
    async def _aget_all_groups_oapg(
        self,
...
class GetAllGroupsRaw(BaseApi):
    ...
    async def aget_all_groups(
        ...
        **kwargs,
        ...
        args = self._get_all_groups_mapped_args(
            category=category,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        return await self._aget_all_groups_oapg(
    ...
    def get_all_groups(
        ...
        return self._get_all_groups_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllGroups(BaseApi):
    ...
    async def aget_all_groups(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CategoriesGroupsGetAllGroupsResponsePydantic:
        raw_response = await self.raw.aget_all_groups(
            category=category,
            direction=direction,
            page=page,
            per_page=per_page,
        ...
        if validate:
            return RootModel[CategoriesGroupsGetAllGroupsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CategoriesGroupsGetAllGroupsResponsePydantic, raw_response.body)
    ...
    def get_all_groups(
        ...
        raw_response = self.raw.get_all_groups(
            category=category,
            direction=direction,
            page=page,
            per_page=per_page,
