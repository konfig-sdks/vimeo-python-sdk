...
class BaseApi(api_client.Api):
    ...
    def _add_domain_to_whitelist_mapped_args(
        self,
        domain: str,
    ...
    async def _aadd_domain_to_whitelist_oapg(
        self,
    ...
    def _add_domain_to_whitelist_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddDomainToWhitelistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_domain_to_whitelist(
        self,
        domain: str,
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_domain_to_whitelist_mapped_args(
            domain=domain,
            video_id=video_id,
        )
        return await self._aadd_domain_to_whitelist_oapg(
    ...
    def add_domain_to_whitelist(
        ...
        return self._add_domain_to_whitelist_oapg(
            path_params=args.path,
        )

class AddDomainToWhitelist(BaseApi):
    ...
    async def aadd_domain_to_whitelist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_domain_to_whitelist(
            domain=domain,
            video_id=video_id,
            **kwargs,
        )
    ...
    def add_domain_to_whitelist(
        ...
        raw_response = self.raw.add_domain_to_whitelist(
            domain=domain,
            video_id=video_id,
        )
