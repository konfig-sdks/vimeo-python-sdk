...
class BaseApi(api_client.Api):
    ...
    def _remove_domain_from_whitelist_mapped_args(
        self,
        domain: str,
    ...
    async def _aremove_domain_from_whitelist_oapg(
        self,
    ...
    def _remove_domain_from_whitelist_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveDomainFromWhitelistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_domain_from_whitelist(
        self,
        domain: str,
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_domain_from_whitelist_mapped_args(
            domain=domain,
            video_id=video_id,
        )
        return await self._aremove_domain_from_whitelist_oapg(
    ...
    def remove_domain_from_whitelist(
        ...
        return self._remove_domain_from_whitelist_oapg(
            path_params=args.path,
        )

class RemoveDomainFromWhitelist(BaseApi):
    ...
    async def aremove_domain_from_whitelist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_domain_from_whitelist(
            domain=domain,
            video_id=video_id,
            **kwargs,
        )
    ...
    def remove_domain_from_whitelist(
        ...
        raw_response = self.raw.remove_domain_from_whitelist(
            domain=domain,
            video_id=video_id,
        )
