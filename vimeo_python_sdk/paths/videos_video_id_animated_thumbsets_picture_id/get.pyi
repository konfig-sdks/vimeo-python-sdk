...
class BaseApi(api_client.Api):
    ...
    def _specific_set_get_mapped_args(
        self,
        picture_id: str,
    ...
    async def _aspecific_set_get_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/videos/{video_id}/animated_thumbsets/{picture_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SpecificSetGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aspecific_set_get(
        self,
        picture_id: str,
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._specific_set_get_mapped_args(
            picture_id=picture_id,
            video_id=video_id,
        )
        return await self._aspecific_set_get_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def specific_set_get(
        self,
        picture_id: str,
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._specific_set_get_oapg(
            path_params=args.path,
        )

class SpecificSetGet(BaseApi):
    ...
    async def aspecific_set_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aspecific_set_get(
            picture_id=picture_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def specific_set_get(
        ...
        raw_response = self.raw.specific_set_get(
            picture_id=picture_id,
            video_id=video_id,
        )
        if validate:
