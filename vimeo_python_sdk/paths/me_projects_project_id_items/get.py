...
class BaseApi(api_client.Api):
    ...
    def _get_folder_items_mapped_args(
        self,
    ...
    async def _aget_folder_items_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/me/projects/{project_id}/items',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetFolderItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_folder_items(
        self,
        project_id: typing.Union[int, float],
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_folder_items_mapped_args(
        ...
        return await self._aget_folder_items_oapg(
    ...
    def get_folder_items(
        ...
        return self._get_folder_items_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFolderItems(BaseApi):
    ...
    async def aget_folder_items(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_folder_items(
            project_id=project_id,
            direction=direction,
            filter=filter,
            page=page,
    ...
    def get_folder_items(
        ...
        raw_response = self.raw.get_folder_items(
            project_id=project_id,
            direction=direction,
            filter=filter,
            page=page,
