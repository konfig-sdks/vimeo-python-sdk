...
from vimeo_python_sdk.model.showcases_showcase_videos_list_in_showcase200_response import ShowcasesShowcaseVideosListInShowcase200Response as ShowcasesShowcaseVideosListInShowcase200ResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.showcases_showcase_videos_list_in_showcase200_response import ShowcasesShowcaseVideosListInShowcase200Response
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.showcases_showcase_videos_list_in_showcase200_response import ShowcasesShowcaseVideosListInShowcase200Response as ShowcasesShowcaseVideosListInShowcase200ResponsePydantic
...
class SortSchema(
    ...
    def PLAYS(cls):
        return cls("plays")
WeakSearchSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'weak_search': typing.Union[WeakSearchSchema, bool, ],
    },
    total=False
)
...
request_query_weak_search = api_client.QueryParameter(
    name="weak_search",
    style=api_client.ParameterStyle.FORM,
    schema=WeakSearchSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = ShowcasesShowcaseVideosListInShowcase200ResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShowcasesShowcaseVideosListInShowcase200Response
...
class BaseApi(api_client.Api):
    ...
    def _list_in_showcase_0_mapped_args(
        self,
        ...
        weak_search: typing.Optional[bool] = None,
        ...
        if weak_search is not None:
            _query_params["weak_search"] = weak_search
    ...
    async def _alist_in_showcase_0_oapg(
        self,
...
class ListInShowcase0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_in_showcase_0(
        self,
        album_id: typing.Union[int, float],
        containing_uri: typing.Optional[str] = None,
        direction: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_in_showcase_0_mapped_args(
            album_id=album_id,
        ...
        return await self._alist_in_showcase_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_in_showcase_0(
        self,
        album_id: typing.Union[int, float],
        containing_uri: typing.Optional[str] = None,
        direction: typing.Optional[str] = None,
        ...
        return self._list_in_showcase_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListInShowcase0(BaseApi):
    ...
    async def alist_in_showcase_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShowcasesShowcaseVideosListInShowcase200ResponsePydantic:
        raw_response = await self.raw.alist_in_showcase_0(
            album_id=album_id,
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
        ...
        if validate:
            return RootModel[ShowcasesShowcaseVideosListInShowcase200ResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ShowcasesShowcaseVideosListInShowcase200ResponsePydantic, raw_response.body)
    ...
    def list_in_showcase_0(
        ...
        raw_response = self.raw.list_in_showcase_0(
            album_id=album_id,
            containing_uri=containing_uri,
            direction=direction,
            filter=filter,
