...
class BaseApi(api_client.Api):
    ...
    def _add_user_logo_0_mapped_args(
        self,
    ...
    async def _aadd_user_logo_0_oapg(
        self,
...
class AddUserLogo0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_user_logo_0(
        self,
        user_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._add_user_logo_0_mapped_args(
            user_id=user_id,
        )
        return await self._aadd_user_logo_0_oapg(
    ...
    def add_user_logo_0(
        ...
        return self._add_user_logo_0_oapg(
            path_params=args.path,
        )

class AddUserLogo0(BaseApi):
    ...
    async def aadd_user_logo_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_user_logo_0(
            user_id=user_id,
            **kwargs,
        )
        if validate:
    ...
    def add_user_logo_0(
        ...
        raw_response = self.raw.add_user_logo_0(
            user_id=user_id,
        )
        if validate:
            return PicturePydantic(**raw_response.body)
