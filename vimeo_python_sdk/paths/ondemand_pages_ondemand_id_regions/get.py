...
from vimeo_python_sdk.model.on_demand_regions_get_all_response import OnDemandRegionsGetAllResponse as OnDemandRegionsGetAllResponseSchema
from vimeo_python_sdk.model.legacy_error import LegacyError as LegacyErrorSchema

from vimeo_python_sdk.type.on_demand_regions_get_all_response import OnDemandRegionsGetAllResponse
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.on_demand_regions_get_all_response import OnDemandRegionsGetAllResponse as OnDemandRegionsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoOndemandRegionjson = OnDemandRegionsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OnDemandRegionsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OnDemandRegionsGetAllResponsePydantic:
        raw_response = await self.raw.aget_all(
            ondemand_id=ondemand_id,
            **kwargs,
        )
        if validate:
            return RootModel[OnDemandRegionsGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OnDemandRegionsGetAllResponsePydantic, raw_response.body)
