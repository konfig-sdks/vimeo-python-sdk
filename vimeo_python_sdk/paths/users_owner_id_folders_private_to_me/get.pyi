...
# Path params
OwnerIdSchema = schemas.NumberSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'owner_id': typing.Union[OwnerIdSchema, decimal.Decimal, int, float, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _get_user_private_to_me_folder_mapped_args(
        self,
    ...
    async def _aget_user_private_to_me_folder_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{owner_id}/folders/private_to_me',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_user_private_to_me_folder_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserPrivateToMeFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_private_to_me_folder(
        self,
        owner_id: typing.Union[int, float],
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_user_private_to_me_folder_mapped_args(
            owner_id=owner_id,
        )
        return await self._aget_user_private_to_me_folder_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_user_private_to_me_folder(
        self,
        owner_id: typing.Union[int, float],
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_user_private_to_me_folder_oapg(
            path_params=args.path,
        )

class GetUserPrivateToMeFolder(BaseApi):
    ...
    async def aget_user_private_to_me_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_private_to_me_folder(
            owner_id=owner_id,
            **kwargs,
        )
        if validate:
    ...
    def get_user_private_to_me_folder(
        ...
        raw_response = self.raw.get_user_private_to_me_folder(
            owner_id=owner_id,
        )
        if validate:
            return ProjectPydantic(**raw_response.body)
