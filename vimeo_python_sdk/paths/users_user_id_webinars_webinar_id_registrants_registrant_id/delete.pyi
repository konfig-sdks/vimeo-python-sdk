...
class BaseApi(api_client.Api):
    ...
    def _delete_registrant_record_0_mapped_args(
        self,
        registrant_id: str,
    ...
    async def _adelete_registrant_record_0_oapg(
        self,
    ...
    def _delete_registrant_record_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteRegistrantRecord0Raw(BaseApi):
    ...
    async def adelete_registrant_record_0(
        ...
        **kwargs,
        ...
        args = self._delete_registrant_record_0_mapped_args(
            registrant_id=registrant_id,
            user_id=user_id,
            webinar_id=webinar_id,
        )
        return await self._adelete_registrant_record_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    @api_client.DeprecationWarningOnce(prefix="webinar\registrations")
    def delete_registrant_record_0(
        self,
        registrant_id: str,
        user_id: typing.Union[int, float],
        webinar_id: str,
        ...
        return self._delete_registrant_record_0_oapg(
            path_params=args.path,
        )

class DeleteRegistrantRecord0(BaseApi):
    ...
    async def adelete_registrant_record_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_registrant_record_0(
            registrant_id=registrant_id,
            user_id=user_id,
            webinar_id=webinar_id,
            **kwargs,
    ...
    def delete_registrant_record_0(
        ...
        raw_response = self.raw.delete_registrant_record_0(
            registrant_id=registrant_id,
            user_id=user_id,
            webinar_id=webinar_id,
        )
