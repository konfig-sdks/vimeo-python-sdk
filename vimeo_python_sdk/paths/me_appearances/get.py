...
from vimeo_python_sdk.model.videos_essentials_get_user_appearances_response import VideosEssentialsGetUserAppearancesResponse as VideosEssentialsGetUserAppearancesResponseSchema

from vimeo_python_sdk.type.videos_essentials_get_user_appearances_response import VideosEssentialsGetUserAppearancesResponse

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.videos_essentials_get_user_appearances_response import VideosEssentialsGetUserAppearancesResponse as VideosEssentialsGetUserAppearancesResponsePydantic
...
SchemaFor200ResponseBodyApplicationVndVimeoVideojson = VideosEssentialsGetUserAppearancesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VideosEssentialsGetUserAppearancesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_appearances_mapped_args(
        self,
    ...
    async def _aget_user_appearances_oapg(
        self,
    ...
    def _get_user_appearances_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserAppearancesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_appearances(
        self,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        filter_embeddable: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_appearances_mapped_args(
            direction=direction,
            filter=filter,
        ...
        return await self._aget_user_appearances_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_user_appearances(
        self,
        direction: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        filter_embeddable: typing.Optional[bool] = None,
        ...
        return self._get_user_appearances_oapg(
            query_params=args.query,
        )

class GetUserAppearances(BaseApi):
    ...
    async def aget_user_appearances(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VideosEssentialsGetUserAppearancesResponsePydantic:
        raw_response = await self.raw.aget_user_appearances(
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
            page=page,
        ...
        if validate:
            return RootModel[VideosEssentialsGetUserAppearancesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VideosEssentialsGetUserAppearancesResponsePydantic, raw_response.body)
    ...
    def get_user_appearances(
        ...
        raw_response = self.raw.get_user_appearances(
            direction=direction,
            filter=filter,
            filter_embeddable=filter_embeddable,
            page=page,
