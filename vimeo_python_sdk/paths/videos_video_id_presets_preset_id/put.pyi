...
class BaseApi(api_client.Api):
    ...
    def _add_preset_to_video_mapped_args(
        self,
    ...
    async def _aadd_preset_to_video_oapg(
        self,
...
class AddPresetToVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_preset_to_video(
        self,
        preset_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._add_preset_to_video_mapped_args(
            preset_id=preset_id,
            video_id=video_id,
        )
        return await self._aadd_preset_to_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def add_preset_to_video(
        self,
        preset_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._add_preset_to_video_oapg(
            path_params=args.path,
        )

class AddPresetToVideo(BaseApi):
    ...
    async def aadd_preset_to_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_preset_to_video(
            preset_id=preset_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def add_preset_to_video(
        ...
        raw_response = self.raw.add_preset_to_video(
            preset_id=preset_id,
            video_id=video_id,
        )
