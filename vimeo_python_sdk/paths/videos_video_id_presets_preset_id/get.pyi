...
class BaseApi(api_client.Api):
    ...
    def _check_if_preset_added_to_video_mapped_args(
        self,
    ...
    async def _acheck_if_preset_added_to_video_oapg(
        self,
    ...
    def _check_if_preset_added_to_video_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckIfPresetAddedToVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_if_preset_added_to_video(
        self,
        preset_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._check_if_preset_added_to_video_mapped_args(
            preset_id=preset_id,
            video_id=video_id,
        )
        return await self._acheck_if_preset_added_to_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def check_if_preset_added_to_video(
        self,
        preset_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._check_if_preset_added_to_video_oapg(
            path_params=args.path,
        )

class CheckIfPresetAddedToVideo(BaseApi):
    ...
    async def acheck_if_preset_added_to_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_if_preset_added_to_video(
            preset_id=preset_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def check_if_preset_added_to_video(
        ...
        raw_response = self.raw.check_if_preset_added_to_video(
            preset_id=preset_id,
            video_id=video_id,
        )
