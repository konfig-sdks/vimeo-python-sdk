...
class BaseApi(api_client.Api):
    ...
    def _remove_preset_from_video_mapped_args(
        self,
    ...
    async def _aremove_preset_from_video_oapg(
        self,
    ...
    def _remove_preset_from_video_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemovePresetFromVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_preset_from_video(
        self,
        preset_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._remove_preset_from_video_mapped_args(
            preset_id=preset_id,
            video_id=video_id,
        )
        return await self._aremove_preset_from_video_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_preset_from_video(
        self,
        preset_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
    ) -> typing.Union[
        ...
        return self._remove_preset_from_video_oapg(
            path_params=args.path,
        )

class RemovePresetFromVideo(BaseApi):
    ...
    async def aremove_preset_from_video(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_preset_from_video(
            preset_id=preset_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def remove_preset_from_video(
        ...
        raw_response = self.raw.remove_preset_from_video(
            preset_id=preset_id,
            video_id=video_id,
        )
