...
from vimeo_python_sdk.model.edit_chapter_request import EditChapterRequest as EditChapterRequestSchema
...
from vimeo_python_sdk.type.edit_chapter_request import EditChapterRequest
from vimeo_python_sdk.type.legacy_error import LegacyError

from ...api_client import Dictionary
from vimeo_python_sdk.pydantic.edit_chapter_request import EditChapterRequest as EditChapterRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndVimeoVideoChapterjson = EditChapterRequestSchema


request_body_edit_chapter_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndVimeoVideoChapterjson = ChapterSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.video.chapter+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndVimeoVideoChapterjson),
    },
)
SchemaFor403ResponseBodyApplicationVndVimeoVideoChapterjson = ErrorSchema
...
SchemaFor404ResponseBodyApplicationVndVimeoVideoChapterjson = LegacyErrorSchema
...
_response_for_404 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.vimeo.video.chapter+json': api_client.MediaType(
            schema=SchemaFor404ResponseBodyApplicationVndVimeoVideoChapterjson),
    },
)
    ...
    async def _achapter_2_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/videos/{video_id}/chapters/{chapter_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_edit_chapter_request.serialize(body, content_type)
...
class Chapter2Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achapter_2(
        self,
        chapter_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        title: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._chapter_2_mapped_args(
        ...
        return await self._achapter_2_oapg(
            body=args.body,
    ...
    def chapter_2(
        ...
        return self._chapter_2_oapg(
            body=args.body,
            path_params=args.path,
        )

class Chapter2(BaseApi):
    ...
    async def achapter_2(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.achapter_2(
            chapter_id=chapter_id,
            video_id=video_id,
            title=title,
            active_thumbnail_uri=active_thumbnail_uri,
    ...
    def chapter_2(
        ...
        raw_response = self.raw.chapter_2(
            chapter_id=chapter_id,
            video_id=video_id,
            title=title,
            active_thumbnail_uri=active_thumbnail_uri,
