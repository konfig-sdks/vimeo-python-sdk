...
class Chapter0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def achapter_0(
        self,
        chapter_id: typing.Union[int, float],
        video_id: typing.Union[int, float],
        **kwargs,
        ...
        args = self._chapter_0_mapped_args(
            chapter_id=chapter_id,
            video_id=video_id,
        )
        return await self._achapter_0_oapg(
    ...
    def chapter_0(
        ...
        return self._chapter_0_oapg(
            path_params=args.path,
        )

class Chapter0(BaseApi):
    ...
    async def achapter_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.achapter_0(
            chapter_id=chapter_id,
            video_id=video_id,
            **kwargs,
        )
    ...
    def chapter_0(
        ...
        raw_response = self.raw.chapter_0(
            chapter_id=chapter_id,
            video_id=video_id,
        )
        if validate:
