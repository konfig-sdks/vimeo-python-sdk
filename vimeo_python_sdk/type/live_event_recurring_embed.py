...
from vimeo_python_sdk.type.live_event_recurring_embed_available_player_logos import LiveEventRecurringEmbedAvailablePlayerLogos
from vimeo_python_sdk.type.live_event_recurring_embed_colors import LiveEventRecurringEmbedColors
from vimeo_python_sdk.type.live_event_recurring_embed_embed_properties import LiveEventRecurringEmbedEmbedProperties
from vimeo_python_sdk.type.live_event_recurring_embed_logos import LiveEventRecurringEmbedLogos

class RequiredLiveEventRecurringEmbed(TypedDict):
    ...
    available_player_logos: LiveEventRecurringEmbedAvailablePlayerLogos
    ...
    embed_properties: LiveEventRecurringEmbedEmbedProperties
...
class OptionalLiveEventRecurringEmbed(TypedDict, total=False):
    pass

class LiveEventRecurringEmbed(RequiredLiveEventRecurringEmbed, OptionalLiveEventRecurringEmbed):
    pass
