...
class RequiredPresetSettingsPlayButton(TypedDict):
...
class OptionalPresetSettingsPlayButton(TypedDict, total=False):
    pass

class PresetSettingsPlayButton(RequiredPresetSettingsPlayButton, OptionalPresetSettingsPlayButton):
    pass
