...
from vimeo_python_sdk.type.disabled_video_properties_embed_presets_reasons import DisabledVideoPropertiesEmbedPresetsReasons

class RequiredDisabledVideoPropertiesEmbedPresets(TypedDict):
    ...
    reasons: DisabledVideoPropertiesEmbedPresetsReasons

class OptionalDisabledVideoPropertiesEmbedPresets(TypedDict, total=False):
    pass

class DisabledVideoPropertiesEmbedPresets(RequiredDisabledVideoPropertiesEmbedPresets, OptionalDisabledVideoPropertiesEmbedPresets):
    pass
