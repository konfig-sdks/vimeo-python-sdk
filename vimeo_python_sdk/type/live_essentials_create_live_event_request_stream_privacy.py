...
class RequiredLiveEssentialsCreateLiveEventRequestStreamPrivacy(TypedDict):
    pass

class OptionalLiveEssentialsCreateLiveEventRequestStreamPrivacy(TypedDict, total=False):
...
class LiveEssentialsCreateLiveEventRequestStreamPrivacy(RequiredLiveEssentialsCreateLiveEventRequestStreamPrivacy, OptionalLiveEssentialsCreateLiveEventRequestStreamPrivacy):
    pass
