...
class RequiredLiveEssentialsCreateEventRequestStreamPrivacy(TypedDict):
    pass

class OptionalLiveEssentialsCreateEventRequestStreamPrivacy(TypedDict, total=False):
...
class LiveEssentialsCreateEventRequestStreamPrivacy(RequiredLiveEssentialsCreateEventRequestStreamPrivacy, OptionalLiveEssentialsCreateEventRequestStreamPrivacy):
    pass
