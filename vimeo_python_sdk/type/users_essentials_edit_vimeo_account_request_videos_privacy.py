...
class RequiredUsersEssentialsEditVimeoAccountRequestVideosPrivacy(TypedDict):
    pass

class OptionalUsersEssentialsEditVimeoAccountRequestVideosPrivacy(TypedDict, total=False):
...
class UsersEssentialsEditVimeoAccountRequestVideosPrivacy(RequiredUsersEssentialsEditVimeoAccountRequestVideosPrivacy, OptionalUsersEssentialsEditVimeoAccountRequestVideosPrivacy):
    pass
