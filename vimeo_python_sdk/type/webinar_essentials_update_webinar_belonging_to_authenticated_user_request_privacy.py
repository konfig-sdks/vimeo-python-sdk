...
class RequiredWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestPrivacy(TypedDict):
    pass

class OptionalWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestPrivacy(TypedDict, total=False):
...
class WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestPrivacy(RequiredWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestPrivacy, OptionalWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestPrivacy):
    pass
