...
class RequiredEmbedPresetsEssentialsCreatePresetRequestEmbedTitle(TypedDict):
    pass

class OptionalEmbedPresetsEssentialsCreatePresetRequestEmbedTitle(TypedDict, total=False):
...
class EmbedPresetsEssentialsCreatePresetRequestEmbedTitle(RequiredEmbedPresetsEssentialsCreatePresetRequestEmbedTitle, OptionalEmbedPresetsEssentialsCreatePresetRequestEmbedTitle):
    pass
