...
class RequiredUploadVideoRequest(TypedDict):
    upload: UploadVideoRequestUpload

class OptionalUploadVideoRequest(TypedDict, total=False):
    # The description of the video.
    description: str

    content_rating: UploadVideoRequestContentRating

    embed: UploadVideoRequestEmbed

    embed_domains: UploadVideoRequestEmbedDomains
...
class UploadVideoRequest(RequiredUploadVideoRequest, OptionalUploadVideoRequest):
    pass
