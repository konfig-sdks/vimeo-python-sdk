...
class RequiredEmailCaptureFormCustomFieldsItemConnectedFieldsItem(TypedDict):
...
class OptionalEmailCaptureFormCustomFieldsItemConnectedFieldsItem(TypedDict, total=False):
    pass

class EmailCaptureFormCustomFieldsItemConnectedFieldsItem(RequiredEmailCaptureFormCustomFieldsItemConnectedFieldsItem, OptionalEmailCaptureFormCustomFieldsItemConnectedFieldsItem):
    pass
