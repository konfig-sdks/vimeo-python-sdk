...
class RequiredUploadVideoRequestEmbedTitle(TypedDict):
    pass

class OptionalUploadVideoRequestEmbedTitle(TypedDict, total=False):
...
class UploadVideoRequestEmbedTitle(RequiredUploadVideoRequestEmbedTitle, OptionalUploadVideoRequestEmbedTitle):
    pass
