...
class RequiredLiveEventDestinationsCreateEventDestinationRequest(TypedDict):
...
class OptionalLiveEventDestinationsCreateEventDestinationRequest(TypedDict, total=False):
...
class LiveEventDestinationsCreateEventDestinationRequest(RequiredLiveEventDestinationsCreateEventDestinationRequest, OptionalLiveEventDestinationsCreateEventDestinationRequest):
    pass
