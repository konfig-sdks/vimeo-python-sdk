...
from vimeo_python_sdk.type.webinar_essentials_update_webinar_belonging_to_authenticated_user_request_email_settings_email_preferences import WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences

RequiredWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings = TypedDict("RequiredWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings", {
    })

OptionalWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings = TypedDict("OptionalWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings", {
    ...
    "email_preferences": WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences,
...
class WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings(RequiredWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings, OptionalWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings):
    pass
