...
class RequiredLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy(TypedDict):
    pass

class OptionalLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy(TypedDict, total=False):
...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy(RequiredLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy, OptionalLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestStreamPrivacy):
    pass
