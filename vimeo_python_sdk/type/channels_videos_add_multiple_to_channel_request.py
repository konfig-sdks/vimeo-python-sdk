...
class RequiredChannelsVideosAddMultipleToChannelRequest(TypedDict):
...
class OptionalChannelsVideosAddMultipleToChannelRequest(TypedDict, total=False):
    pass

class ChannelsVideosAddMultipleToChannelRequest(RequiredChannelsVideosAddMultipleToChannelRequest, OptionalChannelsVideosAddMultipleToChannelRequest):
    pass
