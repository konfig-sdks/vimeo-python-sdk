...
from vimeo_python_sdk.type.disabled_video_properties_embed_reasons import DisabledVideoPropertiesEmbedReasons

class RequiredDisabledVideoPropertiesEmbed(TypedDict):
    ...
    reasons: DisabledVideoPropertiesEmbedReasons

class OptionalDisabledVideoPropertiesEmbed(TypedDict, total=False):
    pass

class DisabledVideoPropertiesEmbed(RequiredDisabledVideoPropertiesEmbed, OptionalDisabledVideoPropertiesEmbed):
    pass
