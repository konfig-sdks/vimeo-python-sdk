...
class RequiredLiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1(TypedDict):
...
class OptionalLiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1(TypedDict, total=False):
...
class LiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1(RequiredLiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1, OptionalLiveEventDestinationsCreateOneTimeLiveEventDestinationRequest1):
    pass
