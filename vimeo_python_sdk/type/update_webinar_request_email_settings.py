...
from vimeo_python_sdk.type.update_webinar_request_email_settings_email_preferences import UpdateWebinarRequestEmailSettingsEmailPreferences

RequiredUpdateWebinarRequestEmailSettings = TypedDict("RequiredUpdateWebinarRequestEmailSettings", {
    })

OptionalUpdateWebinarRequestEmailSettings = TypedDict("OptionalUpdateWebinarRequestEmailSettings", {
    ...
    "email_preferences": UpdateWebinarRequestEmailSettingsEmailPreferences,
...
class UpdateWebinarRequestEmailSettings(RequiredUpdateWebinarRequestEmailSettings, OptionalUpdateWebinarRequestEmailSettings):
    pass
