...
from vimeo_python_sdk.type.disabled_video_properties_download_reasons import DisabledVideoPropertiesDownloadReasons

class RequiredDisabledVideoPropertiesDownload(TypedDict):
    ...
    reasons: DisabledVideoPropertiesDownloadReasons

class OptionalDisabledVideoPropertiesDownload(TypedDict, total=False):
    pass

class DisabledVideoPropertiesDownload(RequiredDisabledVideoPropertiesDownload, OptionalDisabledVideoPropertiesDownload):
    pass
