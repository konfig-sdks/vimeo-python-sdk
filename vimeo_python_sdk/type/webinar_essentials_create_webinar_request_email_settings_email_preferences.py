...
class RequiredWebinarEssentialsCreateWebinarRequestEmailSettingsEmailPreferences(TypedDict):
    pass

class OptionalWebinarEssentialsCreateWebinarRequestEmailSettingsEmailPreferences(TypedDict, total=False):
...
class WebinarEssentialsCreateWebinarRequestEmailSettingsEmailPreferences(RequiredWebinarEssentialsCreateWebinarRequestEmailSettingsEmailPreferences, OptionalWebinarEssentialsCreateWebinarRequestEmailSettingsEmailPreferences):
    pass
