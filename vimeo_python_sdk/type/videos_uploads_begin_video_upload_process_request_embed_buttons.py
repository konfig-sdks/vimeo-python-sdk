...
class RequiredVideosUploadsBeginVideoUploadProcessRequestEmbedButtons(TypedDict):
    pass

class OptionalVideosUploadsBeginVideoUploadProcessRequestEmbedButtons(TypedDict, total=False):
...
class VideosUploadsBeginVideoUploadProcessRequestEmbedButtons(RequiredVideosUploadsBeginVideoUploadProcessRequestEmbedButtons, OptionalVideosUploadsBeginVideoUploadProcessRequestEmbedButtons):
    pass
