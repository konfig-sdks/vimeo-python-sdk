...
from vimeo_python_sdk.type.create_vod_request_episodes_rent_price import CreateVodRequestEpisodesRentPrice

class RequiredCreateVodRequestEpisodesRent(TypedDict):
    pass

class OptionalCreateVodRequestEpisodesRent(TypedDict, total=False):
...
class CreateVodRequestEpisodesRent(RequiredCreateVodRequestEpisodesRent, OptionalCreateVodRequestEpisodesRent):
    pass
