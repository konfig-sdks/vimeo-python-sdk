...
class RequiredWebinarEventStreamPrivacy(TypedDict):
...
class OptionalWebinarEventStreamPrivacy(TypedDict, total=False):
    pass

class WebinarEventStreamPrivacy(RequiredWebinarEventStreamPrivacy, OptionalWebinarEventStreamPrivacy):
    pass
