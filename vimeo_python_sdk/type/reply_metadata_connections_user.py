...
class RequiredReplyMetadataConnectionsUser(TypedDict):
...
class OptionalReplyMetadataConnectionsUser(TypedDict, total=False):
    pass

class ReplyMetadataConnectionsUser(RequiredReplyMetadataConnectionsUser, OptionalReplyMetadataConnectionsUser):
    pass
