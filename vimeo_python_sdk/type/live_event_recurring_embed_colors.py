...
class RequiredLiveEventRecurringEmbedColors(TypedDict):
...
class OptionalLiveEventRecurringEmbedColors(TypedDict, total=False):
    pass

class LiveEventRecurringEmbedColors(RequiredLiveEventRecurringEmbedColors, OptionalLiveEventRecurringEmbedColors):
    pass
