...
from vimeo_python_sdk.type.live_essentials_create_live_event_request_embed_logos import LiveEssentialsCreateLiveEventRequestEmbedLogos

class RequiredLiveEssentialsCreateLiveEventRequestEmbed(TypedDict):
    pass

class OptionalLiveEssentialsCreateLiveEventRequestEmbed(TypedDict, total=False):
...
class LiveEssentialsCreateLiveEventRequestEmbed(RequiredLiveEssentialsCreateLiveEventRequestEmbed, OptionalLiveEssentialsCreateLiveEventRequestEmbed):
    pass
