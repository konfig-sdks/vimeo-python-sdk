...
class RequiredVideoVersionUpload(TypedDict):
...
class OptionalVideoVersionUpload(TypedDict, total=False):
...
class VideoVersionUpload(RequiredVideoVersionUpload, OptionalVideoVersionUpload):
    pass
