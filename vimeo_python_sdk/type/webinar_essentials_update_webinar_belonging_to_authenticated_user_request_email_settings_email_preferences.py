...
class RequiredWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences(TypedDict):
    pass

class OptionalWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences(TypedDict, total=False):
...
class WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences(RequiredWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences, OptionalWebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences):
    pass
