...
class RequiredLiveEventAutomatedClosedCaptionsEditPreferenceRequest(TypedDict):
    # Whether automated closed captions are enabled for the event.
    auto_cc_enabled: bool

class OptionalLiveEventAutomatedClosedCaptionsEditPreferenceRequest(TypedDict, total=False):
...
class LiveEventAutomatedClosedCaptionsEditPreferenceRequest(RequiredLiveEventAutomatedClosedCaptionsEditPreferenceRequest, OptionalLiveEventAutomatedClosedCaptionsEditPreferenceRequest):
    pass
