...
class RequiredLiveEssentialsCreateEventForUserRequest(TypedDict):
...
class OptionalLiveEssentialsCreateEventForUserRequest(TypedDict, total=False):
    ...
    content_rating: LiveEssentialsCreateEventForUserRequestContentRating
...
class LiveEssentialsCreateEventForUserRequest(RequiredLiveEssentialsCreateEventForUserRequest, OptionalLiveEssentialsCreateEventForUserRequest):
    pass
