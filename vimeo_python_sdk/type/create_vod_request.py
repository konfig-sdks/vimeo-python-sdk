...
class RequiredCreateVodRequest(TypedDict):
...
class OptionalCreateVodRequest(TypedDict, total=False):
...
class CreateVodRequest(RequiredCreateVodRequest, OptionalCreateVodRequest):
    pass
