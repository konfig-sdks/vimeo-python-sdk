...
class RequiredVideosUploadsBeginVideoUploadProcessRequestPrivacy(TypedDict):
    pass

class OptionalVideosUploadsBeginVideoUploadProcessRequestPrivacy(TypedDict, total=False):
...
class VideosUploadsBeginVideoUploadProcessRequestPrivacy(RequiredVideosUploadsBeginVideoUploadProcessRequestPrivacy, OptionalVideosUploadsBeginVideoUploadProcessRequestPrivacy):
    pass
