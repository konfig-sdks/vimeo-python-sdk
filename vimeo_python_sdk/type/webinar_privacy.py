...
class RequiredWebinarPrivacy(TypedDict):
...
class OptionalWebinarPrivacy(TypedDict, total=False):
    pass

class WebinarPrivacy(RequiredWebinarPrivacy, OptionalWebinarPrivacy):
    pass
