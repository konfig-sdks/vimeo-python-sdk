...
class RequiredEditVideoRequestPrivacy(TypedDict):
    pass

class OptionalEditVideoRequestPrivacy(TypedDict, total=False):
...
class EditVideoRequestPrivacy(RequiredEditVideoRequestPrivacy, OptionalEditVideoRequestPrivacy):
    pass
