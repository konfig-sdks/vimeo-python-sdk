...
class RequiredLiveEventEmbedColors(TypedDict):
...
class OptionalLiveEventEmbedColors(TypedDict, total=False):
    pass

class LiveEventEmbedColors(RequiredLiveEventEmbedColors, OptionalLiveEventEmbedColors):
    pass
