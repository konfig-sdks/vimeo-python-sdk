...
class RequiredLiveEssentialsCreateLiveEventRequest(TypedDict):
...
class OptionalLiveEssentialsCreateLiveEventRequest(TypedDict, total=False):
    ...
    content_rating: LiveEssentialsCreateLiveEventRequestContentRating
...
class LiveEssentialsCreateLiveEventRequest(RequiredLiveEssentialsCreateLiveEventRequest, OptionalLiveEssentialsCreateLiveEventRequest):
    pass
