...
class RequiredCreateShowcaseRequest(TypedDict):
    # The name of the showcase.
    name: str

class OptionalCreateShowcaseRequest(TypedDict, total=False):
...
class CreateShowcaseRequest(RequiredCreateShowcaseRequest, OptionalCreateShowcaseRequest):
    pass
