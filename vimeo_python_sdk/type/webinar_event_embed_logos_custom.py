...
class RequiredWebinarEventEmbedLogosCustom(TypedDict):
...
class OptionalWebinarEventEmbedLogosCustom(TypedDict, total=False):
    pass

class WebinarEventEmbedLogosCustom(RequiredWebinarEventEmbedLogosCustom, OptionalWebinarEventEmbedLogosCustom):
    pass
