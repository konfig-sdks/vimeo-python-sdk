...
class RequiredEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedTitle(TypedDict):
    pass

class OptionalEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedTitle(TypedDict, total=False):
...
class EmbedPresetsEssentialsCreateEmbedPresetRequestEmbedTitle(RequiredEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedTitle, OptionalEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedTitle):
    pass
