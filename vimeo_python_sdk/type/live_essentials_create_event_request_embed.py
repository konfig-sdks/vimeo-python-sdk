...
from vimeo_python_sdk.type.live_essentials_create_event_request_embed_logos import LiveEssentialsCreateEventRequestEmbedLogos

class RequiredLiveEssentialsCreateEventRequestEmbed(TypedDict):
    pass

class OptionalLiveEssentialsCreateEventRequestEmbed(TypedDict, total=False):
...
class LiveEssentialsCreateEventRequestEmbed(RequiredLiveEssentialsCreateEventRequestEmbed, OptionalLiveEssentialsCreateEventRequestEmbed):
    pass
