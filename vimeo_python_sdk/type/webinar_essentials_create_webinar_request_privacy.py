...
class RequiredWebinarEssentialsCreateWebinarRequestPrivacy(TypedDict):
    pass

class OptionalWebinarEssentialsCreateWebinarRequestPrivacy(TypedDict, total=False):
...
class WebinarEssentialsCreateWebinarRequestPrivacy(RequiredWebinarEssentialsCreateWebinarRequestPrivacy, OptionalWebinarEssentialsCreateWebinarRequestPrivacy):
    pass
