...
class RequiredWebinarEventEmbedColors(TypedDict):
...
class OptionalWebinarEventEmbedColors(TypedDict, total=False):
    pass

class WebinarEventEmbedColors(RequiredWebinarEventEmbedColors, OptionalWebinarEventEmbedColors):
    pass
