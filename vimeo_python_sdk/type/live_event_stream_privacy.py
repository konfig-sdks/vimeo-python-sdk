...
class RequiredLiveEventStreamPrivacy(TypedDict):
...
class OptionalLiveEventStreamPrivacy(TypedDict, total=False):
    pass

class LiveEventStreamPrivacy(RequiredLiveEventStreamPrivacy, OptionalLiveEventStreamPrivacy):
    pass
