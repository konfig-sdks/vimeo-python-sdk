...
from vimeo_python_sdk.type.live_event_embed_available_player_logos import LiveEventEmbedAvailablePlayerLogos
from vimeo_python_sdk.type.live_event_embed_colors import LiveEventEmbedColors
from vimeo_python_sdk.type.live_event_embed_embed_properties import LiveEventEmbedEmbedProperties
from vimeo_python_sdk.type.live_event_embed_logos import LiveEventEmbedLogos

class RequiredLiveEventEmbed(TypedDict):
...
class OptionalLiveEventEmbed(TypedDict, total=False):
    pass

class LiveEventEmbed(RequiredLiveEventEmbed, OptionalLiveEventEmbed):
    pass
