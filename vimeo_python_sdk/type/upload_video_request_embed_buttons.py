...
class RequiredUploadVideoRequestEmbedButtons(TypedDict):
    pass

class OptionalUploadVideoRequestEmbedButtons(TypedDict, total=False):
...
class UploadVideoRequestEmbedButtons(RequiredUploadVideoRequestEmbedButtons, OptionalUploadVideoRequestEmbedButtons):
    pass
