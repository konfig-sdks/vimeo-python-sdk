...
class RequiredCreateWebinarRequestEmailSettingsEmailPreferences(TypedDict):
    pass

class OptionalCreateWebinarRequestEmailSettingsEmailPreferences(TypedDict, total=False):
...
class CreateWebinarRequestEmailSettingsEmailPreferences(RequiredCreateWebinarRequestEmailSettingsEmailPreferences, OptionalCreateWebinarRequestEmailSettingsEmailPreferences):
    pass
