...
class RequiredDisabledVideoPropertiesDuplicateReasonsItem(TypedDict):
...
class OptionalDisabledVideoPropertiesDuplicateReasonsItem(TypedDict, total=False):
    pass

class DisabledVideoPropertiesDuplicateReasonsItem(RequiredDisabledVideoPropertiesDuplicateReasonsItem, OptionalDisabledVideoPropertiesDuplicateReasonsItem):
    pass
