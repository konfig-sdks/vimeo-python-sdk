...
class RequiredEditVideoRequestSpatialDirectorTimelineItem(TypedDict):
...
class OptionalEditVideoRequestSpatialDirectorTimelineItem(TypedDict, total=False):
    # The 360 director timeline roll.
    roll: typing.Union[int, float]

class EditVideoRequestSpatialDirectorTimelineItem(RequiredEditVideoRequestSpatialDirectorTimelineItem, OptionalEditVideoRequestSpatialDirectorTimelineItem):
    pass
