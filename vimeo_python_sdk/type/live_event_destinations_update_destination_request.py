...
class RequiredLiveEventDestinationsUpdateDestinationRequest(TypedDict):
    pass

class OptionalLiveEventDestinationsUpdateDestinationRequest(TypedDict, total=False):
...
class LiveEventDestinationsUpdateDestinationRequest(RequiredLiveEventDestinationsUpdateDestinationRequest, OptionalLiveEventDestinationsUpdateDestinationRequest):
    pass
