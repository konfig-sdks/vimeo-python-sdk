...
class RequiredCreateVodRequestRentPrice(TypedDict):
    pass

class OptionalCreateVodRequestRentPrice(TypedDict, total=False):
...
class CreateVodRequestRentPrice(RequiredCreateVodRequestRentPrice, OptionalCreateVodRequestRentPrice):
    pass
