...
class RequiredEmbedSettingsColors(TypedDict):
...
class OptionalEmbedSettingsColors(TypedDict, total=False):
    pass

class EmbedSettingsColors(RequiredEmbedSettingsColors, OptionalEmbedSettingsColors):
    pass
