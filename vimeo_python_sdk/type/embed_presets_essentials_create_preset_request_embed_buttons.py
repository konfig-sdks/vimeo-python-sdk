...
class RequiredEmbedPresetsEssentialsCreatePresetRequestEmbedButtons(TypedDict):
    pass

class OptionalEmbedPresetsEssentialsCreatePresetRequestEmbedButtons(TypedDict, total=False):
...
class EmbedPresetsEssentialsCreatePresetRequestEmbedButtons(RequiredEmbedPresetsEssentialsCreatePresetRequestEmbedButtons, OptionalEmbedPresetsEssentialsCreatePresetRequestEmbedButtons):
    pass
