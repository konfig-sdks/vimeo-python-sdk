...
class RequiredEditVideoRequestEmbedTitle(TypedDict):
    pass

class OptionalEditVideoRequestEmbedTitle(TypedDict, total=False):
...
class EditVideoRequestEmbedTitle(RequiredEditVideoRequestEmbedTitle, OptionalEditVideoRequestEmbedTitle):
    pass
