...
class RequiredLiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest(TypedDict):
    # Whether automated closed captions are enabled for the event.
    auto_cc_enabled: bool

class OptionalLiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest(TypedDict, total=False):
...
class LiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest(RequiredLiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest, OptionalLiveEventAutomatedClosedCaptionsEditPreferenceForEventRequest):
    pass
