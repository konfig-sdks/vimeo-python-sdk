...
class RequiredEditVideoRequestEmbedLogosCustom(TypedDict):
    pass

class OptionalEditVideoRequestEmbedLogosCustom(TypedDict, total=False):
...
class EditVideoRequestEmbedLogosCustom(RequiredEditVideoRequestEmbedLogosCustom, OptionalEditVideoRequestEmbedLogosCustom):
    pass
