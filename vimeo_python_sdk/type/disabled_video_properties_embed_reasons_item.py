...
class RequiredDisabledVideoPropertiesEmbedReasonsItem(TypedDict):
...
class OptionalDisabledVideoPropertiesEmbedReasonsItem(TypedDict, total=False):
    pass

class DisabledVideoPropertiesEmbedReasonsItem(RequiredDisabledVideoPropertiesEmbedReasonsItem, OptionalDisabledVideoPropertiesEmbedReasonsItem):
    pass
