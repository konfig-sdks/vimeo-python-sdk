...
from vimeo_python_sdk.type.upload_video_request_spatial_director_timeline import UploadVideoRequestSpatialDirectorTimeline

class RequiredUploadVideoRequestSpatial(TypedDict):
    pass

class OptionalUploadVideoRequestSpatial(TypedDict, total=False):
    director_timeline: UploadVideoRequestSpatialDirectorTimeline
...
class UploadVideoRequestSpatial(RequiredUploadVideoRequestSpatial, OptionalUploadVideoRequestSpatial):
    pass
