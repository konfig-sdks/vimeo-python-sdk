...
class RequiredOnDemandVideosAddVideoToPageRequestRentPrice(TypedDict):
    pass

class OptionalOnDemandVideosAddVideoToPageRequestRentPrice(TypedDict, total=False):
...
class OnDemandVideosAddVideoToPageRequestRentPrice(RequiredOnDemandVideosAddVideoToPageRequestRentPrice, OptionalOnDemandVideosAddVideoToPageRequestRentPrice):
    pass
