...
class RequiredCreateVodRequestBuyPrice(TypedDict):
    pass

class OptionalCreateVodRequestBuyPrice(TypedDict, total=False):
...
class CreateVodRequestBuyPrice(RequiredCreateVodRequestBuyPrice, OptionalCreateVodRequestBuyPrice):
    pass
