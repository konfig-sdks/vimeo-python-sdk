...
class RequiredEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedButtons(TypedDict):
    pass

class OptionalEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedButtons(TypedDict, total=False):
...
class EmbedPresetsEssentialsCreateEmbedPresetRequestEmbedButtons(RequiredEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedButtons, OptionalEmbedPresetsEssentialsCreateEmbedPresetRequestEmbedButtons):
    pass
