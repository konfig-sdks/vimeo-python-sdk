...
from vimeo_python_sdk.type.create_vod_request_rent_price import CreateVodRequestRentPrice

class RequiredCreateVodRequestRent(TypedDict):
    pass

class OptionalCreateVodRequestRent(TypedDict, total=False):
...
class CreateVodRequestRent(RequiredCreateVodRequestRent, OptionalCreateVodRequestRent):
    pass
