...
class RequiredUploadVideoRequestSpatialDirectorTimelineItem(TypedDict):
...
class OptionalUploadVideoRequestSpatialDirectorTimelineItem(TypedDict, total=False):
    # The 360 director timeline roll.
    roll: typing.Union[int, float]

class UploadVideoRequestSpatialDirectorTimelineItem(RequiredUploadVideoRequestSpatialDirectorTimelineItem, OptionalUploadVideoRequestSpatialDirectorTimelineItem):
    pass
