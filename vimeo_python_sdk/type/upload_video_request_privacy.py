...
class RequiredUploadVideoRequestPrivacy(TypedDict):
    pass

class OptionalUploadVideoRequestPrivacy(TypedDict, total=False):
...
class UploadVideoRequestPrivacy(RequiredUploadVideoRequestPrivacy, OptionalUploadVideoRequestPrivacy):
    pass
