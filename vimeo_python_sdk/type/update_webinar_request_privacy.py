...
class RequiredUpdateWebinarRequestPrivacy(TypedDict):
    pass

class OptionalUpdateWebinarRequestPrivacy(TypedDict, total=False):
...
class UpdateWebinarRequestPrivacy(RequiredUpdateWebinarRequestPrivacy, OptionalUpdateWebinarRequestPrivacy):
    pass
