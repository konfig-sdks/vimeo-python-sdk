...
class RequiredLiveEventDestinationsCreateDestinationRequest(TypedDict):
...
class OptionalLiveEventDestinationsCreateDestinationRequest(TypedDict, total=False):
...
class LiveEventDestinationsCreateDestinationRequest(RequiredLiveEventDestinationsCreateDestinationRequest, OptionalLiveEventDestinationsCreateDestinationRequest):
    pass
