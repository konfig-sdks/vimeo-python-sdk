...
class RequiredShowcasesEssentialsCreateUserShowcaseRequest(TypedDict):
    # The name of the showcase.
    name: str

class OptionalShowcasesEssentialsCreateUserShowcaseRequest(TypedDict, total=False):
...
class ShowcasesEssentialsCreateUserShowcaseRequest(RequiredShowcasesEssentialsCreateUserShowcaseRequest, OptionalShowcasesEssentialsCreateUserShowcaseRequest):
    pass
