...
class RequiredLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy(TypedDict):
    pass

class OptionalLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy(TypedDict, total=False):
...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy(RequiredLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy, OptionalLiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy):
    pass
