...
from vimeo_python_sdk.type.update_webinar_request_schedule_weekdays import UpdateWebinarRequestScheduleWeekdays

class RequiredUpdateWebinarRequestSchedule(TypedDict):
    pass

class OptionalUpdateWebinarRequestSchedule(TypedDict, total=False):
    ...
    weekdays: UpdateWebinarRequestScheduleWeekdays

class UpdateWebinarRequestSchedule(RequiredUpdateWebinarRequestSchedule, OptionalUpdateWebinarRequestSchedule):
    pass
