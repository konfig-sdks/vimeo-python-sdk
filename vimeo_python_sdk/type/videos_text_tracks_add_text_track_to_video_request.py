...
class RequiredVideosTextTracksAddTextTrackToVideoRequest(TypedDict):
...
class OptionalVideosTextTracksAddTextTrackToVideoRequest(TypedDict, total=False):
...
class VideosTextTracksAddTextTrackToVideoRequest(RequiredVideosTextTracksAddTextTrackToVideoRequest, OptionalVideosTextTracksAddTextTrackToVideoRequest):
    pass
