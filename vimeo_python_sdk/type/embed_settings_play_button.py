...
class RequiredEmbedSettingsPlayButton(TypedDict):
...
class OptionalEmbedSettingsPlayButton(TypedDict, total=False):
    pass

class EmbedSettingsPlayButton(RequiredEmbedSettingsPlayButton, OptionalEmbedSettingsPlayButton):
    pass
