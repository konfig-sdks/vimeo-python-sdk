...
from vimeo_python_sdk.type.webinar_essentials_create_webinar_request_email_settings_email_preferences import WebinarEssentialsCreateWebinarRequestEmailSettingsEmailPreferences

RequiredWebinarEssentialsCreateWebinarRequestEmailSettings = TypedDict("RequiredWebinarEssentialsCreateWebinarRequestEmailSettings", {
    })

OptionalWebinarEssentialsCreateWebinarRequestEmailSettings = TypedDict("OptionalWebinarEssentialsCreateWebinarRequestEmailSettings", {
...
class WebinarEssentialsCreateWebinarRequestEmailSettings(RequiredWebinarEssentialsCreateWebinarRequestEmailSettings, OptionalWebinarEssentialsCreateWebinarRequestEmailSettings):
    pass
