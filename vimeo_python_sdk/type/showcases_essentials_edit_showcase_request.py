...
class RequiredShowcasesEssentialsEditShowcaseRequest(TypedDict):
    pass

class OptionalShowcasesEssentialsEditShowcaseRequest(TypedDict, total=False):
...
class ShowcasesEssentialsEditShowcaseRequest(RequiredShowcasesEssentialsEditShowcaseRequest, OptionalShowcasesEssentialsEditShowcaseRequest):
    pass
