...
class RequiredLiveEventRecurringEmbedLogosCustom(TypedDict):
...
class OptionalLiveEventRecurringEmbedLogosCustom(TypedDict, total=False):
    pass

class LiveEventRecurringEmbedLogosCustom(RequiredLiveEventRecurringEmbedLogosCustom, OptionalLiveEventRecurringEmbedLogosCustom):
    pass
