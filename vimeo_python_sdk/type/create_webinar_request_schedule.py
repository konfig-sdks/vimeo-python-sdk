...
from vimeo_python_sdk.type.create_webinar_request_schedule_weekdays import CreateWebinarRequestScheduleWeekdays

class RequiredCreateWebinarRequestSchedule(TypedDict):
    pass

class OptionalCreateWebinarRequestSchedule(TypedDict, total=False):
    ...
    weekdays: CreateWebinarRequestScheduleWeekdays

class CreateWebinarRequestSchedule(RequiredCreateWebinarRequestSchedule, OptionalCreateWebinarRequestSchedule):
    pass
