...
from vimeo_python_sdk.pydantic.live_event_metadata_connections_pre_live_video_options import LiveEventMetadataConnectionsPreLiveVideoOptions

class LiveEventMetadataConnectionsPreLiveVideo(BaseModel):
    options: LiveEventMetadataConnectionsPreLiveVideoOptions = Field(alias='options')
