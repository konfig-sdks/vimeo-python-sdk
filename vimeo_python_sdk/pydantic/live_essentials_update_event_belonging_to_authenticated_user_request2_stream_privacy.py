...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy(BaseModel):
    ...
    view: typing.Optional[Literal["anybody", "embed_only", "nobody", "password", "unlisted"]] = Field(None, alias='view')
    class Config:
