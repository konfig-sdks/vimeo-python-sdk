...
from vimeo_python_sdk.pydantic.update_webinar_request_schedule_weekdays import UpdateWebinarRequestScheduleWeekdays

class UpdateWebinarRequestSchedule(BaseModel):
    ...
    weekdays: typing.Optional[UpdateWebinarRequestScheduleWeekdays] = Field(None, alias='weekdays')
    class Config:
