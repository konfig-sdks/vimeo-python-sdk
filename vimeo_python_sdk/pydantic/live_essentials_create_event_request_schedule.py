...
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_schedule_weekdays import LiveEssentialsCreateEventRequestScheduleWeekdays

class LiveEssentialsCreateEventRequestSchedule(BaseModel):
    ...
    weekdays: typing.Optional[LiveEssentialsCreateEventRequestScheduleWeekdays] = Field(None, alias='weekdays')
    class Config:
