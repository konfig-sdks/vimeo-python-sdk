...
from vimeo_python_sdk.pydantic.disabled_video_properties_embed_reasons import DisabledVideoPropertiesEmbedReasons

class DisabledVideoPropertiesEmbed(BaseModel):
    ...
    reasons: DisabledVideoPropertiesEmbedReasons = Field(alias='reasons')
    class Config:
