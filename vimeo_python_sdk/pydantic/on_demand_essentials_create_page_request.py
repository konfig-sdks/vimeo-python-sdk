...
from vimeo_python_sdk.pydantic.on_demand_essentials_create_page_request_buy import OnDemandEssentialsCreatePageRequestBuy
from vimeo_python_sdk.pydantic.on_demand_essentials_create_page_request_episodes import OnDemandEssentialsCreatePageRequestEpisodes
from vimeo_python_sdk.pydantic.on_demand_essentials_create_page_request_rent import OnDemandEssentialsCreatePageRequestRent
from vimeo_python_sdk.pydantic.on_demand_essentials_create_page_request_subscription import OnDemandEssentialsCreatePageRequestSubscription

class OnDemandEssentialsCreatePageRequest(BaseModel):
    ...
    buy: typing.Optional[OnDemandEssentialsCreatePageRequestBuy] = Field(None, alias='buy')

    # The custom domain of the On Demand page.
    domain_link: typing.Optional[str] = Field(None, alias='domain_link')

    episodes: typing.Optional[OnDemandEssentialsCreatePageRequestEpisodes] = Field(None, alias='episodes')

    # The custom string to use in the Vimeo URL of the On Demand page.
    link: typing.Optional[str] = Field(None, alias='link')

    rent: typing.Optional[OnDemandEssentialsCreatePageRequestRent] = Field(None, alias='rent')

    subscription: typing.Optional[OnDemandEssentialsCreatePageRequestSubscription] = Field(None, alias='subscription')
    class Config:
