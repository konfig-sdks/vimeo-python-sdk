...
from vimeo_python_sdk.pydantic.disabled_video_properties_edit_privacy_reasons import DisabledVideoPropertiesEditPrivacyReasons

class DisabledVideoPropertiesEditPrivacy(BaseModel):
    ...
    reasons: DisabledVideoPropertiesEditPrivacyReasons = Field(alias='reasons')
    class Config:
