...
class EmailCaptureFormCustomFieldsItemConnectedFieldsItem(BaseModel):
    # The ID of the provider field.
    email_service_provider_field_id: str = Field(alias='email_service_provider_field_id')

    # The ID of the field in the form associated with the connected field.
    form_field_id: typing.Union[int, float] = Field(alias='form_field_id')
