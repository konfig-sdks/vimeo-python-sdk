...
from vimeo_python_sdk.pydantic.edit_video_request_spatial_director_timeline import EditVideoRequestSpatialDirectorTimeline

class EditVideoRequestSpatial(BaseModel):
    director_timeline: typing.Optional[EditVideoRequestSpatialDirectorTimeline] = Field(None, alias='director_timeline')
