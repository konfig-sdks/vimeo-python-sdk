...
from vimeo_python_sdk.pydantic.on_demand_essentials_create_page_request_rent_price import OnDemandEssentialsCreatePageRequestRentPrice

class OnDemandEssentialsCreatePageRequestRent(BaseModel):
    ...
    price: typing.Optional[OnDemandEssentialsCreatePageRequestRentPrice] = Field(None, alias='price')
    class Config:
