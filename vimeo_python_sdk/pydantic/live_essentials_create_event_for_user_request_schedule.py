...
from vimeo_python_sdk.pydantic.live_essentials_create_event_for_user_request_schedule_weekdays import LiveEssentialsCreateEventForUserRequestScheduleWeekdays

class LiveEssentialsCreateEventForUserRequestSchedule(BaseModel):
    ...
    weekdays: typing.Optional[LiveEssentialsCreateEventForUserRequestScheduleWeekdays] = Field(None, alias='weekdays')
    class Config:
