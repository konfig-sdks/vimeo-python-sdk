...
from vimeo_python_sdk.pydantic.live_essentials_create_live_event_request_content_rating import LiveEssentialsCreateLiveEventRequestContentRating
from vimeo_python_sdk.pydantic.live_essentials_create_live_event_request_embed import LiveEssentialsCreateLiveEventRequestEmbed
from vimeo_python_sdk.pydantic.live_essentials_create_live_event_request_interaction_tools_settings import LiveEssentialsCreateLiveEventRequestInteractionToolsSettings
from vimeo_python_sdk.pydantic.live_essentials_create_live_event_request_schedule import LiveEssentialsCreateLiveEventRequestSchedule
from vimeo_python_sdk.pydantic.live_essentials_create_live_event_request_stream_embed import LiveEssentialsCreateLiveEventRequestStreamEmbed
from vimeo_python_sdk.pydantic.live_essentials_create_live_event_request_stream_privacy import LiveEssentialsCreateLiveEventRequestStreamPrivacy

class LiveEssentialsCreateLiveEventRequest(BaseModel):
    ...
    content_rating: typing.Optional[LiveEssentialsCreateLiveEventRequestContentRating] = Field(None, alias='content_rating')

    # Whether the DVR feature is enabled.
    dvr: typing.Optional[bool] = Field(None, alias='dvr')

    embed: typing.Optional[LiveEssentialsCreateLiveEventRequestEmbed] = Field(None, alias='embed')

    # The URI of the event's folder.
    folder_uri: typing.Optional[str] = Field(None, alias='folder_uri')

    interaction_tools_settings: typing.Optional[LiveEssentialsCreateLiveEventRequestInteractionToolsSettings] = Field(None, alias='interaction_tools_settings')
    ...
    schedule: typing.Optional[LiveEssentialsCreateLiveEventRequestSchedule] = Field(None, alias='schedule')
    ...
    stream_embed: typing.Optional[LiveEssentialsCreateLiveEventRequestStreamEmbed] = Field(None, alias='stream_embed')
    ...
    stream_privacy: typing.Optional[LiveEssentialsCreateLiveEventRequestStreamPrivacy] = Field(None, alias='stream_privacy')
