...
from vimeo_python_sdk.pydantic.live_event_recurring_album import LiveEventRecurringAlbum
from vimeo_python_sdk.pydantic.live_event_recurring_allowed_privacies import LiveEventRecurringAllowedPrivacies
from vimeo_python_sdk.pydantic.live_event_recurring_content_rating import LiveEventRecurringContentRating
from vimeo_python_sdk.pydantic.live_event_recurring_email_quota import LiveEventRecurringEmailQuota
from vimeo_python_sdk.pydantic.live_event_recurring_embed import LiveEventRecurringEmbed
from vimeo_python_sdk.pydantic.live_event_recurring_interaction_tools_settings import LiveEventRecurringInteractionToolsSettings
from vimeo_python_sdk.pydantic.live_event_recurring_live_clips import LiveEventRecurringLiveClips
from vimeo_python_sdk.pydantic.live_event_recurring_live_destinations import LiveEventRecurringLiveDestinations
from vimeo_python_sdk.pydantic.live_event_recurring_metadata import LiveEventRecurringMetadata
from vimeo_python_sdk.pydantic.live_event_recurring_stream_privacy import LiveEventRecurringStreamPrivacy
from vimeo_python_sdk.pydantic.live_event_recurring_webinar import LiveEventRecurringWebinar
...
class LiveEventRecurring(BaseModel):
    ...
    album: LiveEventRecurringAlbum = Field(alias='album')
    ...
    allowed_privacies: LiveEventRecurringAllowedPrivacies = Field(alias='allowed_privacies')
    ...
    content_rating: LiveEventRecurringContentRating = Field(alias='content_rating')
    ...
    email_quota: LiveEventRecurringEmailQuota = Field(alias='email_quota')

    embed: LiveEventRecurringEmbed = Field(alias='embed')
    ...
    interaction_tools_settings: LiveEventRecurringInteractionToolsSettings = Field(alias='interaction_tools_settings')
    ...
    live_clips: LiveEventRecurringLiveClips = Field(alias='live_clips')

    live_destinations: LiveEventRecurringLiveDestinations = Field(alias='live_destinations')

    # Whether the low-latency feature is enabled.
    low_latency: bool = Field(alias='low_latency')

    metadata: LiveEventRecurringMetadata = Field(alias='metadata')
    ...
    stream_privacy: LiveEventRecurringStreamPrivacy = Field(alias='stream_privacy')
    ...
    webinar: LiveEventRecurringWebinar = Field(alias='webinar')
