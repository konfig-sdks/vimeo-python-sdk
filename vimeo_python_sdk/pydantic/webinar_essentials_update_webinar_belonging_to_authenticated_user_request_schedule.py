...
from vimeo_python_sdk.pydantic.webinar_essentials_update_webinar_belonging_to_authenticated_user_request_schedule_weekdays import WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestScheduleWeekdays

class WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestSchedule(BaseModel):
    ...
    weekdays: typing.Optional[WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestScheduleWeekdays] = Field(None, alias='weekdays')
    class Config:
