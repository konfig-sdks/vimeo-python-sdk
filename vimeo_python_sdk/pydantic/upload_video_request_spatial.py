...
from vimeo_python_sdk.pydantic.upload_video_request_spatial_director_timeline import UploadVideoRequestSpatialDirectorTimeline

class UploadVideoRequestSpatial(BaseModel):
    director_timeline: typing.Optional[UploadVideoRequestSpatialDirectorTimeline] = Field(None, alias='director_timeline')
