...
from vimeo_python_sdk.pydantic.email_capture_form_hidden_fields_item_connected_fields import EmailCaptureFormHiddenFieldsItemConnectedFields
from vimeo_python_sdk.pydantic.email_capture_form_hidden_fields_item_field_metadata import EmailCaptureFormHiddenFieldsItemFieldMetadata

class EmailCaptureFormHiddenFieldsItem(BaseModel):
    connected_fields: EmailCaptureFormHiddenFieldsItemConnectedFields = Field(alias='connected_fields')

    field_metadata: EmailCaptureFormHiddenFieldsItemFieldMetadata = Field(alias='field_metadata')
