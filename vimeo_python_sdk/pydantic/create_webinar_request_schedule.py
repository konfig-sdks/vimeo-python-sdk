...
from vimeo_python_sdk.pydantic.create_webinar_request_schedule_weekdays import CreateWebinarRequestScheduleWeekdays

class CreateWebinarRequestSchedule(BaseModel):
    ...
    weekdays: typing.Optional[CreateWebinarRequestScheduleWeekdays] = Field(None, alias='weekdays')
    class Config:
