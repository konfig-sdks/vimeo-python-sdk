...
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_embed_logos import LiveEssentialsCreateEventRequestEmbedLogos

class LiveEssentialsCreateEventRequestEmbed(BaseModel):
    ...
    logos: typing.Optional[LiveEssentialsCreateEventRequestEmbedLogos] = Field(None, alias='logos')
