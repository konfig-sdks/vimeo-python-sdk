...
class ShowcasesEssentialsEditShowcaseRequest(BaseModel):
    ...
    domain: typing.Optional[typing.Optional[str]] = Field(None, alias='domain')
    ...
    use_custom_domain: typing.Optional[bool] = Field(None, alias='use_custom_domain')
    class Config:
