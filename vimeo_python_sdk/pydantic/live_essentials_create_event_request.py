...
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_content_rating import LiveEssentialsCreateEventRequestContentRating
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_embed import LiveEssentialsCreateEventRequestEmbed
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_interaction_tools_settings import LiveEssentialsCreateEventRequestInteractionToolsSettings
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_schedule import LiveEssentialsCreateEventRequestSchedule
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_stream_embed import LiveEssentialsCreateEventRequestStreamEmbed
from vimeo_python_sdk.pydantic.live_essentials_create_event_request_stream_privacy import LiveEssentialsCreateEventRequestStreamPrivacy

class LiveEssentialsCreateEventRequest(BaseModel):
    ...
    content_rating: typing.Optional[LiveEssentialsCreateEventRequestContentRating] = Field(None, alias='content_rating')

    # Whether the DVR feature is enabled.
    dvr: typing.Optional[bool] = Field(None, alias='dvr')

    embed: typing.Optional[LiveEssentialsCreateEventRequestEmbed] = Field(None, alias='embed')

    # The URI of the event's folder.
    folder_uri: typing.Optional[str] = Field(None, alias='folder_uri')

    interaction_tools_settings: typing.Optional[LiveEssentialsCreateEventRequestInteractionToolsSettings] = Field(None, alias='interaction_tools_settings')
    ...
    schedule: typing.Optional[LiveEssentialsCreateEventRequestSchedule] = Field(None, alias='schedule')
    ...
    stream_embed: typing.Optional[LiveEssentialsCreateEventRequestStreamEmbed] = Field(None, alias='stream_embed')
    ...
    stream_privacy: typing.Optional[LiveEssentialsCreateEventRequestStreamPrivacy] = Field(None, alias='stream_privacy')
