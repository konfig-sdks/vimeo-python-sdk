...
from vimeo_python_sdk.pydantic.live_essentials_create_event_for_user_request_embed_logos import LiveEssentialsCreateEventForUserRequestEmbedLogos

class LiveEssentialsCreateEventForUserRequestEmbed(BaseModel):
    ...
    logos: typing.Optional[LiveEssentialsCreateEventForUserRequestEmbedLogos] = Field(None, alias='logos')
