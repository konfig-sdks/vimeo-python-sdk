...
class UserUploadQuotaSpace(BaseModel):
    # The number of bytes or videos remaining in the authenticated user's upload quota.
    free: typing.Union[int, float] = Field(alias='free')
    ...
    showing: Literal["lifetime", "periodic"] = Field(alias='showing')
    ...
    used: typing.Union[int, float] = Field(alias='used')
    class Config:
