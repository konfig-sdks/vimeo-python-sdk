...
from vimeo_python_sdk.pydantic.disabled_video_properties_duplicate_reasons import DisabledVideoPropertiesDuplicateReasons

class DisabledVideoPropertiesDuplicate(BaseModel):
    ...
    reasons: DisabledVideoPropertiesDuplicateReasons = Field(alias='reasons')
    class Config:
