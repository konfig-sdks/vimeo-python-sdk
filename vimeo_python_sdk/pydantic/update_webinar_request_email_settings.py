...
from vimeo_python_sdk.pydantic.update_webinar_request_email_settings_email_preferences import UpdateWebinarRequestEmailSettingsEmailPreferences

class UpdateWebinarRequestEmailSettings(BaseModel):
    ...
    email_preferences: typing.Optional[UpdateWebinarRequestEmailSettingsEmailPreferences] = Field(None, alias='email_preferences')
