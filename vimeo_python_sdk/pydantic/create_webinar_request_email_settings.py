...
from vimeo_python_sdk.pydantic.create_webinar_request_email_settings_email_preferences import CreateWebinarRequestEmailSettingsEmailPreferences

class CreateWebinarRequestEmailSettings(BaseModel):
    ...
    email_preferences: typing.Optional[CreateWebinarRequestEmailSettingsEmailPreferences] = Field(None, alias='email_preferences')
