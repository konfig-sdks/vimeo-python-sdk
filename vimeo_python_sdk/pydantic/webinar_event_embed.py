...
from vimeo_python_sdk.pydantic.webinar_event_embed_available_player_logos import WebinarEventEmbedAvailablePlayerLogos
from vimeo_python_sdk.pydantic.webinar_event_embed_colors import WebinarEventEmbedColors
from vimeo_python_sdk.pydantic.webinar_event_embed_embed_properties import WebinarEventEmbedEmbedProperties
from vimeo_python_sdk.pydantic.webinar_event_embed_logos import WebinarEventEmbedLogos

class WebinarEventEmbed(BaseModel):
    ...
    available_player_logos: WebinarEventEmbedAvailablePlayerLogos = Field(alias='available_player_logos')
    ...
    colors: WebinarEventEmbedColors = Field(alias='colors')

    # The embed code for RLE chat.
    embed_chat: typing.Optional[str] = Field(alias='embed_chat')

    embed_properties: WebinarEventEmbedEmbedProperties = Field(alias='embed_properties')
    ...
    logos: WebinarEventEmbedLogos = Field(alias='logos')
