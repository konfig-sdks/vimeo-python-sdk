...
from vimeo_python_sdk.pydantic.on_demand_essentials_create_page_request_episodes_rent_price import OnDemandEssentialsCreatePageRequestEpisodesRentPrice

class OnDemandEssentialsCreatePageRequestEpisodesRent(BaseModel):
    ...
    price: typing.Optional[OnDemandEssentialsCreatePageRequestEpisodesRentPrice] = Field(None, alias='price')
    class Config:
