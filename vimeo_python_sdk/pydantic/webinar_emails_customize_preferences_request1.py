...
from vimeo_python_sdk.pydantic.webinar_emails_customize_preferences_request1_email_preferences import WebinarEmailsCustomizePreferencesRequest1EmailPreferences

class WebinarEmailsCustomizePreferencesRequest1(BaseModel):
    ...
    email_preferences: typing.Optional[WebinarEmailsCustomizePreferencesRequest1EmailPreferences] = Field(None, alias='email_preferences')
