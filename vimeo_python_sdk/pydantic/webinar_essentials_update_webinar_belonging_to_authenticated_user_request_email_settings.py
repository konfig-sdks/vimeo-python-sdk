...
from vimeo_python_sdk.pydantic.webinar_essentials_update_webinar_belonging_to_authenticated_user_request_email_settings_email_preferences import WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences

class WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettings(BaseModel):
    ...
    email_preferences: typing.Optional[WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences] = Field(None, alias='email_preferences')
