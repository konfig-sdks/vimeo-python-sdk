...
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request_embed_logos import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestEmbedLogos

class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestEmbed(BaseModel):
    ...
    logos: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestEmbedLogos] = Field(None, alias='logos')
