...
from vimeo_python_sdk.pydantic.live_event_album import LiveEventAlbum
from vimeo_python_sdk.pydantic.live_event_allowed_privacies import LiveEventAllowedPrivacies
from vimeo_python_sdk.pydantic.live_event_content_rating import LiveEventContentRating
from vimeo_python_sdk.pydantic.live_event_email_quota import LiveEventEmailQuota
from vimeo_python_sdk.pydantic.live_event_embed import LiveEventEmbed
from vimeo_python_sdk.pydantic.live_event_interaction_tools_settings import LiveEventInteractionToolsSettings
from vimeo_python_sdk.pydantic.live_event_live_clips import LiveEventLiveClips
from vimeo_python_sdk.pydantic.live_event_live_destinations import LiveEventLiveDestinations
from vimeo_python_sdk.pydantic.live_event_metadata import LiveEventMetadata
from vimeo_python_sdk.pydantic.live_event_schedule import LiveEventSchedule
from vimeo_python_sdk.pydantic.live_event_stream_privacy import LiveEventStreamPrivacy
from vimeo_python_sdk.pydantic.live_event_webinar import LiveEventWebinar
...
class LiveEvent(BaseModel):
    ...
    album: LiveEventAlbum = Field(alias='album')
    ...
    allowed_privacies: LiveEventAllowedPrivacies = Field(alias='allowed_privacies')
    ...
    content_rating: LiveEventContentRating = Field(alias='content_rating')
    ...
    email_quota: LiveEventEmailQuota = Field(alias='email_quota')

    embed: LiveEventEmbed = Field(alias='embed')
    ...
    interaction_tools_settings: LiveEventInteractionToolsSettings = Field(alias='interaction_tools_settings')
    ...
    live_clips: LiveEventLiveClips = Field(alias='live_clips')

    live_destinations: LiveEventLiveDestinations = Field(alias='live_destinations')

    # Whether the low-latency feature is enabled.
    low_latency: bool = Field(alias='low_latency')

    metadata: LiveEventMetadata = Field(alias='metadata')
    ...
    stream_privacy: LiveEventStreamPrivacy = Field(alias='stream_privacy')
    ...
    webinar: LiveEventWebinar = Field(alias='webinar')
