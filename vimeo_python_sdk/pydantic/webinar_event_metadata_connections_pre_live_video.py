...
from vimeo_python_sdk.pydantic.webinar_event_metadata_connections_pre_live_video_options import WebinarEventMetadataConnectionsPreLiveVideoOptions

class WebinarEventMetadataConnectionsPreLiveVideo(BaseModel):
    options: WebinarEventMetadataConnectionsPreLiveVideoOptions = Field(alias='options')
