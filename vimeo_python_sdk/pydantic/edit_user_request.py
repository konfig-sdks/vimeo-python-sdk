...
from vimeo_python_sdk.pydantic.edit_user_request_content_filter import EditUserRequestContentFilter
from vimeo_python_sdk.pydantic.edit_user_request_videos import EditUserRequestVideos

class EditUserRequest(BaseModel):
    # The user's bio.
    bio: typing.Optional[str] = Field(None, alias='bio')

    content_filter: typing.Optional[EditUserRequestContentFilter] = Field(None, alias='content_filter')
    ...
    videos: typing.Optional[EditUserRequestVideos] = Field(None, alias='videos')
    class Config:
