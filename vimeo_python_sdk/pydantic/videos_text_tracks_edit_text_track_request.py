...
class VideosTextTracksEditTextTrackRequest(BaseModel):
    ...
    type: typing.Optional[Literal["captions", "chapters", "descriptions", "metadata", "subtitles"]] = Field(None, alias='type')
    class Config:
