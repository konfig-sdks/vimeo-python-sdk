...
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request2_embed_logos import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2EmbedLogos

class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Embed(BaseModel):
    ...
    logos: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2EmbedLogos] = Field(None, alias='logos')
