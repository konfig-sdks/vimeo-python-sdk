...
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request1_content_rating import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request1_embed import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request1_interaction_tools_settings import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1InteractionToolsSettings
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request1_schedule import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request1_stream_embed import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamEmbed
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request1_stream_privacy import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy

class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1(BaseModel):
    ...
    content_rating: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating] = Field(None, alias='content_rating')

    # Whether the DVR feature is enabled.
    dvr: typing.Optional[bool] = Field(None, alias='dvr')

    embed: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed] = Field(None, alias='embed')

    interaction_tools_settings: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1InteractionToolsSettings] = Field(None, alias='interaction_tools_settings')
    ...
    schedule: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule] = Field(None, alias='schedule')
    ...
    stream_embed: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamEmbed] = Field(None, alias='stream_embed')
    ...
    stream_privacy: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy] = Field(None, alias='stream_privacy')
