...
from vimeo_python_sdk.pydantic.disabled_video_properties_embed_presets_reasons import DisabledVideoPropertiesEmbedPresetsReasons

class DisabledVideoPropertiesEmbedPresets(BaseModel):
    ...
    reasons: DisabledVideoPropertiesEmbedPresetsReasons = Field(alias='reasons')
    class Config:
