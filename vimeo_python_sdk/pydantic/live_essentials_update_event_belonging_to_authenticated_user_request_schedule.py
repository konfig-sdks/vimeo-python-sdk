...
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request_schedule_weekdays import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestScheduleWeekdays

class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestSchedule(BaseModel):
    ...
    weekdays: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestScheduleWeekdays] = Field(None, alias='weekdays')
    class Config:
