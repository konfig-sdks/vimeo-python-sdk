...
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request2_content_rating import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2ContentRating
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request2_embed import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Embed
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request2_interaction_tools_settings import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2InteractionToolsSettings
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request2_schedule import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Schedule
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request2_stream_embed import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamEmbed
from vimeo_python_sdk.pydantic.live_essentials_update_event_belonging_to_authenticated_user_request2_stream_privacy import LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy

class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2(BaseModel):
    ...
    content_rating: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2ContentRating] = Field(None, alias='content_rating')

    # Whether the DVR feature is enabled.
    dvr: typing.Optional[bool] = Field(None, alias='dvr')

    embed: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Embed] = Field(None, alias='embed')

    interaction_tools_settings: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2InteractionToolsSettings] = Field(None, alias='interaction_tools_settings')
    ...
    schedule: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2Schedule] = Field(None, alias='schedule')
    ...
    stream_embed: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamEmbed] = Field(None, alias='stream_embed')
    ...
    stream_privacy: typing.Optional[LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2StreamPrivacy] = Field(None, alias='stream_privacy')
