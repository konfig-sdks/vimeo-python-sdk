...
from vimeo_python_sdk.pydantic.create_vod_request_buy_price import CreateVodRequestBuyPrice

class CreateVodRequestBuy(BaseModel):
    ...
    price: typing.Optional[CreateVodRequestBuyPrice] = Field(None, alias='price')
    class Config:
