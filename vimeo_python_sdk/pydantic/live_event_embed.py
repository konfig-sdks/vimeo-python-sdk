...
from vimeo_python_sdk.pydantic.live_event_embed_available_player_logos import LiveEventEmbedAvailablePlayerLogos
from vimeo_python_sdk.pydantic.live_event_embed_colors import LiveEventEmbedColors
from vimeo_python_sdk.pydantic.live_event_embed_embed_properties import LiveEventEmbedEmbedProperties
from vimeo_python_sdk.pydantic.live_event_embed_logos import LiveEventEmbedLogos

class LiveEventEmbed(BaseModel):
    ...
    available_player_logos: LiveEventEmbedAvailablePlayerLogos = Field(alias='available_player_logos')
    ...
    colors: LiveEventEmbedColors = Field(alias='colors')

    # The embed code for RLE chat.
    embed_chat: typing.Optional[str] = Field(alias='embed_chat')

    embed_properties: LiveEventEmbedEmbedProperties = Field(alias='embed_properties')
    ...
    logos: LiveEventEmbedLogos = Field(alias='logos')
