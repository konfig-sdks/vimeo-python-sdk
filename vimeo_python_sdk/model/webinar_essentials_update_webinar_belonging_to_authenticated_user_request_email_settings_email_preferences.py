...
class WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences(
    schemas.DictSchema
):
    """
    ...
    ) -> 'WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestEmailSettingsEmailPreferences':
