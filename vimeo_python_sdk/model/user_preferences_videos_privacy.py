...
class UserPreferencesVideosPrivacy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["add", "comments", "download", "embed", "password", "view", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["add", "comments", "download", "embed", "password", "view", ], str]):
