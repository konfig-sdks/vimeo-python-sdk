...
class UserMetadataConnectionsShared(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['UserMetadataConnectionsSharedOptions']:
                return UserMetadataConnectionsSharedOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsSharedOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsSharedOptions': ...
