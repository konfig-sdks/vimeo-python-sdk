...
class ProjectMetadataConnectionsItems(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['ProjectMetadataConnectionsItemsOptions']:
                return ProjectMetadataConnectionsItemsOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'ProjectMetadataConnectionsItemsOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'ProjectMetadataConnectionsItemsOptions': ...
