...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestScheduleWeekdays(
    schemas.ListSchema
):
    """NOTE:
    ...
    ) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestScheduleWeekdays':
