...
class LiveEventRecurringEmbedEmbedProperties(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["height", "source_url", "width", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["height", "source_url", "width", ], str]):
    ...
    ) -> 'LiveEventRecurringEmbedEmbedProperties':
