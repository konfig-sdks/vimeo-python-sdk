...
class VideoUploader(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["link", "name", "pictures", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["link", "name", "pictures", ], str]):
