...
class VideoMetadataConnectionsPictures(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['VideoMetadataConnectionsPicturesOptions']:
                return VideoMetadataConnectionsPicturesOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataConnectionsPicturesOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataConnectionsPicturesOptions': ...
