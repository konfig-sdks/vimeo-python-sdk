...
class CategoryMetadataConnectionsChannels(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['CategoryMetadataConnectionsChannelsOptions']:
                return CategoryMetadataConnectionsChannelsOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'CategoryMetadataConnectionsChannelsOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'CategoryMetadataConnectionsChannelsOptions': ...
