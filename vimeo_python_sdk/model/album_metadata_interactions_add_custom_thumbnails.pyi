...
class AlbumMetadataInteractionsAddCustomThumbnails(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['AlbumMetadataInteractionsAddCustomThumbnailsOptions']:
                return AlbumMetadataInteractionsAddCustomThumbnailsOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'AlbumMetadataInteractionsAddCustomThumbnailsOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'AlbumMetadataInteractionsAddCustomThumbnailsOptions': ...
