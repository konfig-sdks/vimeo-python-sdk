...
class ChannelMetadataConnectionsUsers(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['ChannelMetadataConnectionsUsersOptions']:
                return ChannelMetadataConnectionsUsersOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'ChannelMetadataConnectionsUsersOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'ChannelMetadataConnectionsUsersOptions': ...
