...
class VideoMetadataInteractionsWatched(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['VideoMetadataInteractionsWatchedOptions']:
                return VideoMetadataInteractionsWatchedOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataInteractionsWatchedOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataInteractionsWatchedOptions': ...
