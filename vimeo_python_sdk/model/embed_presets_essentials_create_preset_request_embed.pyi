...
class EmbedPresetsEssentialsCreatePresetRequestEmbed(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def title() -> typing.Type['EmbedPresetsEssentialsCreatePresetRequestEmbedTitle']:
                return EmbedPresetsEssentialsCreatePresetRequestEmbedTitle
            airplay = schemas.BoolSchema
            audio_tracks = schemas.BoolSchema
        
            @staticmethod
            def buttons() -> typing.Type['EmbedPresetsEssentialsCreatePresetRequestEmbedButtons']:
                return EmbedPresetsEssentialsCreatePresetRequestEmbedButtons
            ...
            @staticmethod
            def colors() -> typing.Type['EmbedPresetsEssentialsCreatePresetRequestEmbedColors']:
                return EmbedPresetsEssentialsCreatePresetRequestEmbedColors
        
            @staticmethod
            def logos() -> typing.Type['EmbedPresetsEssentialsCreatePresetRequestEmbedLogos']:
                return EmbedPresetsEssentialsCreatePresetRequestEmbedLogos
        
            @staticmethod
            def play_button() -> typing.Type['EmbedPresetsEssentialsCreatePresetRequestEmbedPlayButton']:
                return EmbedPresetsEssentialsCreatePresetRequestEmbedPlayButton
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["title"]) -> 'EmbedPresetsEssentialsCreatePresetRequestEmbedTitle': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["buttons"]) -> 'EmbedPresetsEssentialsCreatePresetRequestEmbedButtons': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["colors"]) -> 'EmbedPresetsEssentialsCreatePresetRequestEmbedColors': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["logos"]) -> 'EmbedPresetsEssentialsCreatePresetRequestEmbedLogos': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["play_button"]) -> 'EmbedPresetsEssentialsCreatePresetRequestEmbedPlayButton': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["title"]) -> typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedTitle', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["buttons"]) -> typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedButtons', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["colors"]) -> typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedColors', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["logos"]) -> typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedLogos', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["play_button"]) -> typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedPlayButton', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        title: typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedTitle', schemas.Unset] = schemas.unset,
        ...
        buttons: typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedButtons', schemas.Unset] = schemas.unset,
        ...
        colors: typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedColors', schemas.Unset] = schemas.unset,
        logos: typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedLogos', schemas.Unset] = schemas.unset,
        play_button: typing.Union['EmbedPresetsEssentialsCreatePresetRequestEmbedPlayButton', schemas.Unset] = schemas.unset,
