...
class UserMetadataInteractionsBlock(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['UserMetadataInteractionsBlockOptions']:
                return UserMetadataInteractionsBlockOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataInteractionsBlockOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataInteractionsBlockOptions': ...
