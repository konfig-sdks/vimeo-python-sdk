...
class ChannelMetadataInteractionsFollow(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["added", "added_time", "type", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["added", "added_time", "type", "uri", ], str]):
