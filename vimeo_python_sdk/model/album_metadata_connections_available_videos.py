...
class AlbumMetadataConnectionsAvailableVideos(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['AlbumMetadataConnectionsAvailableVideosOptions']:
                return AlbumMetadataConnectionsAvailableVideosOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'AlbumMetadataConnectionsAvailableVideosOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'AlbumMetadataConnectionsAvailableVideosOptions': ...
