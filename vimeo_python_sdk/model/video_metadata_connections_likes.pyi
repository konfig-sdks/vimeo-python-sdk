...
class VideoMetadataConnectionsLikes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['VideoMetadataConnectionsLikesOptions']:
                return VideoMetadataConnectionsLikesOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataConnectionsLikesOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataConnectionsLikesOptions': ...
