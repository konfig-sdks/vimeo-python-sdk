...
class WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestScheduleWeekdays(
    schemas.ListSchema
):
    """NOTE:
    ...
    ) -> 'WebinarEssentialsUpdateWebinarBelongingToAuthenticatedUserRequestScheduleWeekdays':
