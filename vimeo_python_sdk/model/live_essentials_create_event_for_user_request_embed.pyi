...
class LiveEssentialsCreateEventForUserRequestEmbed(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def logos() -> typing.Type['LiveEssentialsCreateEventForUserRequestEmbedLogos']:
                return LiveEssentialsCreateEventForUserRequestEmbedLogos
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["logos"]) -> 'LiveEssentialsCreateEventForUserRequestEmbedLogos': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["autoplay", "color", "logos", "loop", "playlist", "schedule", "show_latest_archived_clip", "use_color", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["logos"]) -> typing.Union['LiveEssentialsCreateEventForUserRequestEmbedLogos', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["show_latest_archived_clip"]) -> typing.Union[MetaOapg.properties.show_latest_archived_clip, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["autoplay", "color", "logos", "loop", "playlist", "schedule", "show_latest_archived_clip", "use_color", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        logos: typing.Union['LiveEssentialsCreateEventForUserRequestEmbedLogos', schemas.Unset] = schemas.unset,
        ...
        show_latest_archived_clip: typing.Union[MetaOapg.properties.show_latest_archived_clip, bool, schemas.Unset] = schemas.unset,
