...
class DisabledVideoPropertiesEmbed(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def reasons() -> typing.Type['DisabledVideoPropertiesEmbedReasons']:
                return DisabledVideoPropertiesEmbedReasons
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reasons"]) -> 'DisabledVideoPropertiesEmbedReasons': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reasons"]) -> 'DisabledVideoPropertiesEmbedReasons': ...
