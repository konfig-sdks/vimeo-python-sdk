...
class AlbumPrivacy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["view", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["view", "password", ], str]):
