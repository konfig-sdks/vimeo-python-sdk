...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2ScheduleWeekdays(
    schemas.ListSchema
):
    """NOTE:
    ...
    ) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest2ScheduleWeekdays':
