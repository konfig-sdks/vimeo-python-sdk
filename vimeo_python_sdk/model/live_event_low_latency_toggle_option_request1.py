...
class LiveEventLowLatencyToggleOptionRequest1(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["low_latency", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["low_latency", ], str]):
