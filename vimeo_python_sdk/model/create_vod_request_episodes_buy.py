...
class CreateVodRequestEpisodesBuy(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def price() -> typing.Type['CreateVodRequestEpisodesBuyPrice']:
                return CreateVodRequestEpisodesBuyPrice
            __annotations__ = {
                "active": active,
                "download": download,
                "price": price,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price"]) -> 'CreateVodRequestEpisodesBuyPrice': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price"]) -> typing.Union['CreateVodRequestEpisodesBuyPrice', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        price: typing.Union['CreateVodRequestEpisodesBuyPrice', schemas.Unset] = schemas.unset,
