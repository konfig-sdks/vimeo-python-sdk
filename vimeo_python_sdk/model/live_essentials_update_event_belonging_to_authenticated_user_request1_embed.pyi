...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def logos() -> typing.Type['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1EmbedLogos']:
                return LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1EmbedLogos
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["logos"]) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1EmbedLogos': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["logos"]) -> typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1EmbedLogos', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        logos: typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1EmbedLogos', schemas.Unset] = schemas.unset,
