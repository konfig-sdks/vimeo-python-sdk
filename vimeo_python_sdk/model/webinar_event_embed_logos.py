...
class WebinarEventEmbedLogos(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def custom() -> typing.Type['WebinarEventEmbedLogosCustom']:
                return WebinarEventEmbedLogosCustom
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["custom"]) -> 'WebinarEventEmbedLogosCustom': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["custom"]) -> 'WebinarEventEmbedLogosCustom': ...
