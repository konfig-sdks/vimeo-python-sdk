...
class ChannelMetadataConnectionsVideos(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['ChannelMetadataConnectionsVideosOptions']:
                return ChannelMetadataConnectionsVideosOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'ChannelMetadataConnectionsVideosOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'ChannelMetadataConnectionsVideosOptions': ...
