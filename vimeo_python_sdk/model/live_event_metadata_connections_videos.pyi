...
class LiveEventMetadataConnectionsVideos(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['LiveEventMetadataConnectionsVideosOptions']:
                return LiveEventMetadataConnectionsVideosOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'LiveEventMetadataConnectionsVideosOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'LiveEventMetadataConnectionsVideosOptions': ...
