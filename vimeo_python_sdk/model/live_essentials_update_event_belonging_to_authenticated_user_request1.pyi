...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def content_rating() -> typing.Type['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating']:
                return LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating
            dvr = schemas.BoolSchema
        
            @staticmethod
            def embed() -> typing.Type['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed']:
                return LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed
        
            @staticmethod
            def interaction_tools_settings() -> typing.Type['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1InteractionToolsSettings']:
                return LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1InteractionToolsSettings
            ...
            @staticmethod
            def schedule() -> typing.Type['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule']:
                return LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule
            scheduled_playback = schemas.BoolSchema
            stream_description = schemas.StrSchema
        
            @staticmethod
            def stream_embed() -> typing.Type['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamEmbed']:
                return LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamEmbed
            ...
            @staticmethod
            def stream_privacy() -> typing.Type['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy']:
                return LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["content_rating"]) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dvr"]) -> MetaOapg.properties.dvr: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["embed"]) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interaction_tools_settings"]) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1InteractionToolsSettings': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["playlist_sort"]) -> MetaOapg.properties.playlist_sort: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schedule"]) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_embed"]) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamEmbed': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_privacy"]) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["content_rating"]) -> typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dvr"]) -> typing.Union[MetaOapg.properties.dvr, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["embed"]) -> typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interaction_tools_settings"]) -> typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1InteractionToolsSettings', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["schedule"]) -> typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stream_embed"]) -> typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamEmbed', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stream_privacy"]) -> typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        content_rating: typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating', schemas.Unset] = schemas.unset,
        dvr: typing.Union[MetaOapg.properties.dvr, bool, schemas.Unset] = schemas.unset,
        embed: typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Embed', schemas.Unset] = schemas.unset,
        interaction_tools_settings: typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1InteractionToolsSettings', schemas.Unset] = schemas.unset,
        playlist_sort: typing.Union[MetaOapg.properties.playlist_sort, str, schemas.Unset] = schemas.unset,
        schedule: typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1Schedule', schemas.Unset] = schemas.unset,
        ...
        stream_embed: typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamEmbed', schemas.Unset] = schemas.unset,
        ...
        stream_privacy: typing.Union['LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1StreamPrivacy', schemas.Unset] = schemas.unset,
