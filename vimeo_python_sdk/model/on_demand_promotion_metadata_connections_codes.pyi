...
class OnDemandPromotionMetadataConnectionsCodes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['OnDemandPromotionMetadataConnectionsCodesOptions']:
                return OnDemandPromotionMetadataConnectionsCodesOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'OnDemandPromotionMetadataConnectionsCodesOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'OnDemandPromotionMetadataConnectionsCodesOptions': ...
