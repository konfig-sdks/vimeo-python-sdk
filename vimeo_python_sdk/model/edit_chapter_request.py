...
class EditChapterRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "active_thumbnail_uri", "timecode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "active_thumbnail_uri", "timecode", ], str]):
