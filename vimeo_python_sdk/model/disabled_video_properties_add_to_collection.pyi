...
class DisabledVideoPropertiesAddToCollection(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def reasons() -> typing.Type['DisabledVideoPropertiesAddToCollectionReasons']:
                return DisabledVideoPropertiesAddToCollectionReasons
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reasons"]) -> 'DisabledVideoPropertiesAddToCollectionReasons': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enable_link", "min_tier_for_capability", "reasons", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reasons"]) -> 'DisabledVideoPropertiesAddToCollectionReasons': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enable_link", "min_tier_for_capability", "reasons", ], str]):
