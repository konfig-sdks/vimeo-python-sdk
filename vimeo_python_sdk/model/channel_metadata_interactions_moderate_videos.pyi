...
class ChannelMetadataInteractionsModerateVideos(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['ChannelMetadataInteractionsModerateVideosOptions']:
                return ChannelMetadataInteractionsModerateVideosOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'ChannelMetadataInteractionsModerateVideosOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'ChannelMetadataInteractionsModerateVideosOptions': ...
