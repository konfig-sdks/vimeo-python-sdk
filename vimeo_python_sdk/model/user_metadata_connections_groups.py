...
class UserMetadataConnectionsGroups(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['UserMetadataConnectionsGroupsOptions']:
                return UserMetadataConnectionsGroupsOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsGroupsOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsGroupsOptions': ...
