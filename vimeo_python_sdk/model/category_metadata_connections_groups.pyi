...
class CategoryMetadataConnectionsGroups(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['CategoryMetadataConnectionsGroupsOptions']:
                return CategoryMetadataConnectionsGroupsOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'CategoryMetadataConnectionsGroupsOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'CategoryMetadataConnectionsGroupsOptions': ...
