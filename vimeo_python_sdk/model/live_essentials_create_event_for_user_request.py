...
class LiveEssentialsCreateEventForUserRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def content_rating() -> typing.Type['LiveEssentialsCreateEventForUserRequestContentRating']:
                return LiveEssentialsCreateEventForUserRequestContentRating
            dvr = schemas.BoolSchema
        
            @staticmethod
            def embed() -> typing.Type['LiveEssentialsCreateEventForUserRequestEmbed']:
                return LiveEssentialsCreateEventForUserRequestEmbed
            folder_uri = schemas.StrSchema
        
            @staticmethod
            def interaction_tools_settings() -> typing.Type['LiveEssentialsCreateEventForUserRequestInteractionToolsSettings']:
                return LiveEssentialsCreateEventForUserRequestInteractionToolsSettings
            ...
            @staticmethod
            def schedule() -> typing.Type['LiveEssentialsCreateEventForUserRequestSchedule']:
                return LiveEssentialsCreateEventForUserRequestSchedule
            scheduled_playback = schemas.BoolSchema
            stream_description = schemas.StrSchema
        
            @staticmethod
            def stream_embed() -> typing.Type['LiveEssentialsCreateEventForUserRequestStreamEmbed']:
                return LiveEssentialsCreateEventForUserRequestStreamEmbed
            stream_password = schemas.StrSchema
        
            @staticmethod
            def stream_privacy() -> typing.Type['LiveEssentialsCreateEventForUserRequestStreamPrivacy']:
                return LiveEssentialsCreateEventForUserRequestStreamPrivacy
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["content_rating"]) -> 'LiveEssentialsCreateEventForUserRequestContentRating': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dvr"]) -> MetaOapg.properties.dvr: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["embed"]) -> 'LiveEssentialsCreateEventForUserRequestEmbed': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["folder_uri"]) -> MetaOapg.properties.folder_uri: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interaction_tools_settings"]) -> 'LiveEssentialsCreateEventForUserRequestInteractionToolsSettings': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schedule"]) -> 'LiveEssentialsCreateEventForUserRequestSchedule': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_embed"]) -> 'LiveEssentialsCreateEventForUserRequestStreamEmbed': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_password"]) -> MetaOapg.properties.stream_password: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_privacy"]) -> 'LiveEssentialsCreateEventForUserRequestStreamPrivacy': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["content_rating"]) -> typing.Union['LiveEssentialsCreateEventForUserRequestContentRating', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dvr"]) -> typing.Union[MetaOapg.properties.dvr, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["embed"]) -> typing.Union['LiveEssentialsCreateEventForUserRequestEmbed', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interaction_tools_settings"]) -> typing.Union['LiveEssentialsCreateEventForUserRequestInteractionToolsSettings', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["schedule"]) -> typing.Union['LiveEssentialsCreateEventForUserRequestSchedule', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stream_embed"]) -> typing.Union['LiveEssentialsCreateEventForUserRequestStreamEmbed', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stream_privacy"]) -> typing.Union['LiveEssentialsCreateEventForUserRequestStreamPrivacy', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        content_rating: typing.Union['LiveEssentialsCreateEventForUserRequestContentRating', schemas.Unset] = schemas.unset,
        dvr: typing.Union[MetaOapg.properties.dvr, bool, schemas.Unset] = schemas.unset,
        embed: typing.Union['LiveEssentialsCreateEventForUserRequestEmbed', schemas.Unset] = schemas.unset,
        folder_uri: typing.Union[MetaOapg.properties.folder_uri, str, schemas.Unset] = schemas.unset,
        interaction_tools_settings: typing.Union['LiveEssentialsCreateEventForUserRequestInteractionToolsSettings', schemas.Unset] = schemas.unset,
        ...
        schedule: typing.Union['LiveEssentialsCreateEventForUserRequestSchedule', schemas.Unset] = schemas.unset,
        ...
        stream_embed: typing.Union['LiveEssentialsCreateEventForUserRequestStreamEmbed', schemas.Unset] = schemas.unset,
        stream_password: typing.Union[MetaOapg.properties.stream_password, str, schemas.Unset] = schemas.unset,
        stream_privacy: typing.Union['LiveEssentialsCreateEventForUserRequestStreamPrivacy', schemas.Unset] = schemas.unset,
