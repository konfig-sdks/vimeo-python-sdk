...
class UserMetadataConnectionsFolders(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['UserMetadataConnectionsFoldersOptions']:
                return UserMetadataConnectionsFoldersOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsFoldersOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsFoldersOptions': ...
