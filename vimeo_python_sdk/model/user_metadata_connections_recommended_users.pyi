...
class UserMetadataConnectionsRecommendedUsers(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['UserMetadataConnectionsRecommendedUsersOptions']:
                return UserMetadataConnectionsRecommendedUsersOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsRecommendedUsersOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsRecommendedUsersOptions': ...
