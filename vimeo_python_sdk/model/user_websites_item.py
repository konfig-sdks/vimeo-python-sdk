...
class UserWebsitesItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "link", "name", "type", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "link", "name", "type", "uri", ], str]):
