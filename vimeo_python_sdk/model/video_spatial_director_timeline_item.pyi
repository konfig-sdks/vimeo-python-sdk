...
class VideoSpatialDirectorTimelineItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pitch", "roll", "time_code", "yaw", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["time_code"]) -> typing.Union[MetaOapg.properties.time_code, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["yaw"]) -> typing.Union[MetaOapg.properties.yaw, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pitch", "roll", "time_code", "yaw", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        time_code: typing.Union[MetaOapg.properties.time_code, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        yaw: typing.Union[MetaOapg.properties.yaw, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'VideoSpatialDirectorTimelineItem':
