...
class CommentMetadataConnectionsReplies(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['CommentMetadataConnectionsRepliesOptions']:
                return CommentMetadataConnectionsRepliesOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'CommentMetadataConnectionsRepliesOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'CommentMetadataConnectionsRepliesOptions': ...
