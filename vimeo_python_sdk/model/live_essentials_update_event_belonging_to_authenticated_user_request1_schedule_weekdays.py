...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ScheduleWeekdays(
    schemas.ListSchema
):
    """NOTE:
    ...
    ) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ScheduleWeekdays':
