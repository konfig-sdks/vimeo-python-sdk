...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestContentRating(
    schemas.ListSchema
):
    """NOTE:
    ...
    ) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequestContentRating':
