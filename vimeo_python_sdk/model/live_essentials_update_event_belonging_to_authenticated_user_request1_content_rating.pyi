...
class LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating(
    schemas.ListSchema
):
    """NOTE:
    ...
    ) -> 'LiveEssentialsUpdateEventBelongingToAuthenticatedUserRequest1ContentRating':
