...
class VideoMetadataConnectionsAvailableChannels(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['VideoMetadataConnectionsAvailableChannelsOptions']:
                return VideoMetadataConnectionsAvailableChannelsOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataConnectionsAvailableChannelsOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'VideoMetadataConnectionsAvailableChannelsOptions': ...
