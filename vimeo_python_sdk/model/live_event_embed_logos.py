...
class LiveEventEmbedLogos(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def custom() -> typing.Type['LiveEventEmbedLogosCustom']:
                return LiveEventEmbedLogosCustom
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["custom"]) -> 'LiveEventEmbedLogosCustom': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["custom"]) -> 'LiveEventEmbedLogosCustom': ...
