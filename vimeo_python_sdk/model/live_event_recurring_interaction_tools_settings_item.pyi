...
class LiveEventRecurringInteractionToolsSettingsItem(
    schemas.DictSchema
):
    """
    ...
    is_qna_moderated: MetaOapg.properties.is_qna_moderated
    is_anonymous_questions_disabled: MetaOapg.properties.is_anonymous_questions_disabled
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_anonymous_questions_disabled"]) -> MetaOapg.properties.is_anonymous_questions_disabled: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_qna_moderated"]) -> MetaOapg.properties.is_qna_moderated: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        is_qna_moderated: typing.Union[MetaOapg.properties.is_qna_moderated, bool, ],
        is_anonymous_questions_disabled: typing.Union[MetaOapg.properties.is_anonymous_questions_disabled, bool, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LiveEventRecurringInteractionToolsSettingsItem':
