...
class LiveEssentialsCreateLiveEventRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def content_rating() -> typing.Type['LiveEssentialsCreateLiveEventRequestContentRating']:
                return LiveEssentialsCreateLiveEventRequestContentRating
            dvr = schemas.BoolSchema
        
            @staticmethod
            def embed() -> typing.Type['LiveEssentialsCreateLiveEventRequestEmbed']:
                return LiveEssentialsCreateLiveEventRequestEmbed
            folder_uri = schemas.StrSchema
        
            @staticmethod
            def interaction_tools_settings() -> typing.Type['LiveEssentialsCreateLiveEventRequestInteractionToolsSettings']:
                return LiveEssentialsCreateLiveEventRequestInteractionToolsSettings
            ...
            @staticmethod
            def schedule() -> typing.Type['LiveEssentialsCreateLiveEventRequestSchedule']:
                return LiveEssentialsCreateLiveEventRequestSchedule
            scheduled_playback = schemas.BoolSchema
            stream_description = schemas.StrSchema
        
            @staticmethod
            def stream_embed() -> typing.Type['LiveEssentialsCreateLiveEventRequestStreamEmbed']:
                return LiveEssentialsCreateLiveEventRequestStreamEmbed
            stream_password = schemas.StrSchema
        
            @staticmethod
            def stream_privacy() -> typing.Type['LiveEssentialsCreateLiveEventRequestStreamPrivacy']:
                return LiveEssentialsCreateLiveEventRequestStreamPrivacy
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["content_rating"]) -> 'LiveEssentialsCreateLiveEventRequestContentRating': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dvr"]) -> MetaOapg.properties.dvr: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["embed"]) -> 'LiveEssentialsCreateLiveEventRequestEmbed': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["folder_uri"]) -> MetaOapg.properties.folder_uri: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["interaction_tools_settings"]) -> 'LiveEssentialsCreateLiveEventRequestInteractionToolsSettings': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schedule"]) -> 'LiveEssentialsCreateLiveEventRequestSchedule': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_embed"]) -> 'LiveEssentialsCreateLiveEventRequestStreamEmbed': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_password"]) -> MetaOapg.properties.stream_password: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["stream_privacy"]) -> 'LiveEssentialsCreateLiveEventRequestStreamPrivacy': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["content_rating"]) -> typing.Union['LiveEssentialsCreateLiveEventRequestContentRating', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dvr"]) -> typing.Union[MetaOapg.properties.dvr, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["embed"]) -> typing.Union['LiveEssentialsCreateLiveEventRequestEmbed', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["interaction_tools_settings"]) -> typing.Union['LiveEssentialsCreateLiveEventRequestInteractionToolsSettings', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["schedule"]) -> typing.Union['LiveEssentialsCreateLiveEventRequestSchedule', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stream_embed"]) -> typing.Union['LiveEssentialsCreateLiveEventRequestStreamEmbed', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stream_privacy"]) -> typing.Union['LiveEssentialsCreateLiveEventRequestStreamPrivacy', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        content_rating: typing.Union['LiveEssentialsCreateLiveEventRequestContentRating', schemas.Unset] = schemas.unset,
        dvr: typing.Union[MetaOapg.properties.dvr, bool, schemas.Unset] = schemas.unset,
        embed: typing.Union['LiveEssentialsCreateLiveEventRequestEmbed', schemas.Unset] = schemas.unset,
        folder_uri: typing.Union[MetaOapg.properties.folder_uri, str, schemas.Unset] = schemas.unset,
        interaction_tools_settings: typing.Union['LiveEssentialsCreateLiveEventRequestInteractionToolsSettings', schemas.Unset] = schemas.unset,
        ...
        schedule: typing.Union['LiveEssentialsCreateLiveEventRequestSchedule', schemas.Unset] = schemas.unset,
        ...
        stream_embed: typing.Union['LiveEssentialsCreateLiveEventRequestStreamEmbed', schemas.Unset] = schemas.unset,
        stream_password: typing.Union[MetaOapg.properties.stream_password, str, schemas.Unset] = schemas.unset,
        stream_privacy: typing.Union['LiveEssentialsCreateLiveEventRequestStreamPrivacy', schemas.Unset] = schemas.unset,
