...
class OnDemandRegion(
    ...
    country_name: MetaOapg.properties.country_name
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["country_code", "country_name", "uri", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["country_name"]) -> MetaOapg.properties.country_name: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["country_code", "country_name", "uri", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        country_name: typing.Union[MetaOapg.properties.country_name, str, ],
