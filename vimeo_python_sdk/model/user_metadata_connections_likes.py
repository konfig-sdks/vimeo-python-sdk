...
class UserMetadataConnectionsLikes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['UserMetadataConnectionsLikesOptions']:
                return UserMetadataConnectionsLikesOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsLikesOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'UserMetadataConnectionsLikesOptions': ...
