...
class DisabledVideoPropertiesEmbedPresets(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def reasons() -> typing.Type['DisabledVideoPropertiesEmbedPresetsReasons']:
                return DisabledVideoPropertiesEmbedPresetsReasons
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reasons"]) -> 'DisabledVideoPropertiesEmbedPresetsReasons': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reasons"]) -> 'DisabledVideoPropertiesEmbedPresetsReasons': ...
