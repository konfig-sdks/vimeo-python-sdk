...
class Credit(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "role", "uri", "user", "video", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "role", "uri", "user", "video", ], str]):
