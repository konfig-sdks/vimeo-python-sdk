...
class ProjectMetadataConnectionsVideos(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['ProjectMetadataConnectionsVideosOptions']:
                return ProjectMetadataConnectionsVideosOptions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'ProjectMetadataConnectionsVideosOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> 'ProjectMetadataConnectionsVideosOptions': ...
